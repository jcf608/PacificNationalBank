...
CREATE VIEW ACB.V_CREDITLINE_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CREDITLINE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CREDITLINE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CREDITLINE_036_00
  ON ACB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CREDITLINE_036_01

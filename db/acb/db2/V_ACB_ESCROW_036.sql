-- ============================================================
-- DB2 Objects for escrow domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ESCROW_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ESCROW_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_036_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_036_01

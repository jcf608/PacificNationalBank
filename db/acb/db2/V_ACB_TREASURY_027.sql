...
CREATE VIEW ACB.V_TREASURY_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TREASURY_027_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_027_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_027_01
  ON ACB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TREASURY_027_02
  ON ACB.TREASURY_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TREASURY_027_03
  ON ACB.TREASURY_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_TREASURY_027_04

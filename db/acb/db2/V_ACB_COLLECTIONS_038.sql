-- ============================================================
-- DB2 Objects for collections domain — variant 38
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COLLECTIONS_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COLLECTIONS_038_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COLLECTIONS_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COLLECTIONS_038_00
  ON ACB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_038_01
  ON ACB.COLLECTIONS_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_038_02
  ON ACB.COLLECTIONS_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_038_03

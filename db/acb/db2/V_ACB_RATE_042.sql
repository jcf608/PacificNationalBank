...
CREATE TRIGGER ACB.TRG_RATE_042_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RATE_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RATE_042_00
  ON ACB.RATE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RATE_042_01
  ON ACB.RATE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RATE_042_02
  ON ACB.RATE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RATE_042_03

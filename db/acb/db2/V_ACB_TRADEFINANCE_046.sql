-- ============================================================
-- DB2 Objects for tradefinance domain — variant 46
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRADEFINANCE_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRADEFINANCE_046_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRADEFINANCE_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRADEFINANCE_046_00
  ON ACB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRADEFINANCE_046_01
  ON ACB.TRADEFINANCE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TRADEFINANCE_046_02
  ON ACB.TRADEFINANCE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TRADEFINANCE_046_03

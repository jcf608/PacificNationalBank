-- ============================================================
-- DB2 Objects for mortgage domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_MORTGAGE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_MORTGAGE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_MORTGAGE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_MORTGAGE_044_00
  ON ACB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_MORTGAGE_044_01

-- ============================================================
-- DB2 Objects for stop domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_STOP_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_STOP_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_036_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_036_01

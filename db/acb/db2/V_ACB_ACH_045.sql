-- ============================================================
-- DB2 Objects for ach domain — variant 45
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ACH_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACH_045_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_045_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_045_01
  ON ACB.ACH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACH_045_02

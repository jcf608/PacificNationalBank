...
CREATE VIEW ACB.V_MORTGAGE_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_MORTGAGE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_MORTGAGE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_MORTGAGE_040_00
  ON ACB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_MORTGAGE_040_01

-- ============================================================
-- DB2 Objects for fee domain — variant 27
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FEE_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FEE_027_UPDATE
  AFTER UPDATE ON ACB.FEE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.FEE_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'FEE_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_027_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_027_01
  ON ACB.FEE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FEE_027_02
  ON ACB.FEE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FEE_027_03
  ON ACB.FEE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_FEE_027_04
  ON ACB.FEE_MASTER (COL_004 ASC);

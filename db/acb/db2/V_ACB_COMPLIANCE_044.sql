-- ============================================================
-- DB2 Objects for compliance domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COMPLIANCE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COMPLIANCE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COMPLIANCE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COMPLIANCE_044_00
  ON ACB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_044_01

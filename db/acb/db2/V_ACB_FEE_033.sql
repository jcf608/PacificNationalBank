...
CREATE TRIGGER ACB.TRG_FEE_033_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_033_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_033_01
  ON ACB.FEE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FEE_033_02

-- ============================================================
-- DB2 Objects for fee domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FEE_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FEE_043_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_043_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_043_01
  ON ACB.FEE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FEE_043_02
  ON ACB.FEE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FEE_043_03
  ON ACB.FEE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_FEE_043_04

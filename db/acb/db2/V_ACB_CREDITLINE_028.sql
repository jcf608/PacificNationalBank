-- ============================================================
-- DB2 Objects for creditline domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CREDITLINE_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_013,
    COL_014,
  FROM ACB.CREDITLINE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_CREDITLINE_028_UPDATE
  AFTER UPDATE ON ACB.CREDITLINE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.CREDITLINE_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'CREDITLINE_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_CREDITLINE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CREDITLINE_028_00
  ON ACB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CREDITLINE_028_01
  ON ACB.CREDITLINE_MASTER (COL_001 ASC);

...
CREATE TRIGGER ACB.TRG_CARD_043_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CARD_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CARD_043_00
  ON ACB.CARD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CARD_043_01
  ON ACB.CARD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CARD_043_02
  ON ACB.CARD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CARD_043_03
  ON ACB.CARD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_CARD_043_04

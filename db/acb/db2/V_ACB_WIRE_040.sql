...
CREATE TRIGGER ACB.TRG_WIRE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_040_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_040_01

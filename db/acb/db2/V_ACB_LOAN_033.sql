...
CREATE TRIGGER ACB.TRG_LOAN_033_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_033_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_033_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_033_02

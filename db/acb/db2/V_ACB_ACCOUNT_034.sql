...
CREATE VIEW ACB.V_ACCOUNT_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_023,
    COL_024
  FROM ACB.ACCOUNT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_ACCOUNT_034_UPDATE
  AFTER UPDATE ON ACB.ACCOUNT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.ACCOUNT_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACCOUNT_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACCOUNT_034_00
  ON ACB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACCOUNT_034_01
  ON ACB.ACCOUNT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACCOUNT_034_02
  ON ACB.ACCOUNT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ACCOUNT_034_03
  ON ACB.ACCOUNT_MASTER (COL_003 ASC);

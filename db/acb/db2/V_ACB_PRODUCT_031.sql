-- ============================================================
-- DB2 Objects for product domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_PRODUCT_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_PRODUCT_031_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_PRODUCT_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_PRODUCT_031_00
  ON ACB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_PRODUCT_031_01
  ON ACB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_PRODUCT_031_02
  ON ACB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_PRODUCT_031_03
  ON ACB.PRODUCT_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_PRODUCT_031_04

...
CREATE VIEW ACB.V_FOREIGNEXCHANGE_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FOREIGNEXCHANGE_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FOREIGNEXCHANGE_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FOREIGNEXCHANGE_034_00
  ON ACB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FOREIGNEXCHANGE_034_01
  ON ACB.FOREIGNEXCHANGE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FOREIGNEXCHANGE_034_02
  ON ACB.FOREIGNEXCHANGE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FOREIGNEXCHANGE_034_03

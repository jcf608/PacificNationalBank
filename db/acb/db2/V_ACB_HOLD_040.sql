...
CREATE TRIGGER ACB.TRG_HOLD_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_040_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_040_01

...
CREATE VIEW ACB.V_HELOC_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_HELOC_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HELOC_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HELOC_034_00
  ON ACB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HELOC_034_01
  ON ACB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HELOC_034_02
  ON ACB.HELOC_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HELOC_034_03

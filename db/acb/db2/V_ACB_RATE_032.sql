...
CREATE TRIGGER ACB.TRG_RATE_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RATE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RATE_032_00
  ON ACB.RATE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RATE_032_01

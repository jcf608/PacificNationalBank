-- ============================================================
-- DB2 Objects for branch domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_BRANCH_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_BRANCH_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_BRANCH_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_BRANCH_048_00
  ON ACB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_BRANCH_048_01

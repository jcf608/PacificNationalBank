...
CREATE VIEW ACB.V_COMPLIANCE_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COMPLIANCE_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COMPLIANCE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COMPLIANCE_032_00
  ON ACB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_032_01

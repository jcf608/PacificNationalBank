-- ============================================================
-- DB2 Objects for stop domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_STOP_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_STOP_031_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_031_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_031_01
  ON ACB.STOP_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_STOP_031_02
  ON ACB.STOP_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_STOP_031_03
  ON ACB.STOP_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_STOP_031_04

...
CREATE VIEW ACB.V_TREASURY_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TREASURY_031_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_031_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_031_01
  ON ACB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TREASURY_031_02
  ON ACB.TREASURY_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TREASURY_031_03
  ON ACB.TREASURY_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_TREASURY_031_04

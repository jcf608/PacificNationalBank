...
CREATE VIEW ACB.V_ALERT_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ALERT_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ALERT_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ALERT_036_00
  ON ACB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ALERT_036_01

-- ============================================================
-- DB2 Objects for tradefinance domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRADEFINANCE_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRADEFINANCE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRADEFINANCE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRADEFINANCE_036_00
  ON ACB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRADEFINANCE_036_01

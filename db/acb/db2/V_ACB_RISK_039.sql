-- ============================================================
-- DB2 Objects for risk domain — variant 39
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_RISK_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_018,
    COL_019,
  FROM ACB.RISK_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_RISK_039_UPDATE
  AFTER UPDATE ON ACB.RISK_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.RISK_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'RISK_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_039_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_039_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_039_02
  ON ACB.RISK_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RISK_039_03
  ON ACB.RISK_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_RISK_039_04
  ON ACB.RISK_MASTER (COL_004 ASC);

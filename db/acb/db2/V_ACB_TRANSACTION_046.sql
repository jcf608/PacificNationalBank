...
CREATE VIEW ACB.V_TRANSACTION_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRANSACTION_046_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_046_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_046_01
  ON ACB.TRANSACTION_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TRANSACTION_046_02
  ON ACB.TRANSACTION_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TRANSACTION_046_03

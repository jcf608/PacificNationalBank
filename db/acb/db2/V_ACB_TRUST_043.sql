-- ============================================================
-- DB2 Objects for trust domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRUST_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_020,
    COL_021,
  FROM ACB.TRUST_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_TRUST_043_UPDATE
  AFTER UPDATE ON ACB.TRUST_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.TRUST_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'TRUST_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRUST_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRUST_043_00
  ON ACB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRUST_043_01
  ON ACB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TRUST_043_02
  ON ACB.TRUST_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TRUST_043_03
  ON ACB.TRUST_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_TRUST_043_04
  ON ACB.TRUST_MASTER (COL_004 ASC);

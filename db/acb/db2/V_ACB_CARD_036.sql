-- ============================================================
-- DB2 Objects for card domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CARD_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CARD_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CARD_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CARD_036_00
  ON ACB.CARD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CARD_036_01

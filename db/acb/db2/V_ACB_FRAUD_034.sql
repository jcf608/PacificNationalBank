-- ============================================================
-- DB2 Objects for fraud domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FRAUD_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FRAUD_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FRAUD_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FRAUD_034_00
  ON ACB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FRAUD_034_01
  ON ACB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FRAUD_034_02
  ON ACB.FRAUD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FRAUD_034_03

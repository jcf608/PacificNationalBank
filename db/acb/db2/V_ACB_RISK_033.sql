...
CREATE TRIGGER ACB.TRG_RISK_033_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_033_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_033_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_033_02

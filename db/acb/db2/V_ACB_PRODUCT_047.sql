...
CREATE VIEW ACB.V_PRODUCT_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_PRODUCT_047_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_PRODUCT_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_PRODUCT_047_00
  ON ACB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_PRODUCT_047_01
  ON ACB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_PRODUCT_047_02
  ON ACB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_PRODUCT_047_03
  ON ACB.PRODUCT_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_PRODUCT_047_04

...
CREATE VIEW ACB.V_LETTEROFCREDIT_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_LETTEROFCREDIT_046_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LETTEROFCREDIT_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LETTEROFCREDIT_046_00
  ON ACB.LETTEROFCREDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LETTEROFCREDIT_046_01
  ON ACB.LETTEROFCREDIT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LETTEROFCREDIT_046_02
  ON ACB.LETTEROFCREDIT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_LETTEROFCREDIT_046_03

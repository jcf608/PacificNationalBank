...
CREATE VIEW ACB.V_ESCROW_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_017,
    COL_018,
  FROM ACB.ESCROW_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_ESCROW_042_UPDATE
  AFTER UPDATE ON ACB.ESCROW_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.ESCROW_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_042_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_042_01
  ON ACB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ESCROW_042_02
  ON ACB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ESCROW_042_03
  ON ACB.ESCROW_MASTER (COL_003 ASC);

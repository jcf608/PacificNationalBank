...
CREATE VIEW ACB.V_CUSTOMER_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CUSTOMER_028_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_028_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_028_01

-- ============================================================
-- DB2 Objects for stop domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_STOP_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_STOP_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_032_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_032_01

-- ============================================================
-- DB2 Objects for trust domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRUST_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRUST_028_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRUST_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRUST_028_00
  ON ACB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRUST_028_01

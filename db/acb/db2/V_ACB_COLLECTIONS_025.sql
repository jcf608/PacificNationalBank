-- ============================================================
-- DB2 Objects for collections domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COLLECTIONS_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COLLECTIONS_025_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COLLECTIONS_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COLLECTIONS_025_00
  ON ACB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_025_01
  ON ACB.COLLECTIONS_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_025_02

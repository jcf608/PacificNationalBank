...
CREATE TRIGGER ACB.TRG_WIRE_030_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_030_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_030_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_030_02
  ON ACB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_WIRE_030_03

-- ============================================================
-- DB2 Objects for audit domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_AUDIT_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_040_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_040_01

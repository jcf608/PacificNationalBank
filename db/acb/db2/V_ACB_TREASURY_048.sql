-- ============================================================
-- DB2 Objects for treasury domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TREASURY_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TREASURY_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_048_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_048_01

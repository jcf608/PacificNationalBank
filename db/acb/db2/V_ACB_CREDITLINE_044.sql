-- ============================================================
-- DB2 Objects for creditline domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CREDITLINE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CREDITLINE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CREDITLINE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CREDITLINE_044_00
  ON ACB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CREDITLINE_044_01

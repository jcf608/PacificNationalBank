-- ============================================================
-- DB2 Objects for product domain — variant 38
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_PRODUCT_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_023,
    COL_024
  FROM ACB.PRODUCT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_PRODUCT_038_UPDATE
  AFTER UPDATE ON ACB.PRODUCT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.PRODUCT_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'PRODUCT_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_PRODUCT_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_PRODUCT_038_00
  ON ACB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_PRODUCT_038_01
  ON ACB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_PRODUCT_038_02
  ON ACB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_PRODUCT_038_03
  ON ACB.PRODUCT_MASTER (COL_003 ASC);

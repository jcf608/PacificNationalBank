-- ============================================================
-- DB2 Objects for cashmanagement domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CASHMANAGEMENT_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CASHMANAGEMENT_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CASHMANAGEMENT_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CASHMANAGEMENT_040_00
  ON ACB.CASHMANAGEMENT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CASHMANAGEMENT_040_01

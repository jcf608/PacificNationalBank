...
CREATE VIEW ACB.V_TRUST_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRUST_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRUST_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRUST_044_00
  ON ACB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRUST_044_01

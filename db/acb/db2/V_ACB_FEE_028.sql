...
CREATE TRIGGER ACB.TRG_FEE_028_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_028_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_028_01

...
CREATE VIEW ACB.V_TRANSACTION_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRANSACTION_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_048_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_048_01

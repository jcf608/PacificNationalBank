-- ============================================================
-- DB2 Objects for stop domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_STOP_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_STOP_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_040_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_040_01

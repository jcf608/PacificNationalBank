...
CREATE TRIGGER ACB.TRG_RISK_046_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_046_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_046_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_046_02
  ON ACB.RISK_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RISK_046_03

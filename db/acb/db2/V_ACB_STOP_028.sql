...
CREATE TRIGGER ACB.TRG_STOP_028_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_028_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_028_01

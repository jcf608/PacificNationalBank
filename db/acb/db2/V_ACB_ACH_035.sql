-- ============================================================
-- DB2 Objects for ach domain — variant 35
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ACH_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACH_035_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_035_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_035_01
  ON ACB.ACH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACH_035_02
  ON ACB.ACH_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ACH_035_03
  ON ACB.ACH_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_ACH_035_04

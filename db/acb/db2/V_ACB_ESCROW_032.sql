-- ============================================================
-- DB2 Objects for escrow domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ESCROW_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ESCROW_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_032_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_032_01

-- ============================================================
-- DB2 Objects for stop domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_STOP_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_STOP_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_044_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_044_01

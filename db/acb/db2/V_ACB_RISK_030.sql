...
CREATE TRIGGER ACB.TRG_RISK_030_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_030_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_030_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_030_02
  ON ACB.RISK_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RISK_030_03

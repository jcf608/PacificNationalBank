-- ============================================================
-- DB2 Objects for rate domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_RATE_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_RATE_037_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RATE_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RATE_037_00
  ON ACB.RATE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RATE_037_01
  ON ACB.RATE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RATE_037_02

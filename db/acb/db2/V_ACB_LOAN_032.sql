...
CREATE TRIGGER ACB.TRG_LOAN_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_032_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_032_01

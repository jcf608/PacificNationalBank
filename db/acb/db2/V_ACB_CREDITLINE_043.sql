...
CREATE VIEW ACB.V_CREDITLINE_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CREDITLINE_043_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CREDITLINE_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CREDITLINE_043_00
  ON ACB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CREDITLINE_043_01
  ON ACB.CREDITLINE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CREDITLINE_043_02
  ON ACB.CREDITLINE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CREDITLINE_043_03
  ON ACB.CREDITLINE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_CREDITLINE_043_04

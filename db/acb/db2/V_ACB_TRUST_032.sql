...
CREATE VIEW ACB.V_TRUST_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRUST_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRUST_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRUST_032_00
  ON ACB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRUST_032_01

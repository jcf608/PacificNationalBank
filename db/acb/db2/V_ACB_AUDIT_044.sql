-- ============================================================
-- DB2 Objects for audit domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_AUDIT_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_044_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_044_01

...
CREATE VIEW ACB.V_AUDIT_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_032_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_032_01

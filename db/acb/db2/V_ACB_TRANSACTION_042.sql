...
CREATE VIEW ACB.V_TRANSACTION_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRANSACTION_042_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_042_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_042_01
  ON ACB.TRANSACTION_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TRANSACTION_042_02
  ON ACB.TRANSACTION_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TRANSACTION_042_03

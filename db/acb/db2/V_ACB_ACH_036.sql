...
CREATE TRIGGER ACB.TRG_ACH_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_036_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_036_01

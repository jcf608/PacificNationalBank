-- ============================================================
-- DB2 Objects for deposit domain — variant 26
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_DEPOSIT_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_DEPOSIT_026_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_DEPOSIT_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_DEPOSIT_026_00
  ON ACB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_DEPOSIT_026_01
  ON ACB.DEPOSIT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_DEPOSIT_026_02
  ON ACB.DEPOSIT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_DEPOSIT_026_03

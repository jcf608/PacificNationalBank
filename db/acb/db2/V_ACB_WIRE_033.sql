...
CREATE TRIGGER ACB.TRG_WIRE_033_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_033_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_033_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_033_02

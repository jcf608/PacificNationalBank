...
CREATE TRIGGER ACB.TRG_LOAN_025_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_025_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_025_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_025_02

...
CREATE VIEW ACB.V_COLLECTIONS_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COLLECTIONS_041_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COLLECTIONS_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COLLECTIONS_041_00
  ON ACB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_041_01
  ON ACB.COLLECTIONS_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_041_02

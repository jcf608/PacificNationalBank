...
CREATE TRIGGER ACB.TRG_RISK_025_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_025_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_025_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_025_02

...
CREATE VIEW ACB.V_CUSTOMER_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CUSTOMER_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_048_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_048_01

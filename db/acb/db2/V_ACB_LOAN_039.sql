-- ============================================================
-- DB2 Objects for loan domain — variant 39
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_LOAN_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_008,
    COL_009,
  FROM ACB.LOAN_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_LOAN_039_UPDATE
  AFTER UPDATE ON ACB.LOAN_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.LOAN_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'LOAN_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_039_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_039_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_039_02
  ON ACB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_LOAN_039_03
  ON ACB.LOAN_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_LOAN_039_04
  ON ACB.LOAN_MASTER (COL_004 ASC);

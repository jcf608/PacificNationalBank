...
CREATE VIEW ACB.V_FRAUD_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_020,
    COL_021,
  FROM ACB.FRAUD_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_FRAUD_039_UPDATE
  AFTER UPDATE ON ACB.FRAUD_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.FRAUD_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_FRAUD_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FRAUD_039_00
  ON ACB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FRAUD_039_01
  ON ACB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FRAUD_039_02
  ON ACB.FRAUD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FRAUD_039_03
  ON ACB.FRAUD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_FRAUD_039_04
  ON ACB.FRAUD_MASTER (COL_004 ASC);

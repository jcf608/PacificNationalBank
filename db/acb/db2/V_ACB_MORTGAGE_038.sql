-- ============================================================
-- DB2 Objects for mortgage domain — variant 38
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_MORTGAGE_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_MORTGAGE_038_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_MORTGAGE_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_MORTGAGE_038_00
  ON ACB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_MORTGAGE_038_01
  ON ACB.MORTGAGE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_MORTGAGE_038_02
  ON ACB.MORTGAGE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_MORTGAGE_038_03

-- ============================================================
-- DB2 Objects for loan domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_LOAN_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_LOAN_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_036_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_036_01

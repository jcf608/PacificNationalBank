...
CREATE TRIGGER ACB.TRG_STOP_047_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_047_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_047_01
  ON ACB.STOP_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_STOP_047_02
  ON ACB.STOP_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_STOP_047_03
  ON ACB.STOP_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_STOP_047_04

-- ============================================================
-- DB2 Objects for wire domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_WIRE_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_WIRE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_036_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_036_01

...
CREATE TRIGGER ACB.TRG_WIRE_025_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_025_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_025_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_025_02

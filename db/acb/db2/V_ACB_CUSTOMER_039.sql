...
CREATE VIEW ACB.V_CUSTOMER_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CUSTOMER_039_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_039_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_039_01
  ON ACB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CUSTOMER_039_02
  ON ACB.CUSTOMER_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CUSTOMER_039_03
  ON ACB.CUSTOMER_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_CUSTOMER_039_04
  ON ACB.CUSTOMER_MASTER (COL_004 ASC);

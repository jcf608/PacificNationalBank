...
CREATE VIEW ACB.V_ACCOUNT_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACCOUNT_039_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACCOUNT_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACCOUNT_039_00
  ON ACB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACCOUNT_039_01
  ON ACB.ACCOUNT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACCOUNT_039_02
  ON ACB.ACCOUNT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ACCOUNT_039_03
  ON ACB.ACCOUNT_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_ACCOUNT_039_04

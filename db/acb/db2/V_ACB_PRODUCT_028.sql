-- ============================================================
-- DB2 Objects for product domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_PRODUCT_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_PRODUCT_028_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_PRODUCT_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_PRODUCT_028_00
  ON ACB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_PRODUCT_028_01

...
CREATE TRIGGER ACB.TRG_FEE_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_032_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_032_01

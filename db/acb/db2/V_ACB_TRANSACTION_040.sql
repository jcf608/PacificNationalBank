-- ============================================================
-- DB2 Objects for transaction domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRANSACTION_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRANSACTION_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_040_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_040_01

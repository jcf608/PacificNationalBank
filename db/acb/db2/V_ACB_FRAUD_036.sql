-- ============================================================
-- DB2 Objects for fraud domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FRAUD_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FRAUD_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FRAUD_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FRAUD_036_00
  ON ACB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FRAUD_036_01

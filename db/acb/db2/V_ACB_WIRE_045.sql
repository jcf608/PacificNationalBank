-- ============================================================
-- DB2 Objects for wire domain — variant 45
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_WIRE_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_WIRE_045_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_045_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_045_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_045_02

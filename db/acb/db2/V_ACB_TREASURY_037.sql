-- ============================================================
-- DB2 Objects for treasury domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TREASURY_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_019,
    COL_020,
  FROM ACB.TREASURY_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_TREASURY_037_UPDATE
  AFTER UPDATE ON ACB.TREASURY_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.TREASURY_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'TREASURY_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_037_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_037_01
  ON ACB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TREASURY_037_02
  ON ACB.TREASURY_MASTER (COL_002 ASC);

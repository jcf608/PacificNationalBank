...
CREATE TRIGGER ACB.TRG_HOLD_039_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_039_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_039_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_039_02
  ON ACB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HOLD_039_03
  ON ACB.HOLD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_HOLD_039_04

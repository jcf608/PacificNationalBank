...
CREATE TRIGGER ACB.TRG_STOP_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_034_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_034_01
  ON ACB.STOP_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_STOP_034_02
  ON ACB.STOP_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_STOP_034_03

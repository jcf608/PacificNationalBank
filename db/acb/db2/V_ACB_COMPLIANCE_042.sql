-- ============================================================
-- DB2 Objects for compliance domain — variant 42
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COMPLIANCE_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COMPLIANCE_042_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COMPLIANCE_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COMPLIANCE_042_00
  ON ACB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_042_01
  ON ACB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_042_02
  ON ACB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_042_03

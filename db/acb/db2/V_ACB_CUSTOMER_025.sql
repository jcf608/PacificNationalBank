...
CREATE VIEW ACB.V_CUSTOMER_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_011,
    COL_012,
  FROM ACB.CUSTOMER_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_CUSTOMER_025_UPDATE
  AFTER UPDATE ON ACB.CUSTOMER_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.CUSTOMER_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_025_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_025_01
  ON ACB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CUSTOMER_025_02
  ON ACB.CUSTOMER_MASTER (COL_002 ASC);

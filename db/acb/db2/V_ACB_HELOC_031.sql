-- ============================================================
-- DB2 Objects for heloc domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_HELOC_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_021,
    COL_022,
  FROM ACB.HELOC_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_HELOC_031_UPDATE
  AFTER UPDATE ON ACB.HELOC_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.HELOC_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'HELOC_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_HELOC_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HELOC_031_00
  ON ACB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HELOC_031_01
  ON ACB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HELOC_031_02
  ON ACB.HELOC_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HELOC_031_03
  ON ACB.HELOC_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_HELOC_031_04
  ON ACB.HELOC_MASTER (COL_004 ASC);

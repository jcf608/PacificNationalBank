...
CREATE TRIGGER ACB.TRG_FEE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_044_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_044_01

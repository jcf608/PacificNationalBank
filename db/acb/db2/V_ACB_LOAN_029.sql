-- ============================================================
-- DB2 Objects for loan domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_LOAN_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_LOAN_029_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_029_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_029_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_029_02

...
CREATE TRIGGER ACB.TRG_HOLD_026_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_026_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_026_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_026_02
  ON ACB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HOLD_026_03

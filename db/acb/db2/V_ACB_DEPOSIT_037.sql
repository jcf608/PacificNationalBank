-- ============================================================
-- DB2 Objects for deposit domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_DEPOSIT_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_022,
    COL_023,
  FROM ACB.DEPOSIT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_DEPOSIT_037_UPDATE
  AFTER UPDATE ON ACB.DEPOSIT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.DEPOSIT_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_DEPOSIT_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_DEPOSIT_037_00
  ON ACB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_DEPOSIT_037_01
  ON ACB.DEPOSIT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_DEPOSIT_037_02
  ON ACB.DEPOSIT_MASTER (COL_002 ASC);

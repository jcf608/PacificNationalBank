...
CREATE TRIGGER ACB.TRG_WIRE_041_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_041_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_041_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_041_02

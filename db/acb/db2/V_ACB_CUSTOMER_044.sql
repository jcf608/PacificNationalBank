-- ============================================================
-- DB2 Objects for customer domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CUSTOMER_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CUSTOMER_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_044_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_044_01

...
CREATE TRIGGER ACB.TRG_LOAN_026_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_026_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_026_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_026_02
  ON ACB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_LOAN_026_03

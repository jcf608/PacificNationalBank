-- ============================================================
-- DB2 Objects for cashmanagement domain — variant 42
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CASHMANAGEMENT_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CASHMANAGEMENT_042_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CASHMANAGEMENT_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CASHMANAGEMENT_042_00
  ON ACB.CASHMANAGEMENT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CASHMANAGEMENT_042_01
  ON ACB.CASHMANAGEMENT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CASHMANAGEMENT_042_02
  ON ACB.CASHMANAGEMENT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CASHMANAGEMENT_042_03

-- ============================================================
-- DB2 Objects for foreignexchange domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FOREIGNEXCHANGE_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FOREIGNEXCHANGE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FOREIGNEXCHANGE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FOREIGNEXCHANGE_036_00
  ON ACB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FOREIGNEXCHANGE_036_01

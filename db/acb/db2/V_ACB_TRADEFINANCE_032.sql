-- ============================================================
-- DB2 Objects for tradefinance domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRADEFINANCE_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_011,
    COL_012,
  FROM ACB.TRADEFINANCE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_TRADEFINANCE_032_UPDATE
  AFTER UPDATE ON ACB.TRADEFINANCE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.TRADEFINANCE_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'TRADEFINANCE_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRADEFINANCE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRADEFINANCE_032_00
  ON ACB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRADEFINANCE_032_01
  ON ACB.TRADEFINANCE_MASTER (COL_001 ASC);

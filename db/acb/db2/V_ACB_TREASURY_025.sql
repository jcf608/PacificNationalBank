-- ============================================================
-- DB2 Objects for treasury domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TREASURY_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TREASURY_025_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_025_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_025_01
  ON ACB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TREASURY_025_02

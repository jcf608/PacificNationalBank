...
CREATE TRIGGER ACB.TRG_LOAN_038_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_038_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_038_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_038_02
  ON ACB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_LOAN_038_03

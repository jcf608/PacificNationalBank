-- ============================================================
-- DB2 Objects for card domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CARD_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CARD_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CARD_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CARD_034_00
  ON ACB.CARD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CARD_034_01
  ON ACB.CARD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CARD_034_02
  ON ACB.CARD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CARD_034_03

...
CREATE TRIGGER ACB.TRG_HOLD_025_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_025_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_025_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_025_02

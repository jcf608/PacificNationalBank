...
CREATE TRIGGER ACB.TRG_LOAN_037_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_037_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_037_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_037_02

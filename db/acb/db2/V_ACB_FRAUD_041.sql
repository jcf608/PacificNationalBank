-- ============================================================
-- DB2 Objects for fraud domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FRAUD_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FRAUD_041_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FRAUD_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FRAUD_041_00
  ON ACB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FRAUD_041_01
  ON ACB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FRAUD_041_02

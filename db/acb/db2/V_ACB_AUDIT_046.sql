-- ============================================================
-- DB2 Objects for audit domain — variant 46
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_AUDIT_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_046_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_046_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_046_01
  ON ACB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_AUDIT_046_02
  ON ACB.AUDIT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_AUDIT_046_03

...
CREATE VIEW ACB.V_COMPLIANCE_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COMPLIANCE_047_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COMPLIANCE_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COMPLIANCE_047_00
  ON ACB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_047_01
  ON ACB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_047_02
  ON ACB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_047_03
  ON ACB.COMPLIANCE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_047_04

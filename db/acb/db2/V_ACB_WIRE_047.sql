-- ============================================================
-- DB2 Objects for wire domain — variant 47
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_WIRE_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_WIRE_047_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_047_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_047_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_047_02
  ON ACB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_WIRE_047_03
  ON ACB.WIRE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_WIRE_047_04

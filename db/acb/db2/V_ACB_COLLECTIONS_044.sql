...
CREATE VIEW ACB.V_COLLECTIONS_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COLLECTIONS_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COLLECTIONS_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COLLECTIONS_044_00
  ON ACB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_044_01

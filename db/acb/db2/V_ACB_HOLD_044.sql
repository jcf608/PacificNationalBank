...
CREATE TRIGGER ACB.TRG_HOLD_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_044_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_044_01

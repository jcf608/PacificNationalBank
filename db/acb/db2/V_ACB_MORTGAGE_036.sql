...
CREATE VIEW ACB.V_MORTGAGE_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_MORTGAGE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_MORTGAGE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_MORTGAGE_036_00
  ON ACB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_MORTGAGE_036_01

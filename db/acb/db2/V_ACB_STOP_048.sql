...
CREATE TRIGGER ACB.TRG_STOP_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_048_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_048_01

-- ============================================================
-- DB2 Objects for fee domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FEE_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FEE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_040_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_040_01

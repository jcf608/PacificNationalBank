-- ============================================================
-- DB2 Objects for deposit domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_DEPOSIT_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_DEPOSIT_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_DEPOSIT_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_DEPOSIT_032_00
  ON ACB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_DEPOSIT_032_01

...
CREATE VIEW ACB.V_AUDIT_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_036_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_036_01

-- ============================================================
-- DB2 Objects for hold domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_HOLD_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_010,
    COL_011,
  FROM ACB.HOLD_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_HOLD_043_UPDATE
  AFTER UPDATE ON ACB.HOLD_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.HOLD_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_043_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_043_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_043_02
  ON ACB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HOLD_043_03
  ON ACB.HOLD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_HOLD_043_04
  ON ACB.HOLD_MASTER (COL_004 ASC);

...
CREATE TRIGGER ACB.TRG_STOP_030_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_030_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_030_01
  ON ACB.STOP_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_STOP_030_02
  ON ACB.STOP_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_STOP_030_03

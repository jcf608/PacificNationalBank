-- ============================================================
-- DB2 Objects for risk domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_RISK_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_RISK_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_048_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_048_01

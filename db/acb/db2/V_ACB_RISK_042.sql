...
CREATE TRIGGER ACB.TRG_RISK_042_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_042_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_042_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_042_02
  ON ACB.RISK_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RISK_042_03

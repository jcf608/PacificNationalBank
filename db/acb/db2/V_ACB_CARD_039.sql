-- ============================================================
-- DB2 Objects for card domain — variant 39
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CARD_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_014,
    COL_015,
  FROM ACB.CARD_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_CARD_039_UPDATE
  AFTER UPDATE ON ACB.CARD_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.CARD_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_CARD_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CARD_039_00
  ON ACB.CARD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CARD_039_01
  ON ACB.CARD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CARD_039_02
  ON ACB.CARD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CARD_039_03
  ON ACB.CARD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_CARD_039_04
  ON ACB.CARD_MASTER (COL_004 ASC);

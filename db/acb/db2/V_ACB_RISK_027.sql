...
CREATE TRIGGER ACB.TRG_RISK_027_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_027_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_027_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_027_02
  ON ACB.RISK_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RISK_027_03
  ON ACB.RISK_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_RISK_027_04

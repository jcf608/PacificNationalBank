-- ============================================================
-- DB2 Objects for treasury domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TREASURY_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TREASURY_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_044_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_044_01

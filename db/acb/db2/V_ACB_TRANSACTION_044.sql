...
CREATE VIEW ACB.V_TRANSACTION_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRANSACTION_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_044_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_044_01

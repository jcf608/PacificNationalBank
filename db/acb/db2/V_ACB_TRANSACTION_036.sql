-- ============================================================
-- DB2 Objects for transaction domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRANSACTION_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRANSACTION_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_036_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_036_01

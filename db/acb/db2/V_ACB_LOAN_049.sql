...
CREATE TRIGGER ACB.TRG_LOAN_049_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_049_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_049_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_049_02

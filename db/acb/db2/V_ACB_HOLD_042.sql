-- ============================================================
-- DB2 Objects for hold domain — variant 42
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_HOLD_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_HOLD_042_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_042_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_042_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_042_02
  ON ACB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HOLD_042_03

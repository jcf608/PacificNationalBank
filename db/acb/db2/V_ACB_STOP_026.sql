-- ============================================================
-- DB2 Objects for stop domain — variant 26
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_STOP_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_STOP_026_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_026_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_026_01
  ON ACB.STOP_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_STOP_026_02
  ON ACB.STOP_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_STOP_026_03

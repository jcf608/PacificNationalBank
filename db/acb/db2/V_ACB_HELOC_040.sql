-- ============================================================
-- DB2 Objects for heloc domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_HELOC_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_HELOC_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HELOC_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HELOC_040_00
  ON ACB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HELOC_040_01

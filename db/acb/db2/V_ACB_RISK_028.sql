...
CREATE TRIGGER ACB.TRG_RISK_028_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_028_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_028_01

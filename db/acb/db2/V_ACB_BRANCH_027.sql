...
CREATE VIEW ACB.V_BRANCH_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_BRANCH_027_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_BRANCH_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_BRANCH_027_00
  ON ACB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_BRANCH_027_01
  ON ACB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_BRANCH_027_02
  ON ACB.BRANCH_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_BRANCH_027_03
  ON ACB.BRANCH_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_BRANCH_027_04
  ON ACB.BRANCH_MASTER (COL_004 ASC);

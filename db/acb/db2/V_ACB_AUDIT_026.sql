...
CREATE VIEW ACB.V_AUDIT_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_026_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_026_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_026_01
  ON ACB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_AUDIT_026_02
  ON ACB.AUDIT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_AUDIT_026_03

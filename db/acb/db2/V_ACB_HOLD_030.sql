...
CREATE TRIGGER ACB.TRG_HOLD_030_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_030_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_030_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_030_02
  ON ACB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HOLD_030_03

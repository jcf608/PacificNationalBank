-- ============================================================
-- DB2 Objects for product domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_PRODUCT_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_PRODUCT_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_PRODUCT_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_PRODUCT_048_00
  ON ACB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_PRODUCT_048_01

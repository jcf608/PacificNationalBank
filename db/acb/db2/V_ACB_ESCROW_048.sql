...
CREATE VIEW ACB.V_ESCROW_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ESCROW_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_048_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_048_01

...
CREATE VIEW ACB.V_CUSTOMER_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CUSTOMER_049_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_049_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_049_01
  ON ACB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CUSTOMER_049_02

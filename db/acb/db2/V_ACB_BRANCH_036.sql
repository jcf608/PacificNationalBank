...
CREATE VIEW ACB.V_BRANCH_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_BRANCH_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_BRANCH_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_BRANCH_036_00
  ON ACB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_BRANCH_036_01

-- ============================================================
-- DB2 Objects for ach domain — variant 27
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ACH_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACH_027_UPDATE
  AFTER UPDATE ON ACB.ACH_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.ACH_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_027_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_027_01
  ON ACB.ACH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACH_027_02
  ON ACB.ACH_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ACH_027_03
  ON ACB.ACH_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_ACH_027_04
  ON ACB.ACH_MASTER (COL_004 ASC);

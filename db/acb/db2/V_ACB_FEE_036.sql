-- ============================================================
-- DB2 Objects for fee domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FEE_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FEE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_036_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_036_01

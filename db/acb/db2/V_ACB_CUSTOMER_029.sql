-- ============================================================
-- DB2 Objects for customer domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CUSTOMER_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CUSTOMER_029_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_029_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_029_01
  ON ACB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CUSTOMER_029_02

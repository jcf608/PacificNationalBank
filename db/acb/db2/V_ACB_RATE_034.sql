...
CREATE TRIGGER ACB.TRG_RATE_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RATE_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RATE_034_00
  ON ACB.RATE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RATE_034_01
  ON ACB.RATE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RATE_034_02
  ON ACB.RATE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RATE_034_03

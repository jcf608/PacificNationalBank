...
CREATE TRIGGER ACB.TRG_LOAN_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_034_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_034_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_034_02
  ON ACB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_LOAN_034_03

-- ============================================================
-- DB2 Objects for foreignexchange domain — variant 49
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FOREIGNEXCHANGE_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FOREIGNEXCHANGE_049_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FOREIGNEXCHANGE_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FOREIGNEXCHANGE_049_00
  ON ACB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FOREIGNEXCHANGE_049_01
  ON ACB.FOREIGNEXCHANGE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FOREIGNEXCHANGE_049_02

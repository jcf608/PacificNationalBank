-- ============================================================
-- DB2 Objects for rate domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_RATE_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_RATE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RATE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RATE_048_00
  ON ACB.RATE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RATE_048_01

-- ============================================================
-- DB2 Objects for ach domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ACH_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACH_041_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_041_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_041_01
  ON ACB.ACH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACH_041_02

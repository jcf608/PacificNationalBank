...
CREATE VIEW ACB.V_ACCOUNT_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACCOUNT_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACCOUNT_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACCOUNT_044_00
  ON ACB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACCOUNT_044_01

...
CREATE TRIGGER ACB.TRG_CARD_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CARD_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CARD_032_00
  ON ACB.CARD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CARD_032_01

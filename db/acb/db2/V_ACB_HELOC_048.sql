...
CREATE VIEW ACB.V_HELOC_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_HELOC_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HELOC_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HELOC_048_00
  ON ACB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HELOC_048_01

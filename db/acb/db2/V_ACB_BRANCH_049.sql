...
CREATE VIEW ACB.V_BRANCH_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_BRANCH_049_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_BRANCH_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_BRANCH_049_00
  ON ACB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_BRANCH_049_01
  ON ACB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_BRANCH_049_02

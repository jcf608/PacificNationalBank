...
CREATE VIEW ACB.V_AUDIT_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_035_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_035_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_035_01
  ON ACB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_AUDIT_035_02
  ON ACB.AUDIT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_AUDIT_035_03
  ON ACB.AUDIT_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_AUDIT_035_04

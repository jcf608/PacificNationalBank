-- ============================================================
-- DB2 Objects for deposit domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_DEPOSIT_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_DEPOSIT_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_DEPOSIT_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_DEPOSIT_036_00
  ON ACB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_DEPOSIT_036_01

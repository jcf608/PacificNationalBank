...
CREATE TRIGGER ACB.TRG_CARD_026_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CARD_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CARD_026_00
  ON ACB.CARD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CARD_026_01
  ON ACB.CARD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CARD_026_02
  ON ACB.CARD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CARD_026_03

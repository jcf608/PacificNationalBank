-- ============================================================
-- DB2 Objects for escrow domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ESCROW_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ESCROW_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_034_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_034_01
  ON ACB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ESCROW_034_02
  ON ACB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ESCROW_034_03

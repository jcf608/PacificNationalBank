...
CREATE VIEW ACB.V_COLLECTIONS_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COLLECTIONS_026_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COLLECTIONS_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COLLECTIONS_026_00
  ON ACB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_026_01
  ON ACB.COLLECTIONS_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_026_02
  ON ACB.COLLECTIONS_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_026_03

-- ============================================================
-- DB2 Objects for compliance domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COMPLIANCE_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COMPLIANCE_043_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COMPLIANCE_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COMPLIANCE_043_00
  ON ACB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_043_01
  ON ACB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_043_02
  ON ACB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_043_03
  ON ACB.COMPLIANCE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_043_04

...
CREATE VIEW ACB.V_CUSTOMER_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CUSTOMER_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CUSTOMER_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CUSTOMER_040_00
  ON ACB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CUSTOMER_040_01

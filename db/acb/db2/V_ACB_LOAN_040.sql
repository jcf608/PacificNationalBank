...
CREATE TRIGGER ACB.TRG_LOAN_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_040_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_040_01

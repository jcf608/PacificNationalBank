-- ============================================================
-- DB2 Objects for ach domain — variant 38
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ACH_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACH_038_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_038_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_038_01
  ON ACB.ACH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACH_038_02
  ON ACB.ACH_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ACH_038_03

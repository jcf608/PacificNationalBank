...
CREATE VIEW ACB.V_ESCROW_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ESCROW_031_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_031_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_031_01
  ON ACB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ESCROW_031_02
  ON ACB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ESCROW_031_03
  ON ACB.ESCROW_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_ESCROW_031_04

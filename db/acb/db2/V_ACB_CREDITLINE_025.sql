-- ============================================================
-- DB2 Objects for creditline domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CREDITLINE_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CREDITLINE_025_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CREDITLINE_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CREDITLINE_025_00
  ON ACB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CREDITLINE_025_01
  ON ACB.CREDITLINE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CREDITLINE_025_02

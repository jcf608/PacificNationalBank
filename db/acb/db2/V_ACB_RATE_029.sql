...
CREATE TRIGGER ACB.TRG_RATE_029_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RATE_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RATE_029_00
  ON ACB.RATE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RATE_029_01
  ON ACB.RATE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RATE_029_02

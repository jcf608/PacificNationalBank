-- ============================================================
-- DB2 Objects for rate domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_RATE_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_016,
    COL_017,
  FROM ACB.RATE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_RATE_031_UPDATE
  AFTER UPDATE ON ACB.RATE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.RATE_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'RATE_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_RATE_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RATE_031_00
  ON ACB.RATE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RATE_031_01
  ON ACB.RATE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RATE_031_02
  ON ACB.RATE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RATE_031_03
  ON ACB.RATE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_RATE_031_04
  ON ACB.RATE_MASTER (COL_004 ASC);

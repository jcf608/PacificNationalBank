-- ============================================================
-- DB2 Objects for loan domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_LOAN_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_LOAN_041_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_041_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_041_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_041_02

-- ============================================================
-- DB2 Objects for wire domain — variant 35
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_WIRE_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_010,
    COL_011,
  FROM ACB.WIRE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_WIRE_035_UPDATE
  AFTER UPDATE ON ACB.WIRE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.WIRE_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'WIRE_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_035_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_035_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_035_02
  ON ACB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_WIRE_035_03
  ON ACB.WIRE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_WIRE_035_04
  ON ACB.WIRE_MASTER (COL_004 ASC);

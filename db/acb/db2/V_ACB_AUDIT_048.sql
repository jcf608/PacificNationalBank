...
CREATE VIEW ACB.V_AUDIT_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_048_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_048_01

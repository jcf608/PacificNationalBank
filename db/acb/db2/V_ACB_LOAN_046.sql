...
CREATE TRIGGER ACB.TRG_LOAN_046_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_046_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_046_01
  ON ACB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_LOAN_046_02
  ON ACB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_LOAN_046_03

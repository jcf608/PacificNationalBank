...
CREATE VIEW ACB.V_ALERT_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_022,
    COL_023,
  FROM ACB.ALERT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_ALERT_035_UPDATE
  AFTER UPDATE ON ACB.ALERT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.ALERT_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_ALERT_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ALERT_035_00
  ON ACB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ALERT_035_01
  ON ACB.ALERT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ALERT_035_02
  ON ACB.ALERT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ALERT_035_03
  ON ACB.ALERT_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_ALERT_035_04
  ON ACB.ALERT_MASTER (COL_004 ASC);

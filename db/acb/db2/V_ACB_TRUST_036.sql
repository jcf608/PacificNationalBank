-- ============================================================
-- DB2 Objects for trust domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRUST_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRUST_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRUST_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRUST_036_00
  ON ACB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRUST_036_01

...
CREATE TRIGGER ACB.TRG_RISK_038_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_038_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_038_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_038_02
  ON ACB.RISK_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_RISK_038_03

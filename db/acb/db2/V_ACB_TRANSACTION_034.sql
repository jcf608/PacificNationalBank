-- ============================================================
-- DB2 Objects for transaction domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRANSACTION_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRANSACTION_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_034_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_034_01
  ON ACB.TRANSACTION_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TRANSACTION_034_02
  ON ACB.TRANSACTION_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TRANSACTION_034_03

-- ============================================================
-- DB2 Objects for hold domain — variant 45
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_HOLD_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_HOLD_045_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_045_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_045_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_045_02

-- ============================================================
-- DB2 Objects for ach domain — variant 39
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ACH_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACH_039_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_039_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_039_01
  ON ACB.ACH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ACH_039_02
  ON ACB.ACH_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ACH_039_03
  ON ACB.ACH_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_ACH_039_04

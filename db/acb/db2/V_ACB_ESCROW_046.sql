-- ============================================================
-- DB2 Objects for escrow domain — variant 46
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ESCROW_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ESCROW_046_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_046_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_046_01
  ON ACB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ESCROW_046_02
  ON ACB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_ESCROW_046_03

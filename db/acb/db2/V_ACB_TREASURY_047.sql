-- ============================================================
-- DB2 Objects for treasury domain — variant 47
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TREASURY_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TREASURY_047_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_047_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_047_01
  ON ACB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TREASURY_047_02
  ON ACB.TREASURY_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_TREASURY_047_03
  ON ACB.TREASURY_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_TREASURY_047_04
  ON ACB.TREASURY_MASTER (COL_004 ASC);

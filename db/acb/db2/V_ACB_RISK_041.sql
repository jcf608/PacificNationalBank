...
CREATE TRIGGER ACB.TRG_RISK_041_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_041_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_041_01
  ON ACB.RISK_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_RISK_041_02

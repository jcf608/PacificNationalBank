...
CREATE TRIGGER ACB.TRG_WIRE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_044_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_044_01

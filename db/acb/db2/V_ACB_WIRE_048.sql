...
CREATE TRIGGER ACB.TRG_WIRE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_048_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_048_01

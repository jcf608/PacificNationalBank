...
CREATE TRIGGER ACB.TRG_HOLD_033_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_033_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_033_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_033_02

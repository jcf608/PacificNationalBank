...
CREATE VIEW ACB.V_TRUST_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRUST_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRUST_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRUST_040_00
  ON ACB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRUST_040_01

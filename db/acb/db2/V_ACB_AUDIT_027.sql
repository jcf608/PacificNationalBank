...
CREATE VIEW ACB.V_AUDIT_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_AUDIT_027_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_AUDIT_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_AUDIT_027_00
  ON ACB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_AUDIT_027_01
  ON ACB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_AUDIT_027_02
  ON ACB.AUDIT_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_AUDIT_027_03
  ON ACB.AUDIT_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_AUDIT_027_04

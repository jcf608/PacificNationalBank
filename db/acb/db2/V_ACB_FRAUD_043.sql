-- ============================================================
-- DB2 Objects for fraud domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FRAUD_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FRAUD_043_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FRAUD_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FRAUD_043_00
  ON ACB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FRAUD_043_01
  ON ACB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FRAUD_043_02
  ON ACB.FRAUD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FRAUD_043_03
  ON ACB.FRAUD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_FRAUD_043_04

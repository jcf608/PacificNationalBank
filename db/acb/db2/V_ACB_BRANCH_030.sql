-- ============================================================
-- DB2 Objects for branch domain — variant 30
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_BRANCH_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_019,
    COL_020,
  FROM ACB.BRANCH_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_BRANCH_030_UPDATE
  AFTER UPDATE ON ACB.BRANCH_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.BRANCH_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'BRANCH_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_BRANCH_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_BRANCH_030_00
  ON ACB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_BRANCH_030_01
  ON ACB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_BRANCH_030_02
  ON ACB.BRANCH_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_BRANCH_030_03
  ON ACB.BRANCH_MASTER (COL_003 ASC);

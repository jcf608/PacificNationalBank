...
CREATE TRIGGER ACB.TRG_CARD_049_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CARD_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CARD_049_00
  ON ACB.CARD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CARD_049_01
  ON ACB.CARD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CARD_049_02

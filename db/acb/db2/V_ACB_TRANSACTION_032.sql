-- ============================================================
-- DB2 Objects for transaction domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRANSACTION_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_021,
    COL_022,
  FROM ACB.TRANSACTION_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_TRANSACTION_032_UPDATE
  AFTER UPDATE ON ACB.TRANSACTION_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.TRANSACTION_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'TRANSACTION_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRANSACTION_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRANSACTION_032_00
  ON ACB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRANSACTION_032_01
  ON ACB.TRANSACTION_MASTER (COL_001 ASC);

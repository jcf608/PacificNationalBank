-- ============================================================
-- DB2 Objects for stop domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_STOP_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_017,
    COL_018,
  FROM ACB.STOP_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_STOP_043_UPDATE
  AFTER UPDATE ON ACB.STOP_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.STOP_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'STOP_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_043_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_043_01
  ON ACB.STOP_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_STOP_043_02
  ON ACB.STOP_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_STOP_043_03
  ON ACB.STOP_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_STOP_043_04
  ON ACB.STOP_MASTER (COL_004 ASC);

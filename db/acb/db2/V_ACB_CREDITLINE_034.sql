-- ============================================================
-- DB2 Objects for creditline domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_CREDITLINE_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_CREDITLINE_034_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_CREDITLINE_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_CREDITLINE_034_00
  ON ACB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_CREDITLINE_034_01
  ON ACB.CREDITLINE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_CREDITLINE_034_02
  ON ACB.CREDITLINE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_CREDITLINE_034_03

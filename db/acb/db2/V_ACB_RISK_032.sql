...
CREATE TRIGGER ACB.TRG_RISK_032_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_RISK_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_RISK_032_00
  ON ACB.RISK_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_RISK_032_01

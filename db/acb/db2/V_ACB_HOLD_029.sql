...
CREATE TRIGGER ACB.TRG_HOLD_029_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_029_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_029_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_029_02

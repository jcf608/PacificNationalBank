...
CREATE VIEW ACB.V_TREASURY_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TREASURY_036_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TREASURY_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TREASURY_036_00
  ON ACB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TREASURY_036_01

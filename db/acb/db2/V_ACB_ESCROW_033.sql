...
CREATE VIEW ACB.V_ESCROW_033 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ESCROW_033_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ESCROW_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ESCROW_033_00
  ON ACB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ESCROW_033_01
  ON ACB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_ESCROW_033_02

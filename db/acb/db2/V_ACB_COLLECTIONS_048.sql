-- ============================================================
-- DB2 Objects for collections domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COLLECTIONS_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COLLECTIONS_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COLLECTIONS_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COLLECTIONS_048_00
  ON ACB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_048_01

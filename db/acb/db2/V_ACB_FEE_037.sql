...
CREATE TRIGGER ACB.TRG_FEE_037_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_037_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_037_01
  ON ACB.FEE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FEE_037_02

-- ============================================================
-- DB2 Objects for trust domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRUST_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRUST_037_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRUST_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRUST_037_00
  ON ACB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRUST_037_01
  ON ACB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TRUST_037_02

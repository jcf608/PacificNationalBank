...
CREATE TRIGGER ACB.TRG_STOP_037_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_STOP_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_STOP_037_00
  ON ACB.STOP_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_STOP_037_01
  ON ACB.STOP_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_STOP_037_02

-- ============================================================
-- DB2 Objects for ach domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_ACH_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_ACH_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_ACH_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_ACH_048_00
  ON ACB.ACH_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_ACH_048_01

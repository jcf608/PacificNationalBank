-- ============================================================
-- DB2 Objects for heloc domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_HELOC_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_HELOC_028_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HELOC_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HELOC_028_00
  ON ACB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HELOC_028_01

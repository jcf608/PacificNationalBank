...
CREATE TRIGGER ACB.TRG_HOLD_027_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_027_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_027_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_027_02
  ON ACB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HOLD_027_03
  ON ACB.HOLD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_HOLD_027_04

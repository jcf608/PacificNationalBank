...
CREATE TRIGGER ACB.TRG_WIRE_031_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_WIRE_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_WIRE_031_00
  ON ACB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_WIRE_031_01
  ON ACB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_WIRE_031_02
  ON ACB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_WIRE_031_03
  ON ACB.WIRE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_WIRE_031_04

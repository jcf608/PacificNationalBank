-- ============================================================
-- DB2 Objects for hold domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_HOLD_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_HOLD_031_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_HOLD_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_HOLD_031_00
  ON ACB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_HOLD_031_01
  ON ACB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_HOLD_031_02
  ON ACB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_HOLD_031_03
  ON ACB.HOLD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_HOLD_031_04

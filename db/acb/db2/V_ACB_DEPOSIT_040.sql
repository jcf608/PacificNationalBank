...
CREATE VIEW ACB.V_DEPOSIT_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_DEPOSIT_040_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_DEPOSIT_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_DEPOSIT_040_00
  ON ACB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_DEPOSIT_040_01

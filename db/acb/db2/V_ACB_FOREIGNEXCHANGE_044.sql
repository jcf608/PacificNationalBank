...
CREATE VIEW ACB.V_FOREIGNEXCHANGE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FOREIGNEXCHANGE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FOREIGNEXCHANGE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FOREIGNEXCHANGE_044_00
  ON ACB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FOREIGNEXCHANGE_044_01

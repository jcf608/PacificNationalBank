-- ============================================================
-- DB2 Objects for collections domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COLLECTIONS_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_021,
    COL_022,
  FROM ACB.COLLECTIONS_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_COLLECTIONS_036_UPDATE
  AFTER UPDATE ON ACB.COLLECTIONS_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.COLLECTIONS_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_COLLECTIONS_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COLLECTIONS_036_00
  ON ACB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COLLECTIONS_036_01
  ON ACB.COLLECTIONS_MASTER (COL_001 ASC);

-- ============================================================
-- DB2 Objects for loan domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_LOAN_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_LOAN_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LOAN_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LOAN_048_00
  ON ACB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LOAN_048_01

...
CREATE TRIGGER ACB.TRG_FEE_047_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FEE_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FEE_047_00
  ON ACB.FEE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FEE_047_01
  ON ACB.FEE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FEE_047_02
  ON ACB.FEE_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FEE_047_03
  ON ACB.FEE_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_FEE_047_04

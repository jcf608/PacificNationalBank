-- ============================================================
-- DB2 Objects for compliance domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_COMPLIANCE_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_008,
    COL_009,
  FROM ACB.COMPLIANCE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER ACB.TRG_COMPLIANCE_040_UPDATE
  AFTER UPDATE ON ACB.COMPLIANCE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO ACB.COMPLIANCE_AUDIT (
...
CREATE OR REPLACE PROCEDURE ACB.SP_COMPLIANCE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COMPLIANCE_040_00
  ON ACB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_040_01
  ON ACB.COMPLIANCE_MASTER (COL_001 ASC);

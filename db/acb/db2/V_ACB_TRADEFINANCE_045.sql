-- ============================================================
-- DB2 Objects for tradefinance domain — variant 45
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_TRADEFINANCE_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_TRADEFINANCE_045_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_TRADEFINANCE_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_TRADEFINANCE_045_00
  ON ACB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_TRADEFINANCE_045_01
  ON ACB.TRADEFINANCE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_TRADEFINANCE_045_02

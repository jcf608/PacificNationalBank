...
CREATE VIEW ACB.V_COMPLIANCE_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_COMPLIANCE_041_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_COMPLIANCE_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_COMPLIANCE_041_00
  ON ACB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_041_01
  ON ACB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_COMPLIANCE_041_02

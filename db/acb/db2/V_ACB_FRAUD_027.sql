-- ============================================================
-- DB2 Objects for fraud domain — variant 27
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_FRAUD_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_FRAUD_027_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_FRAUD_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_FRAUD_027_00
  ON ACB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_FRAUD_027_01
  ON ACB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX ACB.IX_FRAUD_027_02
  ON ACB.FRAUD_MASTER (COL_002 ASC);

CREATE INDEX ACB.IX_FRAUD_027_03
  ON ACB.FRAUD_MASTER (COL_003 ASC);

CREATE INDEX ACB.IX_FRAUD_027_04

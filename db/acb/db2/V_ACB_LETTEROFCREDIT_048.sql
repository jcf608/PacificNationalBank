-- ============================================================
-- DB2 Objects for letterofcredit domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW ACB.V_LETTEROFCREDIT_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER ACB.TRG_LETTEROFCREDIT_048_UPDATE
...
CREATE OR REPLACE PROCEDURE ACB.SP_LETTEROFCREDIT_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX ACB.IX_LETTEROFCREDIT_048_00
  ON ACB.LETTEROFCREDIT_MASTER (COL_000 ASC);

CREATE INDEX ACB.IX_LETTEROFCREDIT_048_01

-- ============================================================
-- DB2 Objects for deposit domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_DEPOSIT_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_DEPOSIT_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_DEPOSIT_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_DEPOSIT_043_00
  ON PNB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_DEPOSIT_043_01
  ON PNB.DEPOSIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_DEPOSIT_043_02
  ON PNB.DEPOSIT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_DEPOSIT_043_03
  ON PNB.DEPOSIT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_DEPOSIT_043_04

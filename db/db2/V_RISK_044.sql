-- ============================================================
-- DB2 Objects for risk domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RISK_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RISK_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_044_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_044_01

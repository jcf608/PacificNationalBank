...
CREATE VIEW PNB.V_ESCROW_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_032_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_032_01

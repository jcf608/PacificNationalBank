...
CREATE VIEW PNB.V_ACCOUNT_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ACCOUNT_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACCOUNT_036_00
  ON PNB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACCOUNT_036_01

...
CREATE TRIGGER PNB.TRG_RATE_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_041_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_041_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_041_02

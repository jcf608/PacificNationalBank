-- ============================================================
-- DB2 Objects for tradefinance domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRADEFINANCE_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRADEFINANCE_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRADEFINANCE_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRADEFINANCE_041_00
  ON PNB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRADEFINANCE_041_01
  ON PNB.TRADEFINANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRADEFINANCE_041_02

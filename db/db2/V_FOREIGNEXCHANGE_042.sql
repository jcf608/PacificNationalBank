...
CREATE VIEW PNB.V_FOREIGNEXCHANGE_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FOREIGNEXCHANGE_042_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FOREIGNEXCHANGE_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FOREIGNEXCHANGE_042_00
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_042_01
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_042_02
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_042_03

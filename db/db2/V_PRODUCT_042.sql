-- ============================================================
-- DB2 Objects for product domain — variant 42
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_PRODUCT_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_042_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_042_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_042_01
  ON PNB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_PRODUCT_042_02
  ON PNB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_PRODUCT_042_03

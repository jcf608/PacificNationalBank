-- ============================================================
-- DB2 Objects for stop domain — variant 35
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_STOP_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_008,
    COL_009,
  FROM PNB.STOP_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_STOP_035_UPDATE
  AFTER UPDATE ON PNB.STOP_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.STOP_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_035_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_035_01
  ON PNB.STOP_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_STOP_035_02
  ON PNB.STOP_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_STOP_035_03
  ON PNB.STOP_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_STOP_035_04
  ON PNB.STOP_MASTER (COL_004 ASC);

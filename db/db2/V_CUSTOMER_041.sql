...
CREATE VIEW PNB.V_CUSTOMER_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_041_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_041_01
  ON PNB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CUSTOMER_041_02

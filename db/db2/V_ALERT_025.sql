-- ============================================================
-- DB2 Objects for alert domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ALERT_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_025_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_025_01
  ON PNB.ALERT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ALERT_025_02

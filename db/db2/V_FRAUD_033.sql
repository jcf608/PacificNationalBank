...
CREATE VIEW PNB.V_FRAUD_033 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FRAUD_033_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_033_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_033_01
  ON PNB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FRAUD_033_02

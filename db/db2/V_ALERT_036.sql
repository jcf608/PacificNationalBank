-- ============================================================
-- DB2 Objects for alert domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ALERT_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_036_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_036_01

...
CREATE VIEW PNB.V_PRODUCT_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_036_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_036_01

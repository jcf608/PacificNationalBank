...
CREATE VIEW PNB.V_CREDITLINE_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_025_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_025_01
  ON PNB.CREDITLINE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CREDITLINE_025_02

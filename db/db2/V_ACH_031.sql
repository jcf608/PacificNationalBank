...
CREATE TRIGGER PNB.TRG_ACH_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_031_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_031_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_031_02
  ON PNB.ACH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACH_031_03
  ON PNB.ACH_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_ACH_031_04
  ON PNB.ACH_MASTER (COL_004 ASC);

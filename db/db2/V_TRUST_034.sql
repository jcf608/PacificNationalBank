...
CREATE VIEW PNB.V_TRUST_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_034_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_034_01
  ON PNB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRUST_034_02
  ON PNB.TRUST_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TRUST_034_03

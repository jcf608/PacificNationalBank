...
CREATE VIEW PNB.V_DEPOSIT_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_DEPOSIT_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_DEPOSIT_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_DEPOSIT_030_00
  ON PNB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_DEPOSIT_030_01
  ON PNB.DEPOSIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_DEPOSIT_030_02
  ON PNB.DEPOSIT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_DEPOSIT_030_03

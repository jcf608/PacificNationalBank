-- ============================================================
-- DB2 Objects for deposit domain — variant 45
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_DEPOSIT_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_DEPOSIT_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_DEPOSIT_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_DEPOSIT_045_00
  ON PNB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_DEPOSIT_045_01
  ON PNB.DEPOSIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_DEPOSIT_045_02

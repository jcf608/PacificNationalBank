...
CREATE TRIGGER PNB.TRG_STOP_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_040_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_040_01

-- ============================================================
-- DB2 Objects for stop domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_STOP_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_STOP_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_048_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_048_01

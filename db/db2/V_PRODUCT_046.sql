-- ============================================================
-- DB2 Objects for product domain — variant 46
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_PRODUCT_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_046_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_046_01
  ON PNB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_PRODUCT_046_02
  ON PNB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_PRODUCT_046_03

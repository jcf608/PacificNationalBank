-- ============================================================
-- DB2 Objects for rate domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RATE_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RATE_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_032_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_032_01

-- ============================================================
-- DB2 Objects for fraud domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FRAUD_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FRAUD_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_028_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_028_01

-- ============================================================
-- DB2 Objects for fee domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FEE_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FEE_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_032_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_032_01

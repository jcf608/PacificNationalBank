...
CREATE TRIGGER PNB.TRG_RATE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_048_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_048_01

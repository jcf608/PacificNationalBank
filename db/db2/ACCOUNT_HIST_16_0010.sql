-- ============================================================
-- DDL for ACCOUNT_HIST_16_0010
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.ACCOUNT_HIST_16_0010 (
...
CREATE UNIQUE INDEX PNB.IX_ACCOUNT_H160010_PK
    ON PNB.ACCOUNT_HIST_16_0010 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_H160010 (
    IN p_key CHAR(16),

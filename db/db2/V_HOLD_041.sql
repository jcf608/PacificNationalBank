...
CREATE TRIGGER PNB.TRG_HOLD_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_041_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_041_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_041_02

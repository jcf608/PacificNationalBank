-- ============================================================
-- DB2 Objects for account domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ACCOUNT_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_023,
    COL_024
  FROM PNB.ACCOUNT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_ACCOUNT_034_UPDATE
  AFTER UPDATE ON PNB.ACCOUNT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.ACCOUNT_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'ACCOUNT_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACCOUNT_034_00
  ON PNB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACCOUNT_034_01
  ON PNB.ACCOUNT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACCOUNT_034_02
  ON PNB.ACCOUNT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACCOUNT_034_03
  ON PNB.ACCOUNT_MASTER (COL_003 ASC);

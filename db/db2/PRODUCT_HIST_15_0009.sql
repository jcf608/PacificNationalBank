-- ============================================================
-- DDL for PRODUCT_HIST_15_0009
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.PRODUCT_HIST_15_0009 (
    COL_000    CHAR(3) ,
...
CREATE UNIQUE INDEX PNB.IX_PRODUCT_H150009_PK
    ON PNB.PRODUCT_HIST_15_0009 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_H150009 (
    IN p_key CHAR(16),

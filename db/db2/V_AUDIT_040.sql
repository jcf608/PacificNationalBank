...
CREATE VIEW PNB.V_AUDIT_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_040_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_040_01

-- ============================================================
-- DDL for ACCOUNT_HIST_15_0133
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.ACCOUNT_HIST_15_0133 (
...
CREATE UNIQUE INDEX PNB.IX_ACCOUNT_H150133_PK
    ON PNB.ACCOUNT_HIST_15_0133 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_H150133 (
    IN p_key CHAR(16),

...
CREATE VIEW PNB.V_BRANCH_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_025_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_025_01
  ON PNB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_BRANCH_025_02

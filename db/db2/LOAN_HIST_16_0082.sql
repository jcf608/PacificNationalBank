-- ============================================================
-- DDL for LOAN_HIST_16_0082
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.LOAN_HIST_16_0082 (
...
CREATE UNIQUE INDEX PNB.IX_LOAN_H160082_PK
    ON PNB.LOAN_HIST_16_0082 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_H160082 (
    IN p_key CHAR(16),

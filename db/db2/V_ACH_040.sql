...
CREATE TRIGGER PNB.TRG_ACH_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_040_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_040_01

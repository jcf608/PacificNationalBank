...
CREATE VIEW PNB.V_HELOC_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_029_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_029_01
  ON PNB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HELOC_029_02

...
CREATE TRIGGER PNB.TRG_RATE_033_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_033_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_033_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_033_02

-- ============================================================
-- DB2 Objects for loan domain — variant 26
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_LOAN_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_LOAN_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_026_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_026_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_026_02
  ON PNB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_LOAN_026_03

-- ============================================================
-- DB2 Objects for compliance domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COMPLIANCE_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_037_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_037_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_037_02

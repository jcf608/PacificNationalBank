...
CREATE TRIGGER PNB.TRG_WIRE_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_029_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_029_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_029_02

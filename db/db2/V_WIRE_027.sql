...
CREATE TRIGGER PNB.TRG_WIRE_027_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_027_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_027_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_027_02
  ON PNB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_WIRE_027_03
  ON PNB.WIRE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_WIRE_027_04

-- ============================================================
-- DB2 Objects for customer domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CUSTOMER_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_036_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_036_01

...
CREATE VIEW PNB.V_BRANCH_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_034_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_034_01
  ON PNB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_BRANCH_034_02
  ON PNB.BRANCH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_BRANCH_034_03

...
CREATE VIEW PNB.V_TREASURY_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TREASURY_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TREASURY_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TREASURY_047_00
  ON PNB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TREASURY_047_01
  ON PNB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TREASURY_047_02
  ON PNB.TREASURY_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TREASURY_047_03
  ON PNB.TREASURY_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_TREASURY_047_04

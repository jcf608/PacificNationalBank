-- ============================================================
-- DB2 Objects for fee domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FEE_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FEE_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_028_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_028_01

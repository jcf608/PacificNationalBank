...
CREATE VIEW PNB.V_TREASURY_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TREASURY_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TREASURY_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TREASURY_026_00
  ON PNB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TREASURY_026_01
  ON PNB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TREASURY_026_02
  ON PNB.TREASURY_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TREASURY_026_03

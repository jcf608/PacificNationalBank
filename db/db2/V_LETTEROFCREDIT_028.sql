-- ============================================================
-- DB2 Objects for letterofcredit domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_LETTEROFCREDIT_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_LETTEROFCREDIT_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LETTEROFCREDIT_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LETTEROFCREDIT_028_00
  ON PNB.LETTEROFCREDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LETTEROFCREDIT_028_01

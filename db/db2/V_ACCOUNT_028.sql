-- ============================================================
-- DB2 Objects for account domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ACCOUNT_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ACCOUNT_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACCOUNT_028_00
  ON PNB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACCOUNT_028_01

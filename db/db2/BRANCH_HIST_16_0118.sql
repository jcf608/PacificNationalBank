-- ============================================================
-- DDL for BRANCH_HIST_16_0118
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.BRANCH_HIST_16_0118 (
    COL_000    CHAR(3) ,
...
CREATE UNIQUE INDEX PNB.IX_BRANCH_H160118_PK
    ON PNB.BRANCH_HIST_16_0118 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_H160118 (
    IN p_key CHAR(16),

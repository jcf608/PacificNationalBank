-- ============================================================
-- DDL for LOAN_HIST_15_0065
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.LOAN_HIST_15_0065 (
...
CREATE UNIQUE INDEX PNB.IX_LOAN_H150065_PK
    ON PNB.LOAN_HIST_15_0065 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_H150065 (
    IN p_key CHAR(16),

...
CREATE VIEW PNB.V_HELOC_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_044_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_044_01

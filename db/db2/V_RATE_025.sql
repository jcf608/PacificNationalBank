...
CREATE TRIGGER PNB.TRG_RATE_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_025_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_025_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_025_02

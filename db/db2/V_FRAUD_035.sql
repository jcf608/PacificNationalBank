-- ============================================================
-- DB2 Objects for fraud domain — variant 35
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FRAUD_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FRAUD_035_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_035_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_035_01
  ON PNB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FRAUD_035_02
  ON PNB.FRAUD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FRAUD_035_03
  ON PNB.FRAUD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_FRAUD_035_04

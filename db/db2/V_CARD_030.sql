...
CREATE TRIGGER PNB.TRG_CARD_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_030_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_030_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_030_02
  ON PNB.CARD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CARD_030_03

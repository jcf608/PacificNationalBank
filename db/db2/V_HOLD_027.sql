-- ============================================================
-- DB2 Objects for hold domain — variant 27
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HOLD_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HOLD_027_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_027_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_027_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_027_02
  ON PNB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HOLD_027_03
  ON PNB.HOLD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_HOLD_027_04

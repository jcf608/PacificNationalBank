...
CREATE TRIGGER PNB.TRG_FEE_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_043_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_043_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_043_02
  ON PNB.FEE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FEE_043_03
  ON PNB.FEE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_FEE_043_04

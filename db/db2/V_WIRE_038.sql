...
CREATE TRIGGER PNB.TRG_WIRE_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_038_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_038_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_038_02
  ON PNB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_WIRE_038_03

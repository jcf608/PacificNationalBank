...
CREATE TRIGGER PNB.TRG_FEE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_036_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_036_01

...
CREATE TRIGGER PNB.TRG_HOLD_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_048_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_048_01

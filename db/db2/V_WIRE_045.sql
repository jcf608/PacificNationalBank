...
CREATE TRIGGER PNB.TRG_WIRE_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_045_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_045_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_045_02

-- ============================================================
-- DDL for ACCOUNT_HIST_16_0161
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.ACCOUNT_HIST_16_0161 (
...
CREATE UNIQUE INDEX PNB.IX_ACCOUNT_H160161_PK
    ON PNB.ACCOUNT_HIST_16_0161 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_H160161 (
    IN p_key CHAR(16),

-- ============================================================
-- DB2 Objects for loan domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_LOAN_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_LOAN_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_040_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_040_01

...
CREATE VIEW PNB.V_HELOC_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_035_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_035_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_035_01
  ON PNB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HELOC_035_02
  ON PNB.HELOC_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HELOC_035_03
  ON PNB.HELOC_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_HELOC_035_04

-- ============================================================
-- DB2 Objects for compliance domain — variant 46
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COMPLIANCE_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_046_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_046_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_046_02
  ON PNB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_046_03

...
CREATE VIEW PNB.V_CREDITLINE_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_045_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_045_01
  ON PNB.CREDITLINE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CREDITLINE_045_02

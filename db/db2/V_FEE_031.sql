...
CREATE TRIGGER PNB.TRG_FEE_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_031_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_031_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_031_02
  ON PNB.FEE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FEE_031_03
  ON PNB.FEE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_FEE_031_04

-- ============================================================
-- DB2 Objects for tradefinance domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRADEFINANCE_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRADEFINANCE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRADEFINANCE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRADEFINANCE_040_00
  ON PNB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRADEFINANCE_040_01

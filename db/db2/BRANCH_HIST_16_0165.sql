-- ============================================================
-- DDL for BRANCH_HIST_16_0165
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.BRANCH_HIST_16_0165 (
...
CREATE UNIQUE INDEX PNB.IX_BRANCH_H160165_PK
    ON PNB.BRANCH_HIST_16_0165 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_H160165 (
    IN p_key CHAR(16),

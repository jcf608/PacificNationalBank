-- ============================================================
-- DB2 Objects for alert domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ALERT_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_048_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_048_01

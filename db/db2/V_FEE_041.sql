...
CREATE TRIGGER PNB.TRG_FEE_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_041_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_041_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_041_02

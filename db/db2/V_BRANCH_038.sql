-- ============================================================
-- DB2 Objects for branch domain — variant 38
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_BRANCH_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_038_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_038_01
  ON PNB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_BRANCH_038_02
  ON PNB.BRANCH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_BRANCH_038_03

...
CREATE VIEW PNB.V_TRADEFINANCE_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_011,
    COL_012,
  FROM PNB.TRADEFINANCE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_TRADEFINANCE_032_UPDATE
  AFTER UPDATE ON PNB.TRADEFINANCE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.TRADEFINANCE_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRADEFINANCE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRADEFINANCE_032_00
  ON PNB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRADEFINANCE_032_01
  ON PNB.TRADEFINANCE_MASTER (COL_001 ASC);

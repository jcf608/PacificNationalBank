-- ============================================================
-- DDL for LOAN_HIST_16_0149
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.LOAN_HIST_16_0149 (
...
CREATE UNIQUE INDEX PNB.IX_LOAN_H160149_PK
    ON PNB.LOAN_HIST_16_0149 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_H160149 (
    IN p_key CHAR(16),

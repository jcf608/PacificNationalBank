...
CREATE VIEW PNB.V_CUSTOMER_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_032_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_032_01

...
CREATE VIEW PNB.V_BRANCH_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_028_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_028_01

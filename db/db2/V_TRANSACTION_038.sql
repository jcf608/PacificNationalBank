...
CREATE VIEW PNB.V_TRANSACTION_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRANSACTION_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRANSACTION_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRANSACTION_038_00
  ON PNB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRANSACTION_038_01
  ON PNB.TRANSACTION_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRANSACTION_038_02
  ON PNB.TRANSACTION_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TRANSACTION_038_03

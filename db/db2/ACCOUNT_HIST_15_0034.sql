-- ============================================================
-- DDL for ACCOUNT_HIST_15_0034
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.ACCOUNT_HIST_15_0034 (
...
CREATE UNIQUE INDEX PNB.IX_ACCOUNT_H150034_PK
    ON PNB.ACCOUNT_HIST_15_0034 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_H150034 (
    IN p_key CHAR(16),

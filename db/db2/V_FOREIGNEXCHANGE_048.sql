-- ============================================================
-- DB2 Objects for foreignexchange domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FOREIGNEXCHANGE_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FOREIGNEXCHANGE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FOREIGNEXCHANGE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FOREIGNEXCHANGE_048_00
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_048_01

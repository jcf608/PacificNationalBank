-- ============================================================
-- DB2 Objects for product domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_PRODUCT_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_044_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_044_01

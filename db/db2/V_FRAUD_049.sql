...
CREATE VIEW PNB.V_FRAUD_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FRAUD_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_049_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_049_01
  ON PNB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FRAUD_049_02

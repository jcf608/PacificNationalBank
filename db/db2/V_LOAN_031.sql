...
CREATE TRIGGER PNB.TRG_LOAN_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_031_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_031_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_031_02
  ON PNB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_LOAN_031_03
  ON PNB.LOAN_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_LOAN_031_04

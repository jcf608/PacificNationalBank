...
CREATE VIEW PNB.V_FRAUD_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FRAUD_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_041_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_041_01
  ON PNB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FRAUD_041_02

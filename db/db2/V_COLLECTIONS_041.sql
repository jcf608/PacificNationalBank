-- ============================================================
-- DB2 Objects for collections domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COLLECTIONS_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COLLECTIONS_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COLLECTIONS_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COLLECTIONS_041_00
  ON PNB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_041_01
  ON PNB.COLLECTIONS_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_041_02

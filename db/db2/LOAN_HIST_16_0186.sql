-- ============================================================
-- DDL for LOAN_HIST_16_0186
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.LOAN_HIST_16_0186 (
...
CREATE UNIQUE INDEX PNB.IX_LOAN_H160186_PK
    ON PNB.LOAN_HIST_16_0186 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_H160186 (
    IN p_key CHAR(16),

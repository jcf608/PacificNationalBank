-- ============================================================
-- DDL for PRODUCT_HIST_15_0145
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.PRODUCT_HIST_15_0145 (
...
CREATE UNIQUE INDEX PNB.IX_PRODUCT_H150145_PK
    ON PNB.PRODUCT_HIST_15_0145 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_H150145 (
    IN p_key CHAR(16),

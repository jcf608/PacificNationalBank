-- ============================================================
-- DB2 Objects for alert domain — variant 49
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ALERT_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_049_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_049_01
  ON PNB.ALERT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ALERT_049_02

...
CREATE VIEW PNB.V_TRANSACTION_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRANSACTION_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRANSACTION_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRANSACTION_026_00
  ON PNB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRANSACTION_026_01
  ON PNB.TRANSACTION_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRANSACTION_026_02
  ON PNB.TRANSACTION_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TRANSACTION_026_03

-- ============================================================
-- DDL for ACCOUNT_HIST_16_0097
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.ACCOUNT_HIST_16_0097 (
...
CREATE UNIQUE INDEX PNB.IX_ACCOUNT_H160097_PK
    ON PNB.ACCOUNT_HIST_16_0097 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_H160097 (
    IN p_key CHAR(16),

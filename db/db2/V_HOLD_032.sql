...
CREATE TRIGGER PNB.TRG_HOLD_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_032_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_032_01

...
CREATE TRIGGER PNB.TRG_RATE_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_038_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_038_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_038_02
  ON PNB.RATE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RATE_038_03

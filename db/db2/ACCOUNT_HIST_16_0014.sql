-- ============================================================
-- DDL for ACCOUNT_HIST_16_0014
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.ACCOUNT_HIST_16_0014 (
...
CREATE UNIQUE INDEX PNB.IX_ACCOUNT_H160014_PK
    ON PNB.ACCOUNT_HIST_16_0014 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_H160014 (
    IN p_key CHAR(16),

...
CREATE VIEW PNB.V_RISK_039 AS
  SELECT
    ...
    COL_018,
    COL_019,
  FROM PNB.RISK_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_RISK_039_UPDATE
  AFTER UPDATE ON PNB.RISK_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.RISK_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_039_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_039_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_039_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_039_03
  ON PNB.RISK_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_RISK_039_04
  ON PNB.RISK_MASTER (COL_004 ASC);

...
CREATE VIEW PNB.V_TRANSACTION_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_021,
    COL_022,
  FROM PNB.TRANSACTION_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_TRANSACTION_032_UPDATE
  AFTER UPDATE ON PNB.TRANSACTION_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.TRANSACTION_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRANSACTION_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRANSACTION_032_00
  ON PNB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRANSACTION_032_01
  ON PNB.TRANSACTION_MASTER (COL_001 ASC);

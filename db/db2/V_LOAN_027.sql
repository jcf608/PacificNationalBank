...
CREATE VIEW PNB.V_LOAN_027 AS
  SELECT
    ...
    COL_009,
    COL_010,
  FROM PNB.LOAN_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_LOAN_027_UPDATE
  AFTER UPDATE ON PNB.LOAN_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.LOAN_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_027_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_027_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_027_02
  ON PNB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_LOAN_027_03
  ON PNB.LOAN_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_LOAN_027_04
  ON PNB.LOAN_MASTER (COL_004 ASC);

-- ============================================================
-- DB2 Objects for customer domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CUSTOMER_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_048_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_048_01

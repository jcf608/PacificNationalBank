...
CREATE TRIGGER PNB.TRG_ACH_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_044_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_044_01

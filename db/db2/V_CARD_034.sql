...
CREATE TRIGGER PNB.TRG_CARD_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_034_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_034_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_034_02
  ON PNB.CARD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CARD_034_03

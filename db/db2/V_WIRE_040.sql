-- ============================================================
-- DB2 Objects for wire domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_WIRE_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_WIRE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_040_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_040_01

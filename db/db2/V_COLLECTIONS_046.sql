...
CREATE VIEW PNB.V_COLLECTIONS_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COLLECTIONS_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COLLECTIONS_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COLLECTIONS_046_00
  ON PNB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_046_01
  ON PNB.COLLECTIONS_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_046_02
  ON PNB.COLLECTIONS_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_046_03

-- ============================================================
-- DB2 Objects for mortgage domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_MORTGAGE_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_040_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_040_01

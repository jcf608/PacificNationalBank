-- ============================================================
-- DDL for ACCOUNT_HIST_15_0168
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.ACCOUNT_HIST_15_0168 (
    COL_000    SMALLINT ,
...
CREATE UNIQUE INDEX PNB.IX_ACCOUNT_H150168_PK
    ON PNB.ACCOUNT_HIST_15_0168 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_H150168 (
    IN p_key CHAR(16),

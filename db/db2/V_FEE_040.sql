...
CREATE TRIGGER PNB.TRG_FEE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_040_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_040_01

-- ============================================================
-- DB2 Objects for cashmanagement domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CASHMANAGEMENT_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CASHMANAGEMENT_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CASHMANAGEMENT_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CASHMANAGEMENT_037_00
  ON PNB.CASHMANAGEMENT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_037_01
  ON PNB.CASHMANAGEMENT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_037_02

-- ============================================================
-- DDL for LOAN_HIST_16_0023
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.LOAN_HIST_16_0023 (
    COL_000    TIMESTAMP ,
...
CREATE UNIQUE INDEX PNB.IX_LOAN_H160023_PK
    ON PNB.LOAN_HIST_16_0023 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_H160023 (
    IN p_key CHAR(16),

...
CREATE TRIGGER PNB.TRG_LOAN_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_048_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_048_01

...
CREATE TRIGGER PNB.TRG_FEE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_048_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_048_01

-- ============================================================
-- DB2 Objects for branch domain — variant 45
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_BRANCH_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_045_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_045_01
  ON PNB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_BRANCH_045_02

-- ============================================================
-- DB2 Objects for account domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ACCOUNT_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ACCOUNT_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACCOUNT_048_00
  ON PNB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACCOUNT_048_01

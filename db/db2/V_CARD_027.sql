-- ============================================================
-- DB2 Objects for card domain — variant 27
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CARD_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_009,
    COL_010,
  FROM PNB.CARD_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_CARD_027_UPDATE
  AFTER UPDATE ON PNB.CARD_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.CARD_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'CARD_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_027_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_027_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_027_02
  ON PNB.CARD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CARD_027_03
  ON PNB.CARD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_CARD_027_04
  ON PNB.CARD_MASTER (COL_004 ASC);

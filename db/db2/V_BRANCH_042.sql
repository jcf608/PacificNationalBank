-- ============================================================
-- DB2 Objects for branch domain — variant 42
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_BRANCH_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_022,
    COL_023,
  FROM PNB.BRANCH_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_BRANCH_042_UPDATE
  AFTER UPDATE ON PNB.BRANCH_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.BRANCH_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_042_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_042_01
  ON PNB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_BRANCH_042_02
  ON PNB.BRANCH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_BRANCH_042_03
  ON PNB.BRANCH_MASTER (COL_003 ASC);

-- ============================================================
-- DB2 Objects for wire domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_WIRE_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_022,
    COL_023,
  FROM PNB.WIRE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_WIRE_031_UPDATE
  AFTER UPDATE ON PNB.WIRE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.WIRE_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_031_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_031_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_031_02
  ON PNB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_WIRE_031_03
  ON PNB.WIRE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_WIRE_031_04
  ON PNB.WIRE_MASTER (COL_004 ASC);

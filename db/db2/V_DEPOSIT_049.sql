-- ============================================================
-- DB2 Objects for deposit domain — variant 49
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_DEPOSIT_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_016,
    COL_017,
  FROM PNB.DEPOSIT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_DEPOSIT_049_UPDATE
  AFTER UPDATE ON PNB.DEPOSIT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.DEPOSIT_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'DEPOSIT_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE PNB.SP_DEPOSIT_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_DEPOSIT_049_00
  ON PNB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_DEPOSIT_049_01
  ON PNB.DEPOSIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_DEPOSIT_049_02
  ON PNB.DEPOSIT_MASTER (COL_002 ASC);

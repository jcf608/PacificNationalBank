...
CREATE VIEW PNB.V_TREASURY_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TREASURY_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TREASURY_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TREASURY_044_00
  ON PNB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TREASURY_044_01

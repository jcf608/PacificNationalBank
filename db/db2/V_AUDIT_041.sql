...
CREATE VIEW PNB.V_AUDIT_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_041_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_041_01
  ON PNB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_AUDIT_041_02

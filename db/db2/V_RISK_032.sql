-- ============================================================
-- DB2 Objects for risk domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RISK_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RISK_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_032_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_032_01

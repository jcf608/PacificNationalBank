-- ============================================================
-- DB2 Objects for customer domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CUSTOMER_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_040_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_040_01

-- ============================================================
-- DB2 Objects for foreignexchange domain — variant 45
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FOREIGNEXCHANGE_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FOREIGNEXCHANGE_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FOREIGNEXCHANGE_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FOREIGNEXCHANGE_045_00
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_045_01
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_045_02

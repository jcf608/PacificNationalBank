...
CREATE VIEW PNB.V_CREDITLINE_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_028_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_028_01

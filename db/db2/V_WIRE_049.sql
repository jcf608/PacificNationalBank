...
CREATE TRIGGER PNB.TRG_WIRE_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_049_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_049_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_049_02

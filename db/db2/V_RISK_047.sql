...
CREATE TRIGGER PNB.TRG_RISK_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_047_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_047_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_047_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_047_03
  ON PNB.RISK_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_RISK_047_04

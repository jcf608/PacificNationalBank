...
CREATE VIEW PNB.V_AUDIT_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_038_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_038_01
  ON PNB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_AUDIT_038_02
  ON PNB.AUDIT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_AUDIT_038_03

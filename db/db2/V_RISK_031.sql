...
CREATE TRIGGER PNB.TRG_RISK_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_031_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_031_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_031_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_031_03
  ON PNB.RISK_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_RISK_031_04

...
CREATE TRIGGER PNB.TRG_LOAN_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_047_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_047_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_047_02
  ON PNB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_LOAN_047_03
  ON PNB.LOAN_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_LOAN_047_04

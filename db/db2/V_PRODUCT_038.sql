...
CREATE VIEW PNB.V_PRODUCT_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_023,
    COL_024
  FROM PNB.PRODUCT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_PRODUCT_038_UPDATE
  AFTER UPDATE ON PNB.PRODUCT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.PRODUCT_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_038_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_038_01
  ON PNB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_PRODUCT_038_02
  ON PNB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_PRODUCT_038_03
  ON PNB.PRODUCT_MASTER (COL_003 ASC);

-- ============================================================
-- DB2 Objects for creditline domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CREDITLINE_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_048_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_048_01

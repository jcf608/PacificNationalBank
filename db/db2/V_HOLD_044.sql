-- ============================================================
-- DB2 Objects for hold domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HOLD_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HOLD_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_044_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_044_01

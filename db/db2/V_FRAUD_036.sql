...
CREATE VIEW PNB.V_FRAUD_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FRAUD_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_036_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_036_01

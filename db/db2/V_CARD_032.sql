-- ============================================================
-- DB2 Objects for card domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CARD_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CARD_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_032_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_032_01

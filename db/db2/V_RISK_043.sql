...
CREATE TRIGGER PNB.TRG_RISK_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_043_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_043_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_043_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_043_03
  ON PNB.RISK_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_RISK_043_04

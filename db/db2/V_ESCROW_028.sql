-- ============================================================
-- DB2 Objects for escrow domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ESCROW_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_028_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_028_01

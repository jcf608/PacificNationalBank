...
CREATE VIEW PNB.V_MORTGAGE_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_047_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_047_01
  ON PNB.MORTGAGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_MORTGAGE_047_02
  ON PNB.MORTGAGE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_MORTGAGE_047_03
  ON PNB.MORTGAGE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_MORTGAGE_047_04
  ON PNB.MORTGAGE_MASTER (COL_004 ASC);

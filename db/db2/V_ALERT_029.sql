...
CREATE VIEW PNB.V_ALERT_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_029_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_029_01
  ON PNB.ALERT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ALERT_029_02

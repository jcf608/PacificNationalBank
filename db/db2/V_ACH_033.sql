...
CREATE TRIGGER PNB.TRG_ACH_033_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_033_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_033_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_033_02

...
CREATE TRIGGER PNB.TRG_HOLD_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_037_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_037_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_037_02

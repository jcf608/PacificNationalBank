-- ============================================================
-- DB2 Objects for cashmanagement domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CASHMANAGEMENT_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CASHMANAGEMENT_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CASHMANAGEMENT_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CASHMANAGEMENT_025_00
  ON PNB.CASHMANAGEMENT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_025_01
  ON PNB.CASHMANAGEMENT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_025_02

...
CREATE VIEW PNB.V_ESCROW_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_046_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_046_01
  ON PNB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ESCROW_046_02
  ON PNB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ESCROW_046_03

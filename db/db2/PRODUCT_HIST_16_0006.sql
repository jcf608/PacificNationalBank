-- ============================================================
-- DDL for PRODUCT_HIST_16_0006
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.PRODUCT_HIST_16_0006 (
    COL_000    VARCHAR(60) ,
    COL_001    TIMESTAMP ,
...
CREATE UNIQUE INDEX PNB.IX_PRODUCT_H160006_PK
    ON PNB.PRODUCT_HIST_16_0006 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_H160006 (
    IN p_key CHAR(16),

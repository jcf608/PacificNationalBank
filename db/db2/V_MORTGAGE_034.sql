-- ============================================================
-- DB2 Objects for mortgage domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_MORTGAGE_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_034_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_034_01
  ON PNB.MORTGAGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_MORTGAGE_034_02
  ON PNB.MORTGAGE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_MORTGAGE_034_03

...
CREATE TRIGGER PNB.TRG_FEE_027_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_027_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_027_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_027_02
  ON PNB.FEE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FEE_027_03
  ON PNB.FEE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_FEE_027_04

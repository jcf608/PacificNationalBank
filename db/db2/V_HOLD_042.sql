...
CREATE TRIGGER PNB.TRG_HOLD_042_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_042_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_042_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_042_02
  ON PNB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HOLD_042_03

-- ============================================================
-- DB2 Objects for alert domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ALERT_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_044_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_044_01

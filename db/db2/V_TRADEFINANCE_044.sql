...
CREATE VIEW PNB.V_TRADEFINANCE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRADEFINANCE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRADEFINANCE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRADEFINANCE_044_00
  ON PNB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRADEFINANCE_044_01

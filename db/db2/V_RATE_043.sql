-- ============================================================
-- DB2 Objects for rate domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RATE_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RATE_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_043_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_043_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_043_02
  ON PNB.RATE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RATE_043_03
  ON PNB.RATE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_RATE_043_04

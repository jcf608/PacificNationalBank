...
CREATE TRIGGER PNB.TRG_ACH_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_025_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_025_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_025_02

-- ============================================================
-- DB2 Objects for trust domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRUST_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_032_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_032_01

...
CREATE TRIGGER PNB.TRG_RISK_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_037_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_037_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_037_02

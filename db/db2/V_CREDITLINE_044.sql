...
CREATE VIEW PNB.V_CREDITLINE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_044_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_044_01

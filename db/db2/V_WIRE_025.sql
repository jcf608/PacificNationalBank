-- ============================================================
-- DB2 Objects for wire domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_WIRE_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_WIRE_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_025_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_025_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_025_02

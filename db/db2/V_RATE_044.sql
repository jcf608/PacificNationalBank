...
CREATE TRIGGER PNB.TRG_RATE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_044_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_044_01

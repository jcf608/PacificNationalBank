...
CREATE TRIGGER PNB.TRG_ACH_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_049_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_049_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_049_02

-- ============================================================
-- DDL for PRODUCT_HIST_16_0064
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.PRODUCT_HIST_16_0064 (
    COL_000    VARCHAR(60) ,
    COL_001    VARCHAR(200) ,
    COL_002    CHAR(1) ,
...
CREATE UNIQUE INDEX PNB.IX_PRODUCT_H160064_PK
    ON PNB.PRODUCT_HIST_16_0064 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_H160064 (
    IN p_key CHAR(16),

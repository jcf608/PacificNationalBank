-- ============================================================
-- DB2 Objects for escrow domain — variant 33
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ESCROW_033 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_033_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_033_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_033_01
  ON PNB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ESCROW_033_02

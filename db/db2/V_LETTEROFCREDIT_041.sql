-- ============================================================
-- DB2 Objects for letterofcredit domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_LETTEROFCREDIT_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_LETTEROFCREDIT_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LETTEROFCREDIT_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LETTEROFCREDIT_041_00
  ON PNB.LETTEROFCREDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LETTEROFCREDIT_041_01
  ON PNB.LETTEROFCREDIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LETTEROFCREDIT_041_02

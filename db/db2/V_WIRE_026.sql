...
CREATE TRIGGER PNB.TRG_WIRE_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_026_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_026_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_026_02
  ON PNB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_WIRE_026_03

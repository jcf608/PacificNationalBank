-- ============================================================
-- DB2 Objects for stop domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_STOP_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_STOP_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_034_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_034_01
  ON PNB.STOP_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_STOP_034_02
  ON PNB.STOP_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_STOP_034_03

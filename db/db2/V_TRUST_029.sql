-- ============================================================
-- DB2 Objects for trust domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRUST_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_029_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_029_01
  ON PNB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRUST_029_02

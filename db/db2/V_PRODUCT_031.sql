...
CREATE VIEW PNB.V_PRODUCT_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_031_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_031_01
  ON PNB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_PRODUCT_031_02
  ON PNB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_PRODUCT_031_03
  ON PNB.PRODUCT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_PRODUCT_031_04

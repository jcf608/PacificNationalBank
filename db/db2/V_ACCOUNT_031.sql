-- ============================================================
-- DB2 Objects for account domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ACCOUNT_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ACCOUNT_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACCOUNT_031_00
  ON PNB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACCOUNT_031_01
  ON PNB.ACCOUNT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACCOUNT_031_02
  ON PNB.ACCOUNT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACCOUNT_031_03
  ON PNB.ACCOUNT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_ACCOUNT_031_04
  ON PNB.ACCOUNT_MASTER (COL_004 ASC);

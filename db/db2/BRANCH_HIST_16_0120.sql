-- ============================================================
-- DDL for BRANCH_HIST_16_0120
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.BRANCH_HIST_16_0120 (
...
CREATE UNIQUE INDEX PNB.IX_BRANCH_H160120_PK
    ON PNB.BRANCH_HIST_16_0120 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_H160120 (
    IN p_key CHAR(16),

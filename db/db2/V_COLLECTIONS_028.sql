-- ============================================================
-- DB2 Objects for collections domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COLLECTIONS_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COLLECTIONS_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COLLECTIONS_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COLLECTIONS_028_00
  ON PNB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_028_01

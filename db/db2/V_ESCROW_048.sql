-- ============================================================
-- DB2 Objects for escrow domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ESCROW_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_048_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_048_01

-- ============================================================
-- DB2 Objects for audit domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_AUDIT_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_023,
    COL_024
  FROM PNB.AUDIT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_AUDIT_031_UPDATE
  AFTER UPDATE ON PNB.AUDIT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.AUDIT_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_031_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_031_01
  ON PNB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_AUDIT_031_02
  ON PNB.AUDIT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_AUDIT_031_03
  ON PNB.AUDIT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_AUDIT_031_04
  ON PNB.AUDIT_MASTER (COL_004 ASC);

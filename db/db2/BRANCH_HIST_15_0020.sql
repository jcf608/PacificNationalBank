-- ============================================================
-- DDL for BRANCH_HIST_15_0020
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.BRANCH_HIST_15_0020 (
    COL_000    VARCHAR(60) ,
    COL_001    SMALLINT ,
    COL_002    CHAR(1) ,
...
CREATE UNIQUE INDEX PNB.IX_BRANCH_H150020_PK
    ON PNB.BRANCH_HIST_15_0020 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_H150020 (
    IN p_key CHAR(16),

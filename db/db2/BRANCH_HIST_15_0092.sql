-- ============================================================
-- DDL for BRANCH_HIST_15_0092
-- Pacific National Bank — DB2 Schema
-- ============================================================
CREATE TABLE PNB.BRANCH_HIST_15_0092 (
    COL_000    CHAR(3) ,
...
CREATE UNIQUE INDEX PNB.IX_BRANCH_H150092_PK
    ON PNB.BRANCH_HIST_15_0092 (COL_000);

CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_H150092 (
    IN p_key CHAR(16),

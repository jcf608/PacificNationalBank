...
CREATE VIEW PNB.V_TRUST_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_031_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_031_01
  ON PNB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRUST_031_02
  ON PNB.TRUST_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TRUST_031_03
  ON PNB.TRUST_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_TRUST_031_04

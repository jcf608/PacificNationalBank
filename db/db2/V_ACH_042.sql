...
CREATE TRIGGER PNB.TRG_ACH_042_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_042_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_042_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_042_02
  ON PNB.ACH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACH_042_03

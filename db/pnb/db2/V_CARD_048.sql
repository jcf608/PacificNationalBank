...
CREATE TRIGGER PNB.TRG_CARD_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_048_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_048_01

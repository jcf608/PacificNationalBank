-- ============================================================
-- DB2 Objects for audit domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_AUDIT_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_048_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_048_01

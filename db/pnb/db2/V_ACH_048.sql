...
CREATE TRIGGER PNB.TRG_ACH_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_048_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_048_01

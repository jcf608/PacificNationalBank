...
CREATE VIEW PNB.V_TREASURY_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TREASURY_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TREASURY_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TREASURY_037_00
  ON PNB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TREASURY_037_01
  ON PNB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TREASURY_037_02

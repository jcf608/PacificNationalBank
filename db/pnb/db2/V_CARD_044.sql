-- ============================================================
-- DB2 Objects for card domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CARD_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CARD_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_044_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_044_01

-- ============================================================
-- DB2 Objects for card domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CARD_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CARD_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_041_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_041_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_041_02

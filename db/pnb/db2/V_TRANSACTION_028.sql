-- ============================================================
-- DB2 Objects for transaction domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRANSACTION_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRANSACTION_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRANSACTION_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRANSACTION_028_00
  ON PNB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRANSACTION_028_01

-- ============================================================
-- DB2 Objects for fraud domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FRAUD_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FRAUD_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_040_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_040_01

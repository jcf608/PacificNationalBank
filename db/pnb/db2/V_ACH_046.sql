...
CREATE TRIGGER PNB.TRG_ACH_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_046_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_046_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_046_02
  ON PNB.ACH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACH_046_03

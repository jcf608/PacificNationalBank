...
CREATE VIEW PNB.V_TRUST_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_048_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_048_01

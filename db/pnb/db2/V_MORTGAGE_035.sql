...
CREATE VIEW PNB.V_MORTGAGE_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_035_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_035_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_035_01
  ON PNB.MORTGAGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_MORTGAGE_035_02
  ON PNB.MORTGAGE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_MORTGAGE_035_03
  ON PNB.MORTGAGE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_MORTGAGE_035_04

-- ============================================================
-- DB2 Objects for heloc domain — variant 47
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HELOC_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_047_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_047_01
  ON PNB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HELOC_047_02
  ON PNB.HELOC_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HELOC_047_03
  ON PNB.HELOC_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_HELOC_047_04

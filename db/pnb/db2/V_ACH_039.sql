...
CREATE TRIGGER PNB.TRG_ACH_039_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_039_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_039_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_039_02
  ON PNB.ACH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACH_039_03
  ON PNB.ACH_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_ACH_039_04

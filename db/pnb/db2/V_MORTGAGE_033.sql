-- ============================================================
-- DB2 Objects for mortgage domain — variant 33
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_MORTGAGE_033 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_021,
    COL_022,
  FROM PNB.MORTGAGE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_MORTGAGE_033_UPDATE
  AFTER UPDATE ON PNB.MORTGAGE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.MORTGAGE_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_033_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_033_01
  ON PNB.MORTGAGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_MORTGAGE_033_02
  ON PNB.MORTGAGE_MASTER (COL_002 ASC);

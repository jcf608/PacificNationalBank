...
CREATE VIEW PNB.V_HELOC_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_021,
    COL_022,
  FROM PNB.HELOC_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_HELOC_031_UPDATE
  AFTER UPDATE ON PNB.HELOC_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.HELOC_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_031_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_031_01
  ON PNB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HELOC_031_02
  ON PNB.HELOC_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HELOC_031_03
  ON PNB.HELOC_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_HELOC_031_04
  ON PNB.HELOC_MASTER (COL_004 ASC);

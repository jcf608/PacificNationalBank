-- ============================================================
-- DB2 Objects for risk domain — variant 30
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RISK_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RISK_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_030_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_030_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_030_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_030_03

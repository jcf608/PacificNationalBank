-- ============================================================
-- DB2 Objects for rate domain — variant 34
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RATE_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RATE_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_034_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_034_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_034_02
  ON PNB.RATE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RATE_034_03

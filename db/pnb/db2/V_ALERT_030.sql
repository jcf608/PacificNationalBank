-- ============================================================
-- DB2 Objects for alert domain — variant 30
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ALERT_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_030_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_030_01
  ON PNB.ALERT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ALERT_030_02
  ON PNB.ALERT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ALERT_030_03

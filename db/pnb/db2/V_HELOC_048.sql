-- ============================================================
-- DB2 Objects for heloc domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HELOC_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_048_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_048_01

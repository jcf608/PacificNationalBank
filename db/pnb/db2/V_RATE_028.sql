-- ============================================================
-- DB2 Objects for rate domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RATE_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RATE_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_028_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_028_01

-- ============================================================
-- DB2 Objects for compliance domain — variant 47
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COMPLIANCE_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_047_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_047_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_047_02
  ON PNB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_047_03
  ON PNB.COMPLIANCE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_047_04
  ON PNB.COMPLIANCE_MASTER (COL_004 ASC);

...
CREATE TRIGGER PNB.TRG_RISK_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_036_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_036_01

...
CREATE TRIGGER PNB.TRG_ACH_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_034_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_034_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_034_02
  ON PNB.ACH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACH_034_03

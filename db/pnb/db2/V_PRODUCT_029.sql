-- ============================================================
-- DB2 Objects for product domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_PRODUCT_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_029_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_029_01
  ON PNB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_PRODUCT_029_02

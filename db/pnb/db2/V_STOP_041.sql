...
CREATE TRIGGER PNB.TRG_STOP_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_041_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_041_01
  ON PNB.STOP_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_STOP_041_02

...
CREATE VIEW PNB.V_FOREIGNEXCHANGE_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FOREIGNEXCHANGE_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FOREIGNEXCHANGE_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FOREIGNEXCHANGE_038_00
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_038_01
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_038_02
  ON PNB.FOREIGNEXCHANGE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FOREIGNEXCHANGE_038_03

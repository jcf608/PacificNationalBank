-- ============================================================
-- DB2 Objects for wire domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_WIRE_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_WIRE_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_037_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_037_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_037_02

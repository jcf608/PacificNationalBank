-- ============================================================
-- DB2 Objects for loan domain — variant 46
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_LOAN_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_LOAN_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_046_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_046_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_046_02
  ON PNB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_LOAN_046_03

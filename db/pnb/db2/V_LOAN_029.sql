...
CREATE TRIGGER PNB.TRG_LOAN_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_029_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_029_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_029_02

-- ============================================================
-- DB2 Objects for hold domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HOLD_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HOLD_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_028_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_028_01

...
CREATE VIEW PNB.V_CREDITLINE_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_027_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_027_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_027_01
  ON PNB.CREDITLINE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CREDITLINE_027_02
  ON PNB.CREDITLINE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CREDITLINE_027_03
  ON PNB.CREDITLINE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_CREDITLINE_027_04

...
CREATE VIEW PNB.V_TRUST_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_028_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_028_01

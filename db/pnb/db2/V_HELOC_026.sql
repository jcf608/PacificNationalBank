...
CREATE VIEW PNB.V_HELOC_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_026_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_026_01
  ON PNB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HELOC_026_02
  ON PNB.HELOC_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HELOC_026_03

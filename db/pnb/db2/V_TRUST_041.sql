...
CREATE VIEW PNB.V_TRUST_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_041_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_041_01
  ON PNB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRUST_041_02

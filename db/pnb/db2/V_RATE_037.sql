...
CREATE TRIGGER PNB.TRG_RATE_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_037_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_037_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_037_02

...
CREATE VIEW PNB.V_CASHMANAGEMENT_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CASHMANAGEMENT_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CASHMANAGEMENT_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CASHMANAGEMENT_040_00
  ON PNB.CASHMANAGEMENT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_040_01

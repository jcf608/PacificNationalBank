-- ============================================================
-- DB2 Objects for treasury domain — variant 39
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TREASURY_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TREASURY_039_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TREASURY_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TREASURY_039_00
  ON PNB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TREASURY_039_01
  ON PNB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TREASURY_039_02
  ON PNB.TREASURY_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TREASURY_039_03
  ON PNB.TREASURY_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_TREASURY_039_04
  ON PNB.TREASURY_MASTER (COL_004 ASC);

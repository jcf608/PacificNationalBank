...
CREATE VIEW PNB.V_MORTGAGE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_044_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_044_01

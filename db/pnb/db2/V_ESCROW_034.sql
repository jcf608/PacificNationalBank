...
CREATE VIEW PNB.V_ESCROW_034 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_034_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_034_01
  ON PNB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ESCROW_034_02
  ON PNB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ESCROW_034_03

-- ============================================================
-- DB2 Objects for trust domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRUST_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_040_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_040_01

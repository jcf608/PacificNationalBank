...
CREATE TRIGGER PNB.TRG_LOAN_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_028_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_028_01

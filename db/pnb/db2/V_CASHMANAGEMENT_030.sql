...
CREATE VIEW PNB.V_CASHMANAGEMENT_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CASHMANAGEMENT_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CASHMANAGEMENT_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CASHMANAGEMENT_030_00
  ON PNB.CASHMANAGEMENT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_030_01
  ON PNB.CASHMANAGEMENT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_030_02
  ON PNB.CASHMANAGEMENT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CASHMANAGEMENT_030_03

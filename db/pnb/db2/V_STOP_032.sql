...
CREATE TRIGGER PNB.TRG_STOP_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_032_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_032_01

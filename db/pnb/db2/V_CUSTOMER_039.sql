-- ============================================================
-- DB2 Objects for customer domain — variant 39
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CUSTOMER_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_039_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_039_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_039_01
  ON PNB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CUSTOMER_039_02
  ON PNB.CUSTOMER_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CUSTOMER_039_03
  ON PNB.CUSTOMER_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_CUSTOMER_039_04
  ON PNB.CUSTOMER_MASTER (COL_004 ASC);

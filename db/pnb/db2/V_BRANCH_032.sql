...
CREATE VIEW PNB.V_BRANCH_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_032_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_032_01

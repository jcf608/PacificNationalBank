...
CREATE VIEW PNB.V_COMPLIANCE_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_026_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_026_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_026_02
  ON PNB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_026_03

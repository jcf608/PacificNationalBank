...
CREATE VIEW PNB.V_TRUST_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_020,
    COL_021,
  FROM PNB.TRUST_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_TRUST_027_UPDATE
  AFTER UPDATE ON PNB.TRUST_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.TRUST_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_027_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_027_01
  ON PNB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRUST_027_02
  ON PNB.TRUST_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TRUST_027_03
  ON PNB.TRUST_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_TRUST_027_04
  ON PNB.TRUST_MASTER (COL_004 ASC);

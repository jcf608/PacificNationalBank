...
CREATE VIEW PNB.V_ESCROW_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_047_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_047_01
  ON PNB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ESCROW_047_02
  ON PNB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ESCROW_047_03
  ON PNB.ESCROW_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_ESCROW_047_04

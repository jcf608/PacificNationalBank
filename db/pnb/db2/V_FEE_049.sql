-- ============================================================
-- DB2 Objects for fee domain — variant 49
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FEE_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FEE_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_049_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_049_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_049_02

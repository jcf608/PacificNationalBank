...
CREATE TRIGGER PNB.TRG_HOLD_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_043_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_043_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_043_02
  ON PNB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HOLD_043_03
  ON PNB.HOLD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_HOLD_043_04

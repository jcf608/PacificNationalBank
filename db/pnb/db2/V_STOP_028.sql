-- ============================================================
-- DB2 Objects for stop domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_STOP_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_STOP_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_028_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_028_01

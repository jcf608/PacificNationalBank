...
CREATE TRIGGER PNB.TRG_LOAN_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_041_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_041_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_041_02

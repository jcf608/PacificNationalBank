-- ============================================================
-- DB2 Objects for branch domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_BRANCH_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_029_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_029_01
  ON PNB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_BRANCH_029_02

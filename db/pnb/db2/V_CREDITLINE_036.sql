-- ============================================================
-- DB2 Objects for creditline domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CREDITLINE_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_036_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_036_01

-- ============================================================
-- DB2 Objects for account domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ACCOUNT_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ACCOUNT_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACCOUNT_040_00
  ON PNB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACCOUNT_040_01

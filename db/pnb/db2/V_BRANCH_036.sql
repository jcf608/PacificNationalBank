-- ============================================================
-- DB2 Objects for branch domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_BRANCH_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_036_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_036_01

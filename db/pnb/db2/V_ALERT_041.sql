...
CREATE VIEW PNB.V_ALERT_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ALERT_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_041_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_041_01
  ON PNB.ALERT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ALERT_041_02

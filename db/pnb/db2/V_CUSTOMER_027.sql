...
CREATE VIEW PNB.V_CUSTOMER_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_027_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_027_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_027_01
  ON PNB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CUSTOMER_027_02
  ON PNB.CUSTOMER_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CUSTOMER_027_03
  ON PNB.CUSTOMER_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_CUSTOMER_027_04

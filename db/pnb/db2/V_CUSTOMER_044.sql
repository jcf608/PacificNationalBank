...
CREATE VIEW PNB.V_CUSTOMER_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_044_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_044_01

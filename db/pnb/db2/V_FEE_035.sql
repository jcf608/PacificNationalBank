-- ============================================================
-- DB2 Objects for fee domain — variant 35
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FEE_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FEE_035_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_035_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_035_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_035_02
  ON PNB.FEE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FEE_035_03
  ON PNB.FEE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_FEE_035_04

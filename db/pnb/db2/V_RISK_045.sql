...
CREATE TRIGGER PNB.TRG_RISK_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_045_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_045_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_045_02

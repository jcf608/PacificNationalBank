-- ============================================================
-- DB2 Objects for risk domain — variant 33
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RISK_033 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RISK_033_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_033 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_033_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_033_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_033_02

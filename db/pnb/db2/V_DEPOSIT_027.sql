...
CREATE VIEW PNB.V_DEPOSIT_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_DEPOSIT_027_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_DEPOSIT_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_DEPOSIT_027_00
  ON PNB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_DEPOSIT_027_01
  ON PNB.DEPOSIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_DEPOSIT_027_02
  ON PNB.DEPOSIT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_DEPOSIT_027_03
  ON PNB.DEPOSIT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_DEPOSIT_027_04

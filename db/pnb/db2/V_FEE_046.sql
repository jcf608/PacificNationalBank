...
CREATE TRIGGER PNB.TRG_FEE_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_046_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_046_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_046_02
  ON PNB.FEE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FEE_046_03

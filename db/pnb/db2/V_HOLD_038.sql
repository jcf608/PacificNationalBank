...
CREATE TRIGGER PNB.TRG_HOLD_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_038_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_038_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_038_02
  ON PNB.HOLD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HOLD_038_03

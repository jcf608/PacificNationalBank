...
CREATE VIEW PNB.V_ACCOUNT_046 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ACCOUNT_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACCOUNT_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACCOUNT_046_00
  ON PNB.ACCOUNT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACCOUNT_046_01
  ON PNB.ACCOUNT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACCOUNT_046_02
  ON PNB.ACCOUNT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ACCOUNT_046_03

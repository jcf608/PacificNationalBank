-- ============================================================
-- DB2 Objects for mortgage domain — variant 48
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_MORTGAGE_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_048_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_048_01

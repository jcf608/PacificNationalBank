-- ============================================================
-- DB2 Objects for heloc domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HELOC_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_025_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_025_01
  ON PNB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HELOC_025_02

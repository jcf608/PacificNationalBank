-- ============================================================
-- DB2 Objects for compliance domain — variant 38
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COMPLIANCE_038 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_038_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_038 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_038_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_038_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_038_02
  ON PNB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_038_03

-- ============================================================
-- DB2 Objects for collections domain — variant 26
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COLLECTIONS_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COLLECTIONS_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COLLECTIONS_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COLLECTIONS_026_00
  ON PNB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_026_01
  ON PNB.COLLECTIONS_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_026_02
  ON PNB.COLLECTIONS_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_026_03

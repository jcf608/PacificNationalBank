-- ============================================================
-- DB2 Objects for hold domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HOLD_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HOLD_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_036_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_036_01

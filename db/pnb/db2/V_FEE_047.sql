-- ============================================================
-- DB2 Objects for fee domain — variant 47
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FEE_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FEE_047_UPDATE
  AFTER UPDATE ON PNB.FEE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.FEE_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_047_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_047_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_047_02
  ON PNB.FEE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FEE_047_03
  ON PNB.FEE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_FEE_047_04
  ON PNB.FEE_MASTER (COL_004 ASC);

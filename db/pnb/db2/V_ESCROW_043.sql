...
CREATE VIEW PNB.V_ESCROW_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_043_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_043_01
  ON PNB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ESCROW_043_02
  ON PNB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ESCROW_043_03
  ON PNB.ESCROW_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_ESCROW_043_04

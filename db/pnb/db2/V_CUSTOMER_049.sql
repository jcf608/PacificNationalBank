-- ============================================================
-- DB2 Objects for customer domain — variant 49
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CUSTOMER_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_049_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_049_01
  ON PNB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CUSTOMER_049_02

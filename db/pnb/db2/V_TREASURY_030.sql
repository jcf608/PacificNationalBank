-- ============================================================
-- DB2 Objects for treasury domain — variant 30
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TREASURY_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TREASURY_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TREASURY_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TREASURY_030_00
  ON PNB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TREASURY_030_01
  ON PNB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TREASURY_030_02
  ON PNB.TREASURY_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TREASURY_030_03

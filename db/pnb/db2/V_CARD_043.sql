-- ============================================================
-- DB2 Objects for card domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CARD_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CARD_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_043_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_043_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_043_02
  ON PNB.CARD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CARD_043_03
  ON PNB.CARD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_CARD_043_04

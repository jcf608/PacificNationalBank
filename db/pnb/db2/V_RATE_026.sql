...
CREATE TRIGGER PNB.TRG_RATE_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_026_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_026_01
  ON PNB.RATE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RATE_026_02
  ON PNB.RATE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RATE_026_03

...
CREATE TRIGGER PNB.TRG_FEE_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_029_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_029_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_029_02

-- ============================================================
-- DB2 Objects for alert domain — variant 35
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ALERT_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_022,
    COL_023,
  FROM PNB.ALERT_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_ALERT_035_UPDATE
  AFTER UPDATE ON PNB.ALERT_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.ALERT_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'ALERT_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE PNB.SP_ALERT_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ALERT_035_00
  ON PNB.ALERT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ALERT_035_01
  ON PNB.ALERT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ALERT_035_02
  ON PNB.ALERT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ALERT_035_03
  ON PNB.ALERT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_ALERT_035_04
  ON PNB.ALERT_MASTER (COL_004 ASC);

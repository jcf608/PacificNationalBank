-- ============================================================
-- DB2 Objects for product domain — variant 43
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_PRODUCT_043 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_043_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_043_01
  ON PNB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_PRODUCT_043_02
  ON PNB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_PRODUCT_043_03
  ON PNB.PRODUCT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_PRODUCT_043_04
  ON PNB.PRODUCT_MASTER (COL_004 ASC);

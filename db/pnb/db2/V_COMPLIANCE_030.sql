-- ============================================================
-- DB2 Objects for compliance domain — variant 30
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COMPLIANCE_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_030_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_030_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_030_02
  ON PNB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_030_03

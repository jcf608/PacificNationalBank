...
CREATE VIEW PNB.V_TRUST_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_039_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_039_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_039_01
  ON PNB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRUST_039_02
  ON PNB.TRUST_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_TRUST_039_03
  ON PNB.TRUST_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_TRUST_039_04

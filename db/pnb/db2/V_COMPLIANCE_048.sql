...
CREATE VIEW PNB.V_COMPLIANCE_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_048_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_048_01

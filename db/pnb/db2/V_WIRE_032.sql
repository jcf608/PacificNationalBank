...
CREATE TRIGGER PNB.TRG_WIRE_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_032_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_032_01

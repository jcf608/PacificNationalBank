-- ============================================================
-- DB2 Objects for loan domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_LOAN_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_LOAN_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_025_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_025_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_025_02

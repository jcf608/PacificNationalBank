-- ============================================================
-- DB2 Objects for customer domain — variant 26
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CUSTOMER_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CUSTOMER_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CUSTOMER_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CUSTOMER_026_00
  ON PNB.CUSTOMER_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CUSTOMER_026_01
  ON PNB.CUSTOMER_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CUSTOMER_026_02
  ON PNB.CUSTOMER_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CUSTOMER_026_03

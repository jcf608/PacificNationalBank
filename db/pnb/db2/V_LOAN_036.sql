...
CREATE TRIGGER PNB.TRG_LOAN_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_036_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_036_01

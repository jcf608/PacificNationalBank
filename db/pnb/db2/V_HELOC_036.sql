...
CREATE VIEW PNB.V_HELOC_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_036_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_036_01

...
CREATE TRIGGER PNB.TRG_ACH_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_041_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_041_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_041_02

-- ============================================================
-- DB2 Objects for hold domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HOLD_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HOLD_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_029_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_029_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_029_02

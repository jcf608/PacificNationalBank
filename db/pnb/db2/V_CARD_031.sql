...
CREATE TRIGGER PNB.TRG_CARD_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_031_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_031_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_031_02
  ON PNB.CARD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CARD_031_03
  ON PNB.CARD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_CARD_031_04

...
CREATE TRIGGER PNB.TRG_RATE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_040_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_040_01

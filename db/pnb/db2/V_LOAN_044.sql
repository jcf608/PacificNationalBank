...
CREATE TRIGGER PNB.TRG_LOAN_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_044_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_044_01

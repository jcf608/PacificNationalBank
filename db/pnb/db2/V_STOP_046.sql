...
CREATE TRIGGER PNB.TRG_STOP_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_046_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_046_01
  ON PNB.STOP_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_STOP_046_02
  ON PNB.STOP_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_STOP_046_03

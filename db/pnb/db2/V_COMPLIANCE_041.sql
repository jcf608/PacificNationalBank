-- ============================================================
-- DB2 Objects for compliance domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COMPLIANCE_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_041_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_041_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_041_02

...
CREATE VIEW PNB.V_HELOC_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_028_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_028_01

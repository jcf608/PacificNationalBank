...
CREATE TRIGGER PNB.TRG_STOP_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_049_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_049_01
  ON PNB.STOP_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_STOP_049_02

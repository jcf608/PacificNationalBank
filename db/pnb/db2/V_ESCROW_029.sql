-- ============================================================
-- DB2 Objects for escrow domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ESCROW_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_029_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_029_01
  ON PNB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ESCROW_029_02

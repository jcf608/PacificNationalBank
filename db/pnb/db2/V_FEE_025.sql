...
CREATE TRIGGER PNB.TRG_FEE_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_025_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_025_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_025_02

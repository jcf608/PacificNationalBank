-- ============================================================
-- DB2 Objects for trust domain — variant 49
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRUST_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_049_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_049_01
  ON PNB.TRUST_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TRUST_049_02

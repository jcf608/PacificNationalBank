...
CREATE TRIGGER PNB.TRG_STOP_043_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_043 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_043_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_043_01
  ON PNB.STOP_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_STOP_043_02
  ON PNB.STOP_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_STOP_043_03
  ON PNB.STOP_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_STOP_043_04

-- ============================================================
-- DB2 Objects for mortgage domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_MORTGAGE_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_032_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_032_01

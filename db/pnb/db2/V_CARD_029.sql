...
CREATE TRIGGER PNB.TRG_CARD_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_029_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_029_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_029_02

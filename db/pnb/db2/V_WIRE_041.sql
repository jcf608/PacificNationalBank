-- ============================================================
-- DB2 Objects for wire domain — variant 41
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_WIRE_041 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_WIRE_041_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_041 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_041_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_041_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_041_02

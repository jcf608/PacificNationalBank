-- ============================================================
-- DB2 Objects for collections domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COLLECTIONS_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COLLECTIONS_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COLLECTIONS_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COLLECTIONS_044_00
  ON PNB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_044_01

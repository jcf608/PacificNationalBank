...
CREATE TRIGGER PNB.TRG_CARD_039_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_039_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_039_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_039_02
  ON PNB.CARD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_CARD_039_03
  ON PNB.CARD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_CARD_039_04

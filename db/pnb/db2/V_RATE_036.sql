...
CREATE TRIGGER PNB.TRG_RATE_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RATE_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RATE_036_00
  ON PNB.RATE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RATE_036_01

-- ============================================================
-- DB2 Objects for card domain — variant 25
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_CARD_025 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CARD_025_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_025 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_025_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_025_01
  ON PNB.CARD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_CARD_025_02

-- ============================================================
-- DB2 Objects for risk domain — variant 27
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_RISK_027 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_RISK_027_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_027 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_027_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_027_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_027_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_027_03
  ON PNB.RISK_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_RISK_027_04

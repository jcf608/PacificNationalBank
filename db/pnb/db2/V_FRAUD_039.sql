-- ============================================================
-- DB2 Objects for fraud domain — variant 39
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FRAUD_039 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_020,
    COL_021,
  FROM PNB.FRAUD_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_FRAUD_039_UPDATE
  AFTER UPDATE ON PNB.FRAUD_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.FRAUD_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'FRAUD_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE PNB.SP_FRAUD_039 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FRAUD_039_00
  ON PNB.FRAUD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FRAUD_039_01
  ON PNB.FRAUD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FRAUD_039_02
  ON PNB.FRAUD_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_FRAUD_039_03
  ON PNB.FRAUD_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_FRAUD_039_04
  ON PNB.FRAUD_MASTER (COL_004 ASC);

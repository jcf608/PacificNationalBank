...
CREATE VIEW PNB.V_DEPOSIT_048 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_DEPOSIT_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_DEPOSIT_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_DEPOSIT_048_00
  ON PNB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_DEPOSIT_048_01

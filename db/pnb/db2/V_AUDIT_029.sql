-- ============================================================
-- DB2 Objects for audit domain — variant 29
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_AUDIT_029 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_029_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_029 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_029_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_029_01
  ON PNB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_AUDIT_029_02

-- ============================================================
-- DB2 Objects for loan domain — variant 37
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_LOAN_037 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_LOAN_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_037_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_037_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_037_02

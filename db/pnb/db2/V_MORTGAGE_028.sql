-- ============================================================
-- DB2 Objects for mortgage domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_MORTGAGE_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_028_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_028_01

...
CREATE VIEW PNB.V_AUDIT_045 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_045_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_045_01
  ON PNB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_AUDIT_045_02

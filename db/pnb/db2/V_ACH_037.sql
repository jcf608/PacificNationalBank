...
CREATE TRIGGER PNB.TRG_ACH_037_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_037 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_037_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_037_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_037_02

...
CREATE TRIGGER PNB.TRG_RISK_048_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_048 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_048_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_048_01

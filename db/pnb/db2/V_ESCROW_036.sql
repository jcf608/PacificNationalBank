...
CREATE VIEW PNB.V_ESCROW_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_ESCROW_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_036_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_036_01

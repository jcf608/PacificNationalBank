...
CREATE TRIGGER PNB.TRG_RISK_034_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_034 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_034_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_034_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_034_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_034_03

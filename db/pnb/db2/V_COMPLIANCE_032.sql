-- ============================================================
-- DB2 Objects for compliance domain — variant 32
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_COMPLIANCE_032 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_014,
    COL_015,
  FROM PNB.COMPLIANCE_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_COMPLIANCE_032_UPDATE
  AFTER UPDATE ON PNB.COMPLIANCE_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.COMPLIANCE_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'COMPLIANCE_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_032_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_032_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

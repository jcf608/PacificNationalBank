-- ============================================================
-- DB2 Objects for product domain — variant 35
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_PRODUCT_035 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_PRODUCT_035_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_PRODUCT_035 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_PRODUCT_035_00
  ON PNB.PRODUCT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_PRODUCT_035_01
  ON PNB.PRODUCT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_PRODUCT_035_02
  ON PNB.PRODUCT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_PRODUCT_035_03
  ON PNB.PRODUCT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_PRODUCT_035_04

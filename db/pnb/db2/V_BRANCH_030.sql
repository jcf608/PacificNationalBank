...
CREATE VIEW PNB.V_BRANCH_030 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_BRANCH_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_BRANCH_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_BRANCH_030_00
  ON PNB.BRANCH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_BRANCH_030_01
  ON PNB.BRANCH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_BRANCH_030_02
  ON PNB.BRANCH_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_BRANCH_030_03

-- ============================================================
-- DB2 Objects for deposit domain — variant 40
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_DEPOSIT_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_DEPOSIT_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_DEPOSIT_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_DEPOSIT_040_00
  ON PNB.DEPOSIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_DEPOSIT_040_01

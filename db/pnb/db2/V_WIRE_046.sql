...
CREATE TRIGGER PNB.TRG_WIRE_046_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_046 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_046_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_046_01
  ON PNB.WIRE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_WIRE_046_02
  ON PNB.WIRE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_WIRE_046_03

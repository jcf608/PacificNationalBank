...
CREATE VIEW PNB.V_COMPLIANCE_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_042_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_042_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_042_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_042_02
  ON PNB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_042_03

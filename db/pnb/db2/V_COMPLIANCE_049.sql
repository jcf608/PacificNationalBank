...
CREATE VIEW PNB.V_COMPLIANCE_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_049_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_049_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_049_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_049_02

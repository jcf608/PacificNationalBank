-- ============================================================
-- DB2 Objects for audit domain — variant 47
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_AUDIT_047 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_047_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_047 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_047_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_047_01
  ON PNB.AUDIT_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_AUDIT_047_02
  ON PNB.AUDIT_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_AUDIT_047_03
  ON PNB.AUDIT_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_AUDIT_047_04

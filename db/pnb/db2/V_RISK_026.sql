...
CREATE TRIGGER PNB.TRG_RISK_026_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_RISK_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_RISK_026_00
  ON PNB.RISK_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_RISK_026_01
  ON PNB.RISK_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_RISK_026_02
  ON PNB.RISK_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_RISK_026_03

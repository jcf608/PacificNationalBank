...
CREATE TRIGGER PNB.TRG_STOP_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_STOP_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_STOP_044_00
  ON PNB.STOP_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_STOP_044_01

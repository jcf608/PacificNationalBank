-- ============================================================
-- DB2 Objects for audit domain — variant 36
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_AUDIT_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_AUDIT_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_AUDIT_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_AUDIT_036_00
  ON PNB.AUDIT_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_AUDIT_036_01

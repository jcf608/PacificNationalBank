...
CREATE VIEW PNB.V_TRUST_036 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRUST_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRUST_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRUST_036_00
  ON PNB.TRUST_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRUST_036_01

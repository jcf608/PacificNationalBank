-- ============================================================
-- DB2 Objects for tradefinance domain — variant 28
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRADEFINANCE_028 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRADEFINANCE_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRADEFINANCE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRADEFINANCE_028_00
  ON PNB.TRADEFINANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRADEFINANCE_028_01

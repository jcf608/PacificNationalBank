...
CREATE VIEW PNB.V_COMPLIANCE_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COMPLIANCE_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COMPLIANCE_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COMPLIANCE_031_00
  ON PNB.COMPLIANCE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_031_01
  ON PNB.COMPLIANCE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_031_02
  ON PNB.COMPLIANCE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_031_03
  ON PNB.COMPLIANCE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_COMPLIANCE_031_04

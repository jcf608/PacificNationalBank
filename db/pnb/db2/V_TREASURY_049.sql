-- ============================================================
-- DB2 Objects for treasury domain — variant 49
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TREASURY_049 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_016,
    COL_017,
  FROM PNB.TREASURY_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_TREASURY_049_UPDATE
  AFTER UPDATE ON PNB.TREASURY_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.TREASURY_AUDIT (
...
CREATE OR REPLACE PROCEDURE PNB.SP_TREASURY_049 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TREASURY_049_00
  ON PNB.TREASURY_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TREASURY_049_01
  ON PNB.TREASURY_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_TREASURY_049_02
  ON PNB.TREASURY_MASTER (COL_002 ASC);

...
CREATE TRIGGER PNB.TRG_HOLD_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HOLD_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HOLD_045_00
  ON PNB.HOLD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HOLD_045_01
  ON PNB.HOLD_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HOLD_045_02

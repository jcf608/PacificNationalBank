...
CREATE TRIGGER PNB.TRG_CARD_036_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CARD_036 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CARD_036_00
  ON PNB.CARD_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CARD_036_01

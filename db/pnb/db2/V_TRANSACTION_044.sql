-- ============================================================
-- DB2 Objects for transaction domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_TRANSACTION_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_TRANSACTION_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_TRANSACTION_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_TRANSACTION_044_00
  ON PNB.TRANSACTION_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_TRANSACTION_044_01

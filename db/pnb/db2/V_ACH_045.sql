...
CREATE TRIGGER PNB.TRG_ACH_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_045_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_045_01
  ON PNB.ACH_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ACH_045_02

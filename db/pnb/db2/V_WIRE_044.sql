-- ============================================================
-- DB2 Objects for wire domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_WIRE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_WIRE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_044_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_044_01

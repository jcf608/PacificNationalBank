...
CREATE TRIGGER PNB.TRG_LOAN_030_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_LOAN_030 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_LOAN_030_00
  ON PNB.LOAN_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_LOAN_030_01
  ON PNB.LOAN_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_LOAN_030_02
  ON PNB.LOAN_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_LOAN_030_03

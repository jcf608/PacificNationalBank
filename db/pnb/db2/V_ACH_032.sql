...
CREATE TRIGGER PNB.TRG_ACH_032_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_ACH_032 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ACH_032_00
  ON PNB.ACH_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ACH_032_01

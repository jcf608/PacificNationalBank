...
CREATE TRIGGER PNB.TRG_FEE_045_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_045 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_045_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_045_01
  ON PNB.FEE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_FEE_045_02

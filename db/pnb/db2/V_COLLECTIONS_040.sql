...
CREATE VIEW PNB.V_COLLECTIONS_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_COLLECTIONS_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_COLLECTIONS_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_COLLECTIONS_040_00
  ON PNB.COLLECTIONS_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_COLLECTIONS_040_01

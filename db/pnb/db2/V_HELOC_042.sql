-- ============================================================
-- DB2 Objects for heloc domain — variant 42
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_HELOC_042 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_HELOC_042_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_HELOC_042 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_HELOC_042_00
  ON PNB.HELOC_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_HELOC_042_01
  ON PNB.HELOC_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_HELOC_042_02
  ON PNB.HELOC_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_HELOC_042_03

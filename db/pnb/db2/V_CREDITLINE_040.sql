...
CREATE VIEW PNB.V_CREDITLINE_040 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_CREDITLINE_040_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_CREDITLINE_040 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_CREDITLINE_040_00
  ON PNB.CREDITLINE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_CREDITLINE_040_01

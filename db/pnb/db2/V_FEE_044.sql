-- ============================================================
-- DB2 Objects for fee domain — variant 44
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_FEE_044 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_FEE_044_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_FEE_044 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_FEE_044_00
  ON PNB.FEE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_FEE_044_01

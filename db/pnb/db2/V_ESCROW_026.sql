-- ============================================================
-- DB2 Objects for escrow domain — variant 26
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_ESCROW_026 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
    ...
    COL_023,
    COL_024
  FROM PNB.ESCROW_MASTER
  WHERE STATUS = 'A';

CREATE TRIGGER PNB.TRG_ESCROW_026_UPDATE
  AFTER UPDATE ON PNB.ESCROW_MASTER
  REFERENCING NEW AS N OLD AS O
  FOR EACH ROW
  MODE DB2SQL
  BEGIN ATOMIC
    INSERT INTO PNB.ESCROW_AUDIT (
      AUDIT_ID, TABLE_NAME, OPERATION, OLD_VALUE, NEW_VALUE,
      CHANGED_BY, CHANGED_AT
    ) VALUES (
      DEFAULT, 'ESCROW_MASTER', 'UPDATE',
...
CREATE OR REPLACE PROCEDURE PNB.SP_ESCROW_026 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_ESCROW_026_00
  ON PNB.ESCROW_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_ESCROW_026_01
  ON PNB.ESCROW_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_ESCROW_026_02
  ON PNB.ESCROW_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_ESCROW_026_03
  ON PNB.ESCROW_MASTER (COL_003 ASC);

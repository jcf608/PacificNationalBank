...
CREATE TRIGGER PNB.TRG_WIRE_028_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_WIRE_028 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_WIRE_028_00
  ON PNB.WIRE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_WIRE_028_01

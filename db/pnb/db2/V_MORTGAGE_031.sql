-- ============================================================
-- DB2 Objects for mortgage domain — variant 31
-- Pacific National Bank
-- ============================================================

CREATE VIEW PNB.V_MORTGAGE_031 AS
  SELECT
    COL_000,
    COL_001,
    COL_002,
...
CREATE TRIGGER PNB.TRG_MORTGAGE_031_UPDATE
...
CREATE OR REPLACE PROCEDURE PNB.SP_MORTGAGE_031 (
  IN  p_key       VARCHAR(32),
...
CREATE INDEX PNB.IX_MORTGAGE_031_00
  ON PNB.MORTGAGE_MASTER (COL_000 ASC);

CREATE INDEX PNB.IX_MORTGAGE_031_01
  ON PNB.MORTGAGE_MASTER (COL_001 ASC);

CREATE INDEX PNB.IX_MORTGAGE_031_02
  ON PNB.MORTGAGE_MASTER (COL_002 ASC);

CREATE INDEX PNB.IX_MORTGAGE_031_03
  ON PNB.MORTGAGE_MASTER (COL_003 ASC);

CREATE INDEX PNB.IX_MORTGAGE_031_04

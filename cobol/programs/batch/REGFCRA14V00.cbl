      ******************************************************************
      * REGFCRA14V00.cbl — FCRA Regulatory Reporting Variant 0
      * Pacific National Bank — Core Banking System
      * Generated batch program
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. REGFCRA14V00.
       AUTHOR. PNB-CODE-GENERATOR.
       DATE-WRITTEN. 2026-05-26.
       DATE-COMPILED.
      *
      * FCRA Regulatory Reporting Variant 0
      *
       ...
       FILE-CONTROL.
           SELECT INPUT-FILE ASSIGN TO
               "REGFCRA14V00-INPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-INPUT-STATUS.
           SELECT OUTPUT-FILE ASSIGN TO
               "REGFCRA14V00-OUTPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-OUTPUT-STATUS.
           SELECT REPORT-FILE ASSIGN TO
               "REGFCRA14V00-REPORT.RPT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-REPORT-STATUS.
           SELECT ERROR-FILE ASSIGN TO
               "REGFCRA14V00-ERRORS.ERR"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
      ...
      *
       ...
       01  WS-VARIANT-0000        PIC S9(15)V99
                                    COMP-3 VALUE 0.
       01  WS-FLAG-0000            PIC X(01).
           88  FLAG-0000-ON        VALUE "Y".
           88  FLAG-0000-OFF       VALUE "N".
       01  WS-VARIANT-0001        PIC S9(15)V99
                                    COMP-3 VALUE 0.
       01  WS-FLAG-0001            PIC X(01).
           88  FLAG-0001-ON        VALUE "Y".
           88  FLAG-0001-OFF       VALUE "N".
       01  WS-VARIANT-0002        PIC S9(15)V99
                                    COMP-3 VALUE 0.
       01  WS-FLAG-0002            PIC X(01).
           88  FLAG-0002-ON        VALUE "Y".
           88  FLAG-0002-OFF       VALUE "N".
       01  WS-VARIANT-0003        PIC S9(15)V99
                                    COMP-3 VALUE 0.
       01  WS-FLAG-0003            PIC X(01).
           88  FLAG-0003-ON        VALUE "Y".
           88  FLAG-0003-OFF       VALUE "N".
      ...
      *
       1000-INITIALIZE.
           ...
           DISPLAY "REGFCRA14V00 STARTED AT "
           ...
           IF WS-INPUT-STATUS NOT = "00"
               DISPLAY "REGFCRA14V00: ERROR OPENING INPUT FILE"
      ...
      *
       1500-WRITE-REPORT-HEADER.
           ...
           STRING "PACIFIC NATIONAL BANK - FCRA Regulatory Reporting Variant 0"
      ...
      *
       3000-VARIANT-00-STEP-00.
           DISPLAY "Processing variant 0 step 0"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0000 =
                   WS-VARIANT-0000 + 1
           END-IF

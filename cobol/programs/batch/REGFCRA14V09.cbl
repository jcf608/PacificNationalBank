      ******************************************************************
      * REGFCRA14V09.cbl — FCRA Regulatory Reporting Variant 9
      * Pacific National Bank — Core Banking System
      * Generated batch program
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. REGFCRA14V09.
       AUTHOR. PNB-CODE-GENERATOR.
       DATE-WRITTEN. 2026-05-26.
       DATE-COMPILED.
      *
      * FCRA Regulatory Reporting Variant 9
      *
       ...
       FILE-CONTROL.
           SELECT INPUT-FILE ASSIGN TO
               "REGFCRA14V09-INPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-INPUT-STATUS.
           SELECT OUTPUT-FILE ASSIGN TO
               "REGFCRA14V09-OUTPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-OUTPUT-STATUS.
           SELECT REPORT-FILE ASSIGN TO
               "REGFCRA14V09-REPORT.RPT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-REPORT-STATUS.
           SELECT ERROR-FILE ASSIGN TO
               "REGFCRA14V09-ERRORS.ERR"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
      ...
      *
       1000-INITIALIZE.
           ...
           DISPLAY "REGFCRA14V09 STARTED AT "
           ...
           IF WS-INPUT-STATUS NOT = "00"
               DISPLAY "REGFCRA14V09: ERROR OPENING INPUT FILE"
      ...
      *
       1500-WRITE-REPORT-HEADER.
           ...
           STRING "PACIFIC NATIONAL BANK - FCRA Regulatory Reporting Variant 9"
      ...
      *
       3090-VARIANT-09-STEP-00.
           DISPLAY "Processing variant 9 step 0"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0018 =
                   WS-VARIANT-0018 + 1
           END-IF
           ...
           CONTINUE.
      *
       3091-VARIANT-09-STEP-01.
           DISPLAY "Processing variant 9 step 1"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0018 =
                   WS-VARIANT-0018 + 1
           END-IF
           ...
           CONTINUE.
      *
       3092-VARIANT-09-STEP-02.
           DISPLAY "Processing variant 9 step 2"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0018 =
                   WS-VARIANT-0018 + 1
           END-IF
           ...
           CONTINUE.
      *
       3093-VARIANT-09-STEP-03.
           DISPLAY "Processing variant 9 step 3"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0018 =
                   WS-VARIANT-0018 + 1
           END-IF
           ...
           CONTINUE.
      *
       3094-VARIANT-09-STEP-04.
           DISPLAY "Processing variant 9 step 4"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0018 =
                   WS-VARIANT-0018 + 1
           END-IF

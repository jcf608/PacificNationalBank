      ******************************************************************
      * DLILOAN039.cbl — DL/I Wrapper for loan domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLILOAN039.
       ...
       01  WS-LOAN-FLD-000   PIC X(30).
       01  WS-LOAN-FLD-001   PIC X(10).
       01  WS-LOAN-FLD-002   PIC X(20).
       01  WS-LOAN-FLD-003   PIC X(10).
       01  WS-LOAN-FLD-004   PIC X(10).
       01  WS-LOAN-FLD-005   PIC X(10).
       01  WS-LOAN-FLD-006   PIC X(40).
       01  WS-LOAN-FLD-007   PIC X(40).
       01  WS-LOAN-FLD-008   PIC X(20).
       01  WS-LOAN-FLD-009   PIC X(30).
       01  WS-LOAN-FLD-010   PIC X(40).
       01  WS-LOAN-FLD-011   PIC X(30).
       01  WS-LOAN-FLD-012   PIC X(10).
       01  WS-LOAN-FLD-013   PIC X(20).
       01  WS-LOAN-AMT-000   PIC S9(15)V99
                                        COMP-3.
       01  WS-LOAN-AMT-001   PIC S9(15)V99
                                        COMP-3.
       01  WS-LOAN-AMT-002   PIC S9(15)V99
                                        COMP-3.
       01  WS-LOAN-AMT-003   PIC S9(15)V99
                                        COMP-3.
       01  WS-LOAN-AMT-004   PIC S9(15)V99
                                        COMP-3.
       01  WS-LOAN-AMT-005   PIC S9(15)V99
                                        COMP-3.
       01  WS-LOAN-AMT-006   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.
       01  LS-PCB-LOAN      PIC X(100).
       01  LS-IO-AREA              PIC X(2000).
       01  LS-KEY                   PIC X(32).
       01  LS-RETURN-CODE           PIC S9(04) COMP.
      *
       PROCEDURE DIVISION USING LS-PCB-LOAN
                                LS-IO-AREA
                                LS-KEY
                                LS-RETURN-CODE.
       0000-MAIN.
      ...
      *
       1000-GET-UNIQUE.
           MOVE "LOAN" TO WS-SSA-SEG-NAME
           MOVE "(" TO WS-SSA-QUAL
           MOVE "KEY     " TO WS-SSA-FLD-NAME
           MOVE " =" TO WS-SSA-REL-OP
           MOVE LS-KEY TO WS-SSA-VALUE
           CALL "CBLTDLI" USING DLI-GU
               LS-PCB-LOAN WS-IO-AREA WS-SSA
           MOVE LS-PCB-LOAN TO WS-PCB-MASK
           IF PCB-OK

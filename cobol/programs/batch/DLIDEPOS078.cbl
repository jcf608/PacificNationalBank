      ******************************************************************
      * DLIDEPOS078.cbl — DL/I Wrapper for deposit domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIDEPOS078.
       ...
       01  WS-DEPOS-FLD-005   PIC X(40).
       01  WS-DEPOS-FLD-006   PIC X(20).
       01  WS-DEPOS-FLD-007   PIC X(20).
       01  WS-DEPOS-FLD-008   PIC X(20).
       01  WS-DEPOS-FLD-009   PIC X(40).
       01  WS-DEPOS-FLD-010   PIC X(30).
       01  WS-DEPOS-FLD-011   PIC X(20).
       01  WS-DEPOS-FLD-012   PIC X(30).

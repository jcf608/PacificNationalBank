      ******************************************************************
      * REGFCRA14V12.cbl — FCRA Regulatory Reporting Variant 12
      * Pacific National Bank — Core Banking System
      * Generated batch program
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. REGFCRA14V12.
       AUTHOR. PNB-CODE-GENERATOR.
       DATE-WRITTEN. 2026-05-26.
       DATE-COMPILED.
      *
      * FCRA Regulatory Reporting Variant 12
      *
       ...
       FILE-CONTROL.
           SELECT INPUT-FILE ASSIGN TO
               "REGFCRA14V12-INPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-INPUT-STATUS.
           SELECT OUTPUT-FILE ASSIGN TO
               "REGFCRA14V12-OUTPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-OUTPUT-STATUS.
           SELECT REPORT-FILE ASSIGN TO
               "REGFCRA14V12-REPORT.RPT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-REPORT-STATUS.
           SELECT ERROR-FILE ASSIGN TO
               "REGFCRA14V12-ERRORS.ERR"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
      ...
      *
       1000-INITIALIZE.
           ...
           DISPLAY "REGFCRA14V12 STARTED AT "
           ...
           IF WS-INPUT-STATUS NOT = "00"
               DISPLAY "REGFCRA14V12: ERROR OPENING INPUT FILE"
      ...
      *
       1500-WRITE-REPORT-HEADER.
           ...
           STRING "PACIFIC NATIONAL BANK - FCRA Regulatory Reporting Variant 12"
      ...
      *
       3120-VARIANT-12-STEP-00.
           DISPLAY "Processing variant 12 step 0"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0024 =
                   WS-VARIANT-0024 + 1
           END-IF
           ...
           CONTINUE.
      *
       3121-VARIANT-12-STEP-01.
           DISPLAY "Processing variant 12 step 1"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0024 =
                   WS-VARIANT-0024 + 1
           END-IF
           ...
           CONTINUE.
      *
       3122-VARIANT-12-STEP-02.
           DISPLAY "Processing variant 12 step 2"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0024 =
                   WS-VARIANT-0024 + 1
           END-IF

      ******************************************************************
      * DLICUSTO079.cbl — DL/I Wrapper for customer domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLICUSTO079.
       ...
       01  WS-CUSTO-FLD-000   PIC X(20).
       01  WS-CUSTO-FLD-001   PIC X(20).
       01  WS-CUSTO-FLD-002   PIC X(20).
       01  WS-CUSTO-FLD-003   PIC X(30).
       01  WS-CUSTO-FLD-004   PIC X(10).
       01  WS-CUSTO-FLD-005   PIC X(40).
       01  WS-CUSTO-FLD-006   PIC X(30).
       01  WS-CUSTO-FLD-007   PIC X(40).
       01  WS-CUSTO-FLD-008   PIC X(10).
       01  WS-CUSTO-FLD-009   PIC X(40).
       01  WS-CUSTO-FLD-010   PIC X(40).
       01  WS-CUSTO-FLD-011   PIC X(40).
       01  WS-CUSTO-FLD-012   PIC X(10).
       01  WS-CUSTO-FLD-013   PIC X(30).
       01  WS-CUSTO-AMT-000   PIC S9(15)V99
                                        COMP-3.
       01  WS-CUSTO-AMT-001   PIC S9(15)V99
                                        COMP-3.
       01  WS-CUSTO-AMT-002   PIC S9(15)V99
                                        COMP-3.
       01  WS-CUSTO-AMT-003   PIC S9(15)V99
                                        COMP-3.
       01  WS-CUSTO-AMT-004   PIC S9(15)V99
                                        COMP-3.
       01  WS-CUSTO-AMT-005   PIC S9(15)V99
                                        COMP-3.
       01  WS-CUSTO-AMT-006   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.
       01  LS-PCB-CUSTO      PIC X(100).
       01  LS-IO-AREA              PIC X(2000).
       01  LS-KEY                   PIC X(32).
       01  LS-RETURN-CODE           PIC S9(04) COMP.
      *
       PROCEDURE DIVISION USING LS-PCB-CUSTO
                                LS-IO-AREA
                                LS-KEY
                                LS-RETURN-CODE.
       0000-MAIN.
      ...
      *
       1000-GET-UNIQUE.
           ...
           CALL "CBLTDLI" USING DLI-GU
               LS-PCB-CUSTO WS-IO-AREA WS-SSA
           MOVE LS-PCB-CUSTO TO WS-PCB-MASK
           IF PCB-OK

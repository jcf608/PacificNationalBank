      ******************************************************************
      * DLIDEPOS023.cbl — DL/I Wrapper for deposit domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIDEPOS023.
       ...
       01  WS-DEPOS-FLD-001   PIC X(40).
       01  WS-DEPOS-FLD-002   PIC X(10).
       01  WS-DEPOS-FLD-003   PIC X(40).
       01  WS-DEPOS-FLD-004   PIC X(20).
       01  WS-DEPOS-FLD-005   PIC X(10).
       01  WS-DEPOS-FLD-006   PIC X(30).
       01  WS-DEPOS-FLD-007   PIC X(40).

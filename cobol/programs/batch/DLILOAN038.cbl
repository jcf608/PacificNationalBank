      ******************************************************************
      * DLILOAN038.cbl — DL/I Wrapper for loan domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLILOAN038.
       ...
       01  WS-LOAN-FLD-007   PIC X(20).
       01  WS-LOAN-FLD-008   PIC X(40).
       01  WS-LOAN-FLD-009   PIC X(20).
       01  WS-LOAN-FLD-010   PIC X(20).
       01  WS-LOAN-FLD-011   PIC X(40).
       01  WS-LOAN-FLD-012   PIC X(20).

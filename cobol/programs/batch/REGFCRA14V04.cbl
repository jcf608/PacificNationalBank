      ******************************************************************
      * REGFCRA14V04.cbl — FCRA Regulatory Reporting Variant 4
      * Pacific National Bank — Core Banking System
      * Generated batch program
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. REGFCRA14V04.
       AUTHOR. PNB-CODE-GENERATOR.
       DATE-WRITTEN. 2026-05-26.
       DATE-COMPILED.
      *
      * FCRA Regulatory Reporting Variant 4
      *
       ...
       FILE-CONTROL.
           SELECT INPUT-FILE ASSIGN TO
               "REGFCRA14V04-INPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-INPUT-STATUS.
           SELECT OUTPUT-FILE ASSIGN TO
               "REGFCRA14V04-OUTPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-OUTPUT-STATUS.
           SELECT REPORT-FILE ASSIGN TO
               "REGFCRA14V04-REPORT.RPT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-REPORT-STATUS.
           SELECT ERROR-FILE ASSIGN TO
               "REGFCRA14V04-ERRORS.ERR"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
      ...
      *
       1000-INITIALIZE.
           ...
           DISPLAY "REGFCRA14V04 STARTED AT "
           ...
           IF WS-INPUT-STATUS NOT = "00"
               DISPLAY "REGFCRA14V04: ERROR OPENING INPUT FILE"
      ...
      *
       1500-WRITE-REPORT-HEADER.
           ...
           STRING "PACIFIC NATIONAL BANK - FCRA Regulatory Reporting Variant 4"
      ...
      *
       3040-VARIANT-04-STEP-00.
           DISPLAY "Processing variant 4 step 0"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0008 =
                   WS-VARIANT-0008 + 1
           END-IF
           ...
           CONTINUE.
      *
       3041-VARIANT-04-STEP-01.
           DISPLAY "Processing variant 4 step 1"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0008 =
                   WS-VARIANT-0008 + 1
           END-IF
           ...
           CONTINUE.
      *
       3042-VARIANT-04-STEP-02.
           DISPLAY "Processing variant 4 step 2"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0008 =
                   WS-VARIANT-0008 + 1
           END-IF
           ...
           CONTINUE.
      *
       3043-VARIANT-04-STEP-03.
           DISPLAY "Processing variant 4 step 3"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0008 =
                   WS-VARIANT-0008 + 1
           END-IF
           ...
           CONTINUE.
      *
       3044-VARIANT-04-STEP-04.
           DISPLAY "Processing variant 4 step 4"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0008 =
                   WS-VARIANT-0008 + 1
           END-IF

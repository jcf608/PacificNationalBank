      ******************************************************************
      * DLILOAN063.cbl — DL/I Wrapper for loan domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLILOAN063.
       ...
       01  WS-LOAN-FLD-000   PIC X(20).
       01  WS-LOAN-FLD-001   PIC X(30).
       01  WS-LOAN-FLD-002   PIC X(40).
       01  WS-LOAN-FLD-003   PIC X(40).
       01  WS-LOAN-FLD-004   PIC X(20).

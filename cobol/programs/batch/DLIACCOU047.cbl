      ******************************************************************
      * DLIACCOU047.cbl — DL/I Wrapper for account domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIACCOU047.
       ...
       01  WS-ACCOU-FLD-001   PIC X(10).
       01  WS-ACCOU-FLD-002   PIC X(20).
       01  WS-ACCOU-FLD-003   PIC X(40).
       01  WS-ACCOU-FLD-004   PIC X(30).
       01  WS-ACCOU-FLD-005   PIC X(20).
       01  WS-ACCOU-FLD-006   PIC X(40).
       01  WS-ACCOU-FLD-007   PIC X(40).
       01  WS-ACCOU-FLD-008   PIC X(10).
       01  WS-ACCOU-FLD-009   PIC X(10).
       01  WS-ACCOU-FLD-010   PIC X(30).
       01  WS-ACCOU-FLD-011   PIC X(10).

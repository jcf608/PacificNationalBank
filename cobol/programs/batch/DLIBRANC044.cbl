      ******************************************************************
      * DLIBRANC044.cbl — DL/I Wrapper for branch domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIBRANC044.
       ...
       01  WS-BRANC-FLD-000   PIC X(30).
       01  WS-BRANC-FLD-001   PIC X(10).
       01  WS-BRANC-FLD-002   PIC X(30).
       01  WS-BRANC-FLD-003   PIC X(20).
       01  WS-BRANC-FLD-004   PIC X(30).
       01  WS-BRANC-FLD-005   PIC X(30).
       01  WS-BRANC-FLD-006   PIC X(20).
       01  WS-BRANC-FLD-007   PIC X(30).
       01  WS-BRANC-FLD-008   PIC X(40).
       01  WS-BRANC-AMT-000   PIC S9(15)V99
                                        COMP-3.
       01  WS-BRANC-AMT-001   PIC S9(15)V99
                                        COMP-3.
       01  WS-BRANC-AMT-002   PIC S9(15)V99
                                        COMP-3.
       01  WS-BRANC-AMT-003   PIC S9(15)V99
                                        COMP-3.
       01  WS-BRANC-AMT-004   PIC S9(15)V99
                                        COMP-3.
       01  WS-BRANC-AMT-005   PIC S9(15)V99
                                        COMP-3.
       01  WS-BRANC-AMT-006   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.
       01  LS-PCB-BRANC      PIC X(100).
       01  LS-IO-AREA              PIC X(2000).
       01  LS-KEY                   PIC X(32).
       01  LS-RETURN-CODE           PIC S9(04) COMP.
      *
       PROCEDURE DIVISION USING LS-PCB-BRANC
                                LS-IO-AREA
                                LS-KEY
                                LS-RETURN-CODE.
       0000-MAIN.
      ...
      *
       1000-GET-UNIQUE.
           MOVE "BRANCH" TO WS-SSA-SEG-NAME
           MOVE "(" TO WS-SSA-QUAL
           MOVE "KEY     " TO WS-SSA-FLD-NAME
           MOVE " =" TO WS-SSA-REL-OP
           MOVE LS-KEY TO WS-SSA-VALUE
           CALL "CBLTDLI" USING DLI-GU
               LS-PCB-BRANC WS-IO-AREA WS-SSA
           MOVE LS-PCB-BRANC TO WS-PCB-MASK
           IF PCB-OK

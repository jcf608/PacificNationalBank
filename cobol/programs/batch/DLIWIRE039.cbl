      ******************************************************************
      * DLIWIRE039.cbl — DL/I Wrapper for wire domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIWIRE039.
       ...
       01  WS-WIRE-FLD-000   PIC X(20).
       01  WS-WIRE-FLD-001   PIC X(20).
       01  WS-WIRE-FLD-002   PIC X(20).
       01  WS-WIRE-FLD-003   PIC X(40).
       01  WS-WIRE-FLD-004   PIC X(40).
       01  WS-WIRE-FLD-005   PIC X(40).
       01  WS-WIRE-FLD-006   PIC X(30).
       01  WS-WIRE-FLD-007   PIC X(30).
       01  WS-WIRE-FLD-008   PIC X(40).
       01  WS-WIRE-FLD-009   PIC X(30).
       01  WS-WIRE-FLD-010   PIC X(10).
       01  WS-WIRE-FLD-011   PIC X(10).
       01  WS-WIRE-FLD-012   PIC X(20).
       01  WS-WIRE-FLD-013   PIC X(40).
       01  WS-WIRE-AMT-000   PIC S9(15)V99
                                        COMP-3.
       01  WS-WIRE-AMT-001   PIC S9(15)V99
                                        COMP-3.
       01  WS-WIRE-AMT-002   PIC S9(15)V99
                                        COMP-3.
       01  WS-WIRE-AMT-003   PIC S9(15)V99
                                        COMP-3.
       01  WS-WIRE-AMT-004   PIC S9(15)V99
                                        COMP-3.
       01  WS-WIRE-AMT-005   PIC S9(15)V99
                                        COMP-3.
       01  WS-WIRE-AMT-006   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.
       01  LS-PCB-WIRE      PIC X(100).
       01  LS-IO-AREA              PIC X(2000).
       01  LS-KEY                   PIC X(32).
       01  LS-RETURN-CODE           PIC S9(04) COMP.
      *
       PROCEDURE DIVISION USING LS-PCB-WIRE
                                LS-IO-AREA
                                LS-KEY
                                LS-RETURN-CODE.
       0000-MAIN.
      ...
      *
       1000-GET-UNIQUE.
           MOVE "WIRE" TO WS-SSA-SEG-NAME
           MOVE "(" TO WS-SSA-QUAL
           MOVE "KEY     " TO WS-SSA-FLD-NAME
           MOVE " =" TO WS-SSA-REL-OP
           MOVE LS-KEY TO WS-SSA-VALUE
           CALL "CBLTDLI" USING DLI-GU
               LS-PCB-WIRE WS-IO-AREA WS-SSA
           MOVE LS-PCB-WIRE TO WS-PCB-MASK
           IF PCB-OK

      ******************************************************************
      * DLIACCOU078.cbl — DL/I Wrapper for account domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIACCOU078.
       ...
       01  WS-ACCOU-FLD-005   PIC X(30).
       01  WS-ACCOU-FLD-006   PIC X(30).
       01  WS-ACCOU-FLD-007   PIC X(10).
       01  WS-ACCOU-FLD-008   PIC X(10).
       01  WS-ACCOU-FLD-009   PIC X(30).
       01  WS-ACCOU-FLD-010   PIC X(40).

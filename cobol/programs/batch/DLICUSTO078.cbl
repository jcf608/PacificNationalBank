      ******************************************************************
      * DLICUSTO078.cbl — DL/I Wrapper for customer domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLICUSTO078.
       ...
       01  WS-CUSTO-FLD-003   PIC X(20).
       01  WS-CUSTO-FLD-004   PIC X(40).
       01  WS-CUSTO-FLD-005   PIC X(20).
       01  WS-CUSTO-FLD-006   PIC X(10).
       01  WS-CUSTO-FLD-007   PIC X(30).
       01  WS-CUSTO-FLD-008   PIC X(20).
       01  WS-CUSTO-FLD-009   PIC X(30).
       01  WS-CUSTO-FLD-010   PIC X(20).
       01  WS-CUSTO-FLD-011   PIC X(20).

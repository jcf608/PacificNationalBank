      ******************************************************************
      * DLIACH046.cbl — DL/I Wrapper for ach domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIACH046.
       ...
       01  WS-ACH-FLD-003   PIC X(40).
       01  WS-ACH-FLD-004   PIC X(30).
       01  WS-ACH-FLD-005   PIC X(30).
       01  WS-ACH-FLD-006   PIC X(10).
       01  WS-ACH-FLD-007   PIC X(30).
       01  WS-ACH-FLD-008   PIC X(10).
       01  WS-ACH-FLD-009   PIC X(40).

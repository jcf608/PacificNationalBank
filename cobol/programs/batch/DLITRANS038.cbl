      ******************************************************************
      * DLITRANS038.cbl — DL/I Wrapper for transaction domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLITRANS038.
       ...
       01  WS-TRANS-FLD-001   PIC X(20).
       01  WS-TRANS-FLD-002   PIC X(20).
       01  WS-TRANS-FLD-003   PIC X(10).
       ...
       01  WS-TRANS-FLD-010   PIC X(30).
       01  WS-TRANS-FLD-011   PIC X(10).
       01  WS-TRANS-FLD-012   PIC X(40).

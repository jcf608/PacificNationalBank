      ******************************************************************
      * DLILOAN047.cbl — DL/I Wrapper for loan domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLILOAN047.
       ...
       01  WS-LOAN-FLD-002   PIC X(10).
       01  WS-LOAN-FLD-003   PIC X(10).
       01  WS-LOAN-FLD-004   PIC X(30).
       01  WS-LOAN-FLD-005   PIC X(40).
       01  WS-LOAN-FLD-006   PIC X(10).
       01  WS-LOAN-FLD-007   PIC X(40).
       01  WS-LOAN-FLD-008   PIC X(20).
       01  WS-LOAN-FLD-009   PIC X(20).
       01  WS-LOAN-FLD-010   PIC X(10).
       01  WS-LOAN-FLD-011   PIC X(10).

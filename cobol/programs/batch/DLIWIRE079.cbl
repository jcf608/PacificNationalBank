      ******************************************************************
      * DLIWIRE079.cbl — DL/I Wrapper for wire domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIWIRE079.
       ...
       01  WS-WIRE-FLD-000   PIC X(30).
       01  WS-WIRE-FLD-001   PIC X(20).
       01  WS-WIRE-FLD-002   PIC X(40).
       01  WS-WIRE-FLD-003   PIC X(30).
       01  WS-WIRE-FLD-004   PIC X(30).
       01  WS-WIRE-FLD-005   PIC X(20).
       01  WS-WIRE-FLD-006   PIC X(30).
       01  WS-WIRE-FLD-007   PIC X(40).
       01  WS-WIRE-FLD-008   PIC X(10).
       01  WS-WIRE-FLD-009   PIC X(30).
       01  WS-WIRE-FLD-010   PIC X(30).
       01  WS-WIRE-FLD-011   PIC X(30).
       01  WS-WIRE-FLD-012   PIC X(30).
       01  WS-WIRE-FLD-013   PIC X(20).

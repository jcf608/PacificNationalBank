      ******************************************************************
      * DLITRANS039.cbl — DL/I Wrapper for transaction domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLITRANS039.
       ...
       01  WS-TRANS-FLD-000   PIC X(30).
       01  WS-TRANS-FLD-001   PIC X(40).
       01  WS-TRANS-FLD-002   PIC X(30).
       01  WS-TRANS-FLD-003   PIC X(20).
       01  WS-TRANS-FLD-004   PIC X(30).
       01  WS-TRANS-FLD-005   PIC X(20).
       01  WS-TRANS-FLD-006   PIC X(10).
       01  WS-TRANS-FLD-007   PIC X(30).
       01  WS-TRANS-FLD-008   PIC X(20).
       01  WS-TRANS-FLD-009   PIC X(20).
       01  WS-TRANS-FLD-010   PIC X(40).
       01  WS-TRANS-FLD-011   PIC X(40).
       01  WS-TRANS-FLD-012   PIC X(20).
       01  WS-TRANS-FLD-013   PIC X(30).
       01  WS-TRANS-AMT-000   PIC S9(15)V99
                                        COMP-3.
       01  WS-TRANS-AMT-001   PIC S9(15)V99
                                        COMP-3.
       01  WS-TRANS-AMT-002   PIC S9(15)V99
                                        COMP-3.
       01  WS-TRANS-AMT-003   PIC S9(15)V99
                                        COMP-3.
       01  WS-TRANS-AMT-004   PIC S9(15)V99
                                        COMP-3.
       01  WS-TRANS-AMT-005   PIC S9(15)V99
                                        COMP-3.
       01  WS-TRANS-AMT-006   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.
       01  LS-PCB-TRANS      PIC X(100).
       01  LS-IO-AREA              PIC X(2000).
       01  LS-KEY                   PIC X(32).
       01  LS-RETURN-CODE           PIC S9(04) COMP.
      *
       PROCEDURE DIVISION USING LS-PCB-TRANS
                                LS-IO-AREA
                                LS-KEY
                                LS-RETURN-CODE.
       0000-MAIN.
      ...
      *
       1000-GET-UNIQUE.
           MOVE "TRANSACT" TO WS-SSA-SEG-NAME
           MOVE "(" TO WS-SSA-QUAL
           MOVE "KEY     " TO WS-SSA-FLD-NAME
           MOVE " =" TO WS-SSA-REL-OP
           MOVE LS-KEY TO WS-SSA-VALUE
           CALL "CBLTDLI" USING DLI-GU
               LS-PCB-TRANS WS-IO-AREA WS-SSA
           MOVE LS-PCB-TRANS TO WS-PCB-MASK
           IF PCB-OK
      ...
      *
       6400-VALIDATE-RULE-004.
           ...
           CONTINUE.
      *
       6500-VALIDATE-RULE-005.
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-0 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-1 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-2 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-3 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-4 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-5 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-6 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-7 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-8 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-9 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-10 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-11 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-12 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-13 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-000 = SPACES
               MOVE "VALIDATION 5-14 FAILED" TO
                   WS-TRANS-FLD-001
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           CONTINUE.
      *
       6600-VALIDATE-RULE-006.
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-0 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-1 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-2 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-3 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-4 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-5 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-6 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-7 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-8 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-9 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-10 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-11 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-12 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-13 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-001 = SPACES
               MOVE "VALIDATION 6-14 FAILED" TO
                   WS-TRANS-FLD-002
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           CONTINUE.
      *
       6700-VALIDATE-RULE-007.
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-0 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-1 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-2 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-3 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-4 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-5 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-6 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-7 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-8 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-9 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-10 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-11 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-12 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-13 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-002 = SPACES
               MOVE "VALIDATION 7-14 FAILED" TO
                   WS-TRANS-FLD-003
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           CONTINUE.
      *
       6800-VALIDATE-RULE-008.
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-0 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-1 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-2 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-3 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-4 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-5 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-6 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-7 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-8 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-9 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-10 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-11 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-12 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-13 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-003 = SPACES
               MOVE "VALIDATION 8-14 FAILED" TO
                   WS-TRANS-FLD-004
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           CONTINUE.
      *
       6900-VALIDATE-RULE-009.
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-0 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-1 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-2 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-3 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-4 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-5 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-6 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-7 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-8 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-9 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-10 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-11 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-12 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-13 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           IF WS-TRANS-FLD-004 = SPACES
               MOVE "VALIDATION 9-14 FAILED" TO
                   WS-TRANS-FLD-000
               MOVE 8 TO WS-RETURN-CODE
           END-IF
           CONTINUE.

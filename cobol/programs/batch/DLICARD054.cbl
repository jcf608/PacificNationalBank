      ******************************************************************
      * DLICARD054.cbl — DL/I Wrapper for card domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLICARD054.
       ...
       01  WS-CARD-FLD-000   PIC X(30).
       01  WS-CARD-FLD-001   PIC X(30).
       01  WS-CARD-FLD-002   PIC X(30).
       01  WS-CARD-FLD-003   PIC X(20).
       01  WS-CARD-FLD-004   PIC X(30).
       01  WS-CARD-FLD-005   PIC X(10).
       01  WS-CARD-FLD-006   PIC X(20).
       01  WS-CARD-FLD-007   PIC X(40).
       01  WS-CARD-FLD-008   PIC X(40).
       ...
       01  WS-CARD-AMT-005   PIC S9(15)V99
                                        COMP-3.
       01  WS-CARD-AMT-006   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.

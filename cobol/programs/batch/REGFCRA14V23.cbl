      ******************************************************************
      * REGFCRA14V23.cbl — FCRA Regulatory Reporting Variant 23
      * Pacific National Bank — Core Banking System
      * Generated batch program
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. REGFCRA14V23.
       AUTHOR. PNB-CODE-GENERATOR.
       DATE-WRITTEN. 2026-05-26.
       DATE-COMPILED.
      *
      * FCRA Regulatory Reporting Variant 23
      *
       ...
       FILE-CONTROL.
           SELECT INPUT-FILE ASSIGN TO
               "REGFCRA14V23-INPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-INPUT-STATUS.
           SELECT OUTPUT-FILE ASSIGN TO
               "REGFCRA14V23-OUTPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-OUTPUT-STATUS.
           SELECT REPORT-FILE ASSIGN TO
               "REGFCRA14V23-REPORT.RPT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-REPORT-STATUS.
           SELECT ERROR-FILE ASSIGN TO
               "REGFCRA14V23-ERRORS.ERR"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
      ...
      *
       1000-INITIALIZE.
           ...
           DISPLAY "REGFCRA14V23 STARTED AT "
           ...
           IF WS-INPUT-STATUS NOT = "00"
               DISPLAY "REGFCRA14V23: ERROR OPENING INPUT FILE"
      ...
      *
       1500-WRITE-REPORT-HEADER.
           ...
           STRING "PACIFIC NATIONAL BANK - FCRA Regulatory Reporting Variant 23"
      ...
      *
       3230-VARIANT-23-STEP-00.
           DISPLAY "Processing variant 23 step 0"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0046 =
                   WS-VARIANT-0046 + 1
           END-IF
           ...
           CONTINUE.
      *
       3231-VARIANT-23-STEP-01.
           DISPLAY "Processing variant 23 step 1"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0046 =
                   WS-VARIANT-0046 + 1
           END-IF
           ...
           CONTINUE.
      *
       3232-VARIANT-23-STEP-02.
           DISPLAY "Processing variant 23 step 2"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0046 =
                   WS-VARIANT-0046 + 1
           END-IF
           ...
           CONTINUE.
      *
       3233-VARIANT-23-STEP-03.
           DISPLAY "Processing variant 23 step 3"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0046 =
                   WS-VARIANT-0046 + 1
           END-IF

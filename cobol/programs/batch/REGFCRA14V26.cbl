      ******************************************************************
      * REGFCRA14V26.cbl — FCRA Regulatory Reporting Variant 26
      * Pacific National Bank — Core Banking System
      * Generated batch program
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. REGFCRA14V26.
       AUTHOR. PNB-CODE-GENERATOR.
       DATE-WRITTEN. 2026-05-26.
       DATE-COMPILED.
      *
      * FCRA Regulatory Reporting Variant 26
      *
       ...
       FILE-CONTROL.
           SELECT INPUT-FILE ASSIGN TO
               "REGFCRA14V26-INPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-INPUT-STATUS.
           SELECT OUTPUT-FILE ASSIGN TO
               "REGFCRA14V26-OUTPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-OUTPUT-STATUS.
           SELECT REPORT-FILE ASSIGN TO
               "REGFCRA14V26-REPORT.RPT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-REPORT-STATUS.
           SELECT ERROR-FILE ASSIGN TO
               "REGFCRA14V26-ERRORS.ERR"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
      ...
      *
       1000-INITIALIZE.
           ...
           DISPLAY "REGFCRA14V26 STARTED AT "
           ...
           IF WS-INPUT-STATUS NOT = "00"
               DISPLAY "REGFCRA14V26: ERROR OPENING INPUT FILE"
      ...
      *
       1500-WRITE-REPORT-HEADER.
           ...
           STRING "PACIFIC NATIONAL BANK - FCRA Regulatory Reporting Variant 26"
      ...
      *
       3260-VARIANT-26-STEP-00.
           DISPLAY "Processing variant 26 step 0"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0052 =
                   WS-VARIANT-0052 + 1
           END-IF
           ...
           CONTINUE.
      *
       3261-VARIANT-26-STEP-01.
           DISPLAY "Processing variant 26 step 1"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0052 =
                   WS-VARIANT-0052 + 1
           END-IF

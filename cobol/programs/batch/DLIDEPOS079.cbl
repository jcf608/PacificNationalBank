      ******************************************************************
      * DLIDEPOS079.cbl — DL/I Wrapper for deposit domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIDEPOS079.
       ...
       01  WS-DEPOS-FLD-000   PIC X(10).
       01  WS-DEPOS-FLD-001   PIC X(20).
       01  WS-DEPOS-FLD-002   PIC X(30).
       01  WS-DEPOS-FLD-003   PIC X(30).
       01  WS-DEPOS-FLD-004   PIC X(10).
       01  WS-DEPOS-FLD-005   PIC X(30).
       01  WS-DEPOS-FLD-006   PIC X(30).
       01  WS-DEPOS-FLD-007   PIC X(30).
       01  WS-DEPOS-FLD-008   PIC X(10).
       01  WS-DEPOS-FLD-009   PIC X(30).
       01  WS-DEPOS-FLD-010   PIC X(30).
       01  WS-DEPOS-FLD-011   PIC X(20).
       01  WS-DEPOS-FLD-012   PIC X(20).
       01  WS-DEPOS-FLD-013   PIC X(30).
       01  WS-DEPOS-AMT-000   PIC S9(15)V99
                                        COMP-3.
       01  WS-DEPOS-AMT-001   PIC S9(15)V99
                                        COMP-3.
       01  WS-DEPOS-AMT-002   PIC S9(15)V99
                                        COMP-3.
       01  WS-DEPOS-AMT-003   PIC S9(15)V99
                                        COMP-3.
       01  WS-DEPOS-AMT-004   PIC S9(15)V99
                                        COMP-3.
       01  WS-DEPOS-AMT-005   PIC S9(15)V99
                                        COMP-3.
       01  WS-DEPOS-AMT-006   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.
       01  LS-PCB-DEPOS      PIC X(100).
       01  LS-IO-AREA              PIC X(2000).
       01  LS-KEY                   PIC X(32).
       01  LS-RETURN-CODE           PIC S9(04) COMP.
      *
       PROCEDURE DIVISION USING LS-PCB-DEPOS
                                LS-IO-AREA
                                LS-KEY
                                LS-RETURN-CODE.
       0000-MAIN.
      ...
      *
       1000-GET-UNIQUE.
           MOVE "DEPOSIT" TO WS-SSA-SEG-NAME
           MOVE "(" TO WS-SSA-QUAL
           MOVE "KEY     " TO WS-SSA-FLD-NAME
           MOVE " =" TO WS-SSA-REL-OP
           MOVE LS-KEY TO WS-SSA-VALUE
           CALL "CBLTDLI" USING DLI-GU
               LS-PCB-DEPOS WS-IO-AREA WS-SSA
           MOVE LS-PCB-DEPOS TO WS-PCB-MASK
           IF PCB-OK

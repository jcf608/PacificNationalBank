      ******************************************************************
      * DLICARD047.cbl — DL/I Wrapper for card domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLICARD047.
       ...
       01  WS-CARD-FLD-000   PIC X(40).
       01  WS-CARD-FLD-001   PIC X(10).
       01  WS-CARD-FLD-002   PIC X(40).
       01  WS-CARD-FLD-003   PIC X(30).
       01  WS-CARD-FLD-004   PIC X(10).
       01  WS-CARD-FLD-005   PIC X(20).
       01  WS-CARD-FLD-006   PIC X(10).
       01  WS-CARD-FLD-007   PIC X(30).
       01  WS-CARD-FLD-008   PIC X(30).
       01  WS-CARD-FLD-009   PIC X(20).
       01  WS-CARD-FLD-010   PIC X(20).
       01  WS-CARD-FLD-011   PIC X(40).
       01  WS-CARD-AMT-000   PIC S9(15)V99
                                        COMP-3.
       01  WS-CARD-AMT-001   PIC S9(15)V99
                                        COMP-3.
       01  WS-CARD-AMT-002   PIC S9(15)V99
                                        COMP-3.
       01  WS-CARD-AMT-003   PIC S9(15)V99
                                        COMP-3.
       01  WS-CARD-AMT-004   PIC S9(15)V99
                                        COMP-3.
      *
       LINKAGE SECTION.
       01  LS-PCB-CARD      PIC X(100).
       01  LS-IO-AREA              PIC X(2000).
       01  LS-KEY                   PIC X(32).
       01  LS-RETURN-CODE           PIC S9(04) COMP.
      *
       PROCEDURE DIVISION USING LS-PCB-CARD
                                LS-IO-AREA
                                LS-KEY
                                LS-RETURN-CODE.
       0000-MAIN.
      ...
      *
       1000-GET-UNIQUE.
           MOVE "CARD" TO WS-SSA-SEG-NAME
           MOVE "(" TO WS-SSA-QUAL
           MOVE "KEY     " TO WS-SSA-FLD-NAME
           MOVE " =" TO WS-SSA-REL-OP
           MOVE LS-KEY TO WS-SSA-VALUE
           CALL "CBLTDLI" USING DLI-GU
               LS-PCB-CARD WS-IO-AREA WS-SSA
           MOVE LS-PCB-CARD TO WS-PCB-MASK
           IF PCB-OK

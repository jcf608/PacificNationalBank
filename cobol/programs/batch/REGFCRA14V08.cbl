      ******************************************************************
      * REGFCRA14V08.cbl — FCRA Regulatory Reporting Variant 8
      * Pacific National Bank — Core Banking System
      * Generated batch program
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. REGFCRA14V08.
       AUTHOR. PNB-CODE-GENERATOR.
       DATE-WRITTEN. 2026-05-26.
       DATE-COMPILED.
      *
      * FCRA Regulatory Reporting Variant 8
      *
       ...
       FILE-CONTROL.
           SELECT INPUT-FILE ASSIGN TO
               "REGFCRA14V08-INPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-INPUT-STATUS.
           SELECT OUTPUT-FILE ASSIGN TO
               "REGFCRA14V08-OUTPUT.DAT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-OUTPUT-STATUS.
           SELECT REPORT-FILE ASSIGN TO
               "REGFCRA14V08-REPORT.RPT"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-REPORT-STATUS.
           SELECT ERROR-FILE ASSIGN TO
               "REGFCRA14V08-ERRORS.ERR"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
      ...
      *
       1000-INITIALIZE.
           ...
           DISPLAY "REGFCRA14V08 STARTED AT "
           ...
           IF WS-INPUT-STATUS NOT = "00"
               DISPLAY "REGFCRA14V08: ERROR OPENING INPUT FILE"
      ...
      *
       1500-WRITE-REPORT-HEADER.
           ...
           STRING "PACIFIC NATIONAL BANK - FCRA Regulatory Reporting Variant 8"
      ...
      *
       3080-VARIANT-08-STEP-00.
           DISPLAY "Processing variant 8 step 0"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0016 =
                   WS-VARIANT-0016 + 1
           END-IF
           ...
           CONTINUE.
      *
       3081-VARIANT-08-STEP-01.
           DISPLAY "Processing variant 8 step 1"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0016 =
                   WS-VARIANT-0016 + 1
           END-IF
           ...
           CONTINUE.
      *
       3082-VARIANT-08-STEP-02.
           DISPLAY "Processing variant 8 step 2"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0016 =
                   WS-VARIANT-0016 + 1
           END-IF
           ...
           CONTINUE.
      *
       3083-VARIANT-08-STEP-03.
           DISPLAY "Processing variant 8 step 3"
           IF WS-RECORDS-READ > 0
               COMPUTE WS-VARIANT-0016 =
                   WS-VARIANT-0016 + 1
           END-IF

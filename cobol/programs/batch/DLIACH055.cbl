      ******************************************************************
      * DLIACH055.cbl — DL/I Wrapper for ach domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIACH055.
       ...
       01  WS-ACH-FLD-000   PIC X(20).
       01  WS-ACH-FLD-001   PIC X(40).
       01  WS-ACH-FLD-002   PIC X(10).
       01  WS-ACH-FLD-003   PIC X(20).

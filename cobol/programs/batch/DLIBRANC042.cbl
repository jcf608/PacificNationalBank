      ******************************************************************
      * DLIBRANC042.cbl — DL/I Wrapper for branch domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLIBRANC042.
       ...
       01  WS-BRANC-FLD-001   PIC X(20).
       01  WS-BRANC-FLD-002   PIC X(20).
       01  WS-BRANC-FLD-003   PIC X(20).
       01  WS-BRANC-FLD-004   PIC X(10).
       01  WS-BRANC-FLD-005   PIC X(10).

      ******************************************************************
      * DLICUSTO063.cbl — DL/I Wrapper for customer domain
      * Pacific National Bank — IMS/DB Access Layer
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. DLICUSTO063.
       ...
       01  WS-CUSTO-FLD-000   PIC X(30).
       01  WS-CUSTO-FLD-001   PIC X(30).
       01  WS-CUSTO-FLD-002   PIC X(40).
       01  WS-CUSTO-FLD-003   PIC X(40).
       01  WS-CUSTO-FLD-004   PIC X(20).

      ******************************************************************
      * OTXACH-05V10.cbl — Online ACH-CREDIT Transaction V10
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXACH-05V10.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-FIELD-0030   PIC X(20).
           05  WS-OL-AMT-0030     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0031   PIC X(20).
           05  WS-OL-AMT-0031     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0032   PIC X(20).
           05  WS-OL-AMT-0032     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0033   PIC X(20).
           05  WS-OL-AMT-0033     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0034   PIC X(20).
           05  WS-OL-AMT-0034     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0035   PIC X(20).
           05  WS-OL-AMT-0035     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0036   PIC X(20).
           05  WS-OL-AMT-0036     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0037   PIC X(20).
           05  WS-OL-AMT-0037     PIC S9(13)V99
                                    COMP-3.
      *
       ...
       5100-ONLINE-STEP-00.
           ...
           IF WS-RESPONSE-CODE NOT =
               ...
               MOVE "LINK FAILED" TO
                   WS-CA-MESSAGE
           END-IF.
           MOVE WS-OL-FIELD-0030
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0031
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0032
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0033
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0034
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0035
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0036
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0037
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0030
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0031

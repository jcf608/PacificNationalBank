      ******************************************************************
      * OTXWITH01V14.cbl — Online WITHDRAWAL Transaction V14
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXWITH01V14.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-FIELD-0042   PIC X(20).
           05  WS-OL-AMT-0042     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0043   PIC X(20).
           05  WS-OL-AMT-0043     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0044   PIC X(20).
           05  WS-OL-AMT-0044     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0045   PIC X(20).
           05  WS-OL-AMT-0045     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0046   PIC X(20).
           05  WS-OL-AMT-0046     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0047   PIC X(20).
           05  WS-OL-AMT-0047     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0048   PIC X(20).
           05  WS-OL-AMT-0048     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0049   PIC X(20).
           05  WS-OL-AMT-0049     PIC S9(13)V99
                                    COMP-3.
      *
       ...
       5140-ONLINE-STEP-00.
           ...
           IF WS-RESPONSE-CODE NOT =
               ...
               MOVE "LINK FAILED" TO
                   WS-CA-MESSAGE
           END-IF.
           MOVE WS-OL-FIELD-0042
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0043
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0044
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0045
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0046
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0047
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0048
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0049
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0042
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0043

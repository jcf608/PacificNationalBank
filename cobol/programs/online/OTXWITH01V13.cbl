      ******************************************************************
      * OTXWITH01V13.cbl — Online WITHDRAWAL Transaction V13
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXWITH01V13.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-FIELD-0039   PIC X(20).
           05  WS-OL-AMT-0039     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0040   PIC X(20).
           05  WS-OL-AMT-0040     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0041   PIC X(20).
           05  WS-OL-AMT-0041     PIC S9(13)V99
                                    COMP-3.
       ...
       5130-ONLINE-STEP-00.
           ...
           IF WS-RESPONSE-CODE NOT =
               ...
               MOVE "LINK FAILED" TO
                   WS-CA-MESSAGE
           END-IF.
           MOVE WS-OL-FIELD-0039
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0040
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0041
               TO WS-CA-MESSAGE

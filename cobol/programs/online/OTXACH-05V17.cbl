      ******************************************************************
      * OTXACH-05V17.cbl — Online ACH-CREDIT Transaction V17
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXACH-05V17.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-FIELD-0051   PIC X(20).
           05  WS-OL-AMT-0051     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0052   PIC X(20).
           05  WS-OL-AMT-0052     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0053   PIC X(20).
           05  WS-OL-AMT-0053     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0054   PIC X(20).
           05  WS-OL-AMT-0054     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0055   PIC X(20).
           05  WS-OL-AMT-0055     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0056   PIC X(20).
           05  WS-OL-AMT-0056     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0057   PIC X(20).
           05  WS-OL-AMT-0057     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0058   PIC X(20).
           05  WS-OL-AMT-0058     PIC S9(13)V99
                                    COMP-3.
      *
       ...
       5170-ONLINE-STEP-00.
           ...
           IF WS-RESPONSE-CODE NOT =
               ...
               MOVE "LINK FAILED" TO
                   WS-CA-MESSAGE
           END-IF.
           MOVE WS-OL-FIELD-0051
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0052
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0053
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0054
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0055
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0056
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0057
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0058
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0051
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0052

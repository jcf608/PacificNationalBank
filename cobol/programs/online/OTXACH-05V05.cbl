      ******************************************************************
      * OTXACH-05V05.cbl — Online ACH-CREDIT Transaction V5
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXACH-05V05.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-FIELD-0015   PIC X(20).
           05  WS-OL-AMT-0015     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0016   PIC X(20).
           05  WS-OL-AMT-0016     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0017   PIC X(20).
           05  WS-OL-AMT-0017     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0018   PIC X(20).
           05  WS-OL-AMT-0018     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0019   PIC X(20).
           05  WS-OL-AMT-0019     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0020   PIC X(20).
           05  WS-OL-AMT-0020     PIC S9(13)V99
                                    COMP-3.
       ...
       5050-ONLINE-STEP-00.
           ...
           IF WS-RESPONSE-CODE NOT =
               ...
               MOVE "LINK FAILED" TO
                   WS-CA-MESSAGE
           END-IF.
           MOVE WS-OL-FIELD-0015
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0016
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0017
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0018
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0019
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0020
               TO WS-CA-MESSAGE

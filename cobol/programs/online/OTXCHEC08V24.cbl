      ******************************************************************
      * OTXCHEC08V24.cbl — Online CHECK-PAID Transaction V24
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXCHEC08V24.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-AMT-0073     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0074   PIC X(20).
           05  WS-OL-AMT-0074     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0075   PIC X(20).
           05  WS-OL-AMT-0075     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0076   PIC X(20).
           05  WS-OL-AMT-0076     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0077   PIC X(20).
           05  WS-OL-AMT-0077     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0078   PIC X(20).
           05  WS-OL-AMT-0078     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0079   PIC X(20).
           05  WS-OL-AMT-0079     PIC S9(13)V99
                                    COMP-3.
      *
      ...
      *
       5240-ONLINE-STEP-00.
           ...
           MOVE WS-OL-FIELD-0073
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0074
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0075
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0076
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0077
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0078
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0079
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0072
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0073

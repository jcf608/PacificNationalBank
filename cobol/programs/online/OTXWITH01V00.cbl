      ******************************************************************
      * OTXWITH01V00.cbl — Online WITHDRAWAL Transaction V0
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXWITH01V00.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-FIELD-0000   PIC X(20).
           05  WS-OL-AMT-0000     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0001   PIC X(20).
           05  WS-OL-AMT-0001     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0002   PIC X(20).
           05  WS-OL-AMT-0002     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0003   PIC X(20).
           05  WS-OL-AMT-0003     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0004   PIC X(20).
           05  WS-OL-AMT-0004     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0005   PIC X(20).
           05  WS-OL-AMT-0005     PIC S9(13)V99
                                    COMP-3.
       ...
       5000-ONLINE-STEP-00.
           ...
           IF WS-RESPONSE-CODE NOT =
               ...
               MOVE "LINK FAILED" TO
                   WS-CA-MESSAGE
           END-IF.
           MOVE WS-OL-FIELD-0000
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0001
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0002
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0003
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0004
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0005
               TO WS-CA-MESSAGE

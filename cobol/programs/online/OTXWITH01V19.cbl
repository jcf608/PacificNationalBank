      ******************************************************************
      * OTXWITH01V19.cbl — Online WITHDRAWAL Transaction V19
      * Pacific National Bank — Online Transaction Processing
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. OTXWITH01V19.
      ...
      *
       ...
       01  WS-COMMAREA.
           ...
           05  WS-OL-AMT-0058     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0059   PIC X(20).
           05  WS-OL-AMT-0059     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0060   PIC X(20).
           05  WS-OL-AMT-0060     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0061   PIC X(20).
           05  WS-OL-AMT-0061     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0062   PIC X(20).
           05  WS-OL-AMT-0062     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0063   PIC X(20).
           05  WS-OL-AMT-0063     PIC S9(13)V99
                                    COMP-3.
           05  WS-OL-FIELD-0064   PIC X(20).
           05  WS-OL-AMT-0064     PIC S9(13)V99
                                    COMP-3.
      *
      ...
      *
       5190-ONLINE-STEP-00.
           ...
           MOVE WS-OL-FIELD-0058
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0059
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0060
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0061
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0062
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0063
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0064
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0057
               TO WS-CA-MESSAGE
           MOVE WS-OL-FIELD-0058

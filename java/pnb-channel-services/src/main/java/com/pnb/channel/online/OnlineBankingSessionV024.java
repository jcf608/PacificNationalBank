...
/**
 * OnlineBankingSessionV024 — Pacific National Bank entity.
 * Auto-generated domain object.
 */
@Entity
@Table(name = "ONLINEBANKINGSESSIONV024")
public class OnlineBankingSessionV024 {
    ...
    public OnlineBankingSessionV024() {}
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OnlineBankingSessionV024)) return false;
        OnlineBankingSessionV024 that = (OnlineBankingSessionV024) o;
    ...
    public String toString() {
        return "OnlineBankingSessionV024{" +
            "id=" + id +
            ", sessionId=" + sessionId +

...
/**
 * ComplianceMapper047 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper047 {

    public ComplianceDto047 toDto(ComplianceV047 entity) {
        if (entity == null) return null;
        ComplianceDto047 dto = new ComplianceDto047();
    ...
    public ComplianceV047 toEntity(ComplianceDto047 dto) {
        if (dto == null) return null;
        ComplianceV047 entity = new ComplianceV047();

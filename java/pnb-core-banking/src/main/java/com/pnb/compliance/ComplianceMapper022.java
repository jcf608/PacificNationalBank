...
/**
 * ComplianceMapper022 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper022 {

    public ComplianceDto022 toDto(ComplianceV022 entity) {
        if (entity == null) return null;
        ComplianceDto022 dto = new ComplianceDto022();
    ...
    public ComplianceV022 toEntity(ComplianceDto022 dto) {
        if (dto == null) return null;
        ComplianceV022 entity = new ComplianceV022();

...
/**
 * ComplianceMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper023 {

    public ComplianceDto023 toDto(ComplianceV023 entity) {
        if (entity == null) return null;
        ComplianceDto023 dto = new ComplianceDto023();
    ...
    public ComplianceV023 toEntity(ComplianceDto023 dto) {
        if (dto == null) return null;
        ComplianceV023 entity = new ComplianceV023();

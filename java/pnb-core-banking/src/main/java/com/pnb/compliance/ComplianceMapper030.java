...
/**
 * ComplianceMapper030 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper030 {

    public ComplianceDto030 toDto(ComplianceV030 entity) {
        if (entity == null) return null;
        ComplianceDto030 dto = new ComplianceDto030();
    ...
    public ComplianceV030 toEntity(ComplianceDto030 dto) {
        if (dto == null) return null;
        ComplianceV030 entity = new ComplianceV030();

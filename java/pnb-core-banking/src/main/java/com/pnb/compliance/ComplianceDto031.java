...
/**
 * ComplianceDto031 — Data Transfer Object for compliance operations.
 * Variant 31 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ComplianceDto031 {
    ...
    private BigDecimal compField014;

    public ComplianceDto031() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final ComplianceDto031 instance = new ComplianceDto031();
        ...
        public Builder compField014(BigDecimal val) { instance.compField014 = val; return this; }
        public ComplianceDto031 build() { return instance; }
    }
    ...
    public BigDecimal getCompField014() { return compField014; }
    public void setCompField014(BigDecimal compField014) { this.compField014 = compField014; }

    @Override
    public String toString() {
        return "ComplianceDto031{" +

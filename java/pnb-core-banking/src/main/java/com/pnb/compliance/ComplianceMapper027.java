...
/**
 * ComplianceMapper027 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper027 {

    public ComplianceDto027 toDto(ComplianceV027 entity) {
        if (entity == null) return null;
        ComplianceDto027 dto = new ComplianceDto027();
    ...
    public ComplianceV027 toEntity(ComplianceDto027 dto) {
        if (dto == null) return null;
        ComplianceV027 entity = new ComplianceV027();

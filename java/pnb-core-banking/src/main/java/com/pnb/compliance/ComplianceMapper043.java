...
/**
 * ComplianceMapper043 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper043 {

    public ComplianceDto043 toDto(ComplianceV043 entity) {
        if (entity == null) return null;
        ComplianceDto043 dto = new ComplianceDto043();
    ...
    public ComplianceV043 toEntity(ComplianceDto043 dto) {
        if (dto == null) return null;
        ComplianceV043 entity = new ComplianceV043();

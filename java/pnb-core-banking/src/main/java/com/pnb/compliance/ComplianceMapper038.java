...
/**
 * ComplianceMapper038 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper038 {

    public ComplianceDto038 toDto(ComplianceV038 entity) {
        if (entity == null) return null;
        ComplianceDto038 dto = new ComplianceDto038();
    ...
    public ComplianceV038 toEntity(ComplianceDto038 dto) {
        if (dto == null) return null;
        ComplianceV038 entity = new ComplianceV038();

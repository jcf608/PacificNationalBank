...
/**
 * ComplianceDto044 — Data Transfer Object for compliance operations.
 * Variant 44 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ComplianceDto044 {
    ...
    public ComplianceDto044() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final ComplianceDto044 instance = new ComplianceDto044();
        ...
        public ComplianceDto044 build() { return instance; }
    }

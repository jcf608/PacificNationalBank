...
/**
 * ComplianceMapper036 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper036 {

    public ComplianceDto036 toDto(ComplianceV036 entity) {
        if (entity == null) return null;
        ComplianceDto036 dto = new ComplianceDto036();
    ...
    public ComplianceV036 toEntity(ComplianceDto036 dto) {
        if (dto == null) return null;
        ComplianceV036 entity = new ComplianceV036();

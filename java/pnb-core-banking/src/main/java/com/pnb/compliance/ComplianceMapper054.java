...
/**
 * ComplianceMapper054 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper054 {

    public ComplianceDto054 toDto(ComplianceV054 entity) {
        if (entity == null) return null;
        ComplianceDto054 dto = new ComplianceDto054();
    ...
    public ComplianceV054 toEntity(ComplianceDto054 dto) {
        if (dto == null) return null;
        ComplianceV054 entity = new ComplianceV054();

...
/**
 * ComplianceMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper024 {

    public ComplianceDto024 toDto(ComplianceV024 entity) {
        if (entity == null) return null;
        ComplianceDto024 dto = new ComplianceDto024();
    ...
    public ComplianceV024 toEntity(ComplianceDto024 dto) {
        if (dto == null) return null;
        ComplianceV024 entity = new ComplianceV024();

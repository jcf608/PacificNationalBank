...
/**
 * ComplianceMapper041 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper041 {

    public ComplianceDto041 toDto(ComplianceV041 entity) {
        if (entity == null) return null;
        ComplianceDto041 dto = new ComplianceDto041();
    ...
    public ComplianceV041 toEntity(ComplianceDto041 dto) {
        if (dto == null) return null;
        ComplianceV041 entity = new ComplianceV041();

...
/**
 * ComplianceMapper028 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ComplianceMapper028 {

    public ComplianceDto028 toDto(ComplianceV028 entity) {
        if (entity == null) return null;
        ComplianceDto028 dto = new ComplianceDto028();
    ...
    public ComplianceV028 toEntity(ComplianceDto028 dto) {
        if (dto == null) return null;
        ComplianceV028 entity = new ComplianceV028();

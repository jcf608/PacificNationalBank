...
/**
 * StopMapper030 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper030 {

    public StopDto030 toDto(StopV030 entity) {
        if (entity == null) return null;
        StopDto030 dto = new StopDto030();
    ...
    public StopV030 toEntity(StopDto030 dto) {
        if (dto == null) return null;
        StopV030 entity = new StopV030();

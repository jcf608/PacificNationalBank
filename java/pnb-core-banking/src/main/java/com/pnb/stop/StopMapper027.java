...
/**
 * StopMapper027 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper027 {

    public StopDto027 toDto(StopV027 entity) {
        if (entity == null) return null;
        StopDto027 dto = new StopDto027();
    ...
    public StopV027 toEntity(StopDto027 dto) {
        if (dto == null) return null;
        StopV027 entity = new StopV027();

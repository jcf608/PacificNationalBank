...
/**
 * StopMapper051 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper051 {

    public StopDto051 toDto(StopV051 entity) {
        if (entity == null) return null;
        StopDto051 dto = new StopDto051();
    ...
    public StopV051 toEntity(StopDto051 dto) {
        if (dto == null) return null;
        StopV051 entity = new StopV051();

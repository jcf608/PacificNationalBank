...
/**
 * StopMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper024 {

    public StopDto024 toDto(StopV024 entity) {
        if (entity == null) return null;
        StopDto024 dto = new StopDto024();
    ...
    public StopV024 toEntity(StopDto024 dto) {
        if (dto == null) return null;
        StopV024 entity = new StopV024();

...
/**
 * StopMapper039 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper039 {

    public StopDto039 toDto(StopV039 entity) {
        if (entity == null) return null;
        StopDto039 dto = new StopDto039();
    ...
    public StopV039 toEntity(StopDto039 dto) {
        if (dto == null) return null;
        StopV039 entity = new StopV039();

...
/**
 * StopDto056 — Data Transfer Object for stop operations.
 * Variant 56 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class StopDto056 {
    ...
    public static class Builder {
        private final StopDto056 instance = new StopDto056();
        ...
        public StopDto056 build() { return instance; }
    }

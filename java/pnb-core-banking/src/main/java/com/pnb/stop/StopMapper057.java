...
/**
 * StopMapper057 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper057 {

    public StopDto057 toDto(StopV057 entity) {
        if (entity == null) return null;
        StopDto057 dto = new StopDto057();
    ...
    public StopV057 toEntity(StopDto057 dto) {
        if (dto == null) return null;
        StopV057 entity = new StopV057();

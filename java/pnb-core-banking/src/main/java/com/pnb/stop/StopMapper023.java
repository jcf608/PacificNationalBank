...
/**
 * StopMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper023 {

    public StopDto023 toDto(StopV023 entity) {
        if (entity == null) return null;
        StopDto023 dto = new StopDto023();
    ...
    public StopV023 toEntity(StopDto023 dto) {
        if (dto == null) return null;
        StopV023 entity = new StopV023();

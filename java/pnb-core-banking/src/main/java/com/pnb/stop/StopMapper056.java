...
/**
 * StopMapper056 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper056 {

    public StopDto056 toDto(StopV056 entity) {
        if (entity == null) return null;
        StopDto056 dto = new StopDto056();
    ...
    public StopV056 toEntity(StopDto056 dto) {
        if (dto == null) return null;
        StopV056 entity = new StopV056();

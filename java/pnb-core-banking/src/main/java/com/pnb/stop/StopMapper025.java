...
/**
 * StopMapper025 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper025 {

    public StopDto025 toDto(StopV025 entity) {
        if (entity == null) return null;
        StopDto025 dto = new StopDto025();
    ...
    public StopV025 toEntity(StopDto025 dto) {
        if (dto == null) return null;
        StopV025 entity = new StopV025();

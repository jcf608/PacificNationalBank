...
/**
 * StopMapper022 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper022 {

    public StopDto022 toDto(StopV022 entity) {
        if (entity == null) return null;
        StopDto022 dto = new StopDto022();
    ...
    public StopV022 toEntity(StopDto022 dto) {
        if (dto == null) return null;
        StopV022 entity = new StopV022();

...
/**
 * StopMapper047 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper047 {

    public StopDto047 toDto(StopV047 entity) {
        if (entity == null) return null;
        StopDto047 dto = new StopDto047();
    ...
    public StopV047 toEntity(StopDto047 dto) {
        if (dto == null) return null;
        StopV047 entity = new StopV047();

...
/**
 * StopMapper043 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper043 {

    public StopDto043 toDto(StopV043 entity) {
        if (entity == null) return null;
        StopDto043 dto = new StopDto043();
    ...
    public StopV043 toEntity(StopDto043 dto) {
        if (dto == null) return null;
        StopV043 entity = new StopV043();

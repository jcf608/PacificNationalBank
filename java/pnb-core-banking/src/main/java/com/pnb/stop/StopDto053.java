...
/**
 * StopDto053 — Data Transfer Object for stop operations.
 * Variant 53 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class StopDto053 {
    ...
    public static class Builder {
        private final StopDto053 instance = new StopDto053();
        ...
        public StopDto053 build() { return instance; }
    }

...
/**
 * StopMapper026 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper026 {

    public StopDto026 toDto(StopV026 entity) {
        if (entity == null) return null;
        StopDto026 dto = new StopDto026();
    ...
    public StopV026 toEntity(StopDto026 dto) {
        if (dto == null) return null;
        StopV026 entity = new StopV026();

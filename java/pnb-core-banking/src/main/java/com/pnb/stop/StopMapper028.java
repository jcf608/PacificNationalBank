...
/**
 * StopMapper028 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper028 {

    public StopDto028 toDto(StopV028 entity) {
        if (entity == null) return null;
        StopDto028 dto = new StopDto028();
    ...
    public StopV028 toEntity(StopDto028 dto) {
        if (dto == null) return null;
        StopV028 entity = new StopV028();

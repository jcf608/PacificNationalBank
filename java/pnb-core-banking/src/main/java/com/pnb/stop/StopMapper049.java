...
/**
 * StopMapper049 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper049 {

    public StopDto049 toDto(StopV049 entity) {
        if (entity == null) return null;
        StopDto049 dto = new StopDto049();
    ...
    public StopV049 toEntity(StopDto049 dto) {
        if (dto == null) return null;
        StopV049 entity = new StopV049();

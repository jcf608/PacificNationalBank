...
/**
 * StopMapper020 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper020 {

    public StopDto020 toDto(StopV020 entity) {
        if (entity == null) return null;
        StopDto020 dto = new StopDto020();
    ...
    public StopV020 toEntity(StopDto020 dto) {
        if (dto == null) return null;
        StopV020 entity = new StopV020();

...
/**
 * StopMapper038 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper038 {

    public StopDto038 toDto(StopV038 entity) {
        if (entity == null) return null;
        StopDto038 dto = new StopDto038();
    ...
    public StopV038 toEntity(StopDto038 dto) {
        if (dto == null) return null;
        StopV038 entity = new StopV038();

...
/**
 * StopMapper042 — Maps between entity and DTO.
 */
@ApplicationScoped
public class StopMapper042 {

    public StopDto042 toDto(StopV042 entity) {
        if (entity == null) return null;
        StopDto042 dto = new StopDto042();
    ...
    public StopV042 toEntity(StopDto042 dto) {
        if (dto == null) return null;
        StopV042 entity = new StopV042();

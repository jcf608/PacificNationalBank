...
/**
 * BranchDto027 — Data Transfer Object for branch operations.
 * Variant 27 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BranchDto027 {
    ...
    public static class Builder {
        private final BranchDto027 instance = new BranchDto027();
        ...
        public BranchDto027 build() { return instance; }
    }

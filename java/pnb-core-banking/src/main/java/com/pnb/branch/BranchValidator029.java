...
/**
 * BranchValidator029 — Business rule validation.
 */
@ApplicationScoped
public class BranchValidator029 {

    public List<String> validate(BranchDto029 dto) {
        ...
        if (dto.getBranField006() != null && dto.getBranField006().compareTo(BigDecimal.ZERO) < 0) {

...
/**
 * BranchMapper059 — Maps between entity and DTO.
 */
@ApplicationScoped
public class BranchMapper059 {

    public BranchDto059 toDto(BranchV059 entity) {
        if (entity == null) return null;
        BranchDto059 dto = new BranchDto059();
    ...
    public BranchV059 toEntity(BranchDto059 dto) {
        if (dto == null) return null;
        BranchV059 entity = new BranchV059();

...
/**
 * BranchMapper022 — Maps between entity and DTO.
 */
@ApplicationScoped
public class BranchMapper022 {

    public BranchDto022 toDto(BranchV022 entity) {
        if (entity == null) return null;
        BranchDto022 dto = new BranchDto022();
    ...
    public BranchV022 toEntity(BranchDto022 dto) {
        if (dto == null) return null;
        BranchV022 entity = new BranchV022();

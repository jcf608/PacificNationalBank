...
/**
 * BranchMapper043 — Maps between entity and DTO.
 */
@ApplicationScoped
public class BranchMapper043 {

    public BranchDto043 toDto(BranchV043 entity) {
        if (entity == null) return null;
        BranchDto043 dto = new BranchDto043();
    ...
    public BranchV043 toEntity(BranchDto043 dto) {
        if (dto == null) return null;
        BranchV043 entity = new BranchV043();

...
/**
 * AccountMapper034 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper034 {

    public AccountDto034 toDto(AccountV034 entity) {
        if (entity == null) return null;
        AccountDto034 dto = new AccountDto034();
    ...
    public AccountV034 toEntity(AccountDto034 dto) {
        if (dto == null) return null;
        AccountV034 entity = new AccountV034();

...
/**
 * AccountMapper042 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper042 {

    public AccountDto042 toDto(AccountV042 entity) {
        if (entity == null) return null;
        AccountDto042 dto = new AccountDto042();
    ...
    public AccountV042 toEntity(AccountDto042 dto) {
        if (dto == null) return null;
        AccountV042 entity = new AccountV042();

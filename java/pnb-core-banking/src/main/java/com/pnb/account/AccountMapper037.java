...
/**
 * AccountMapper037 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper037 {

    public AccountDto037 toDto(AccountV037 entity) {
        if (entity == null) return null;
        AccountDto037 dto = new AccountDto037();
    ...
    public AccountV037 toEntity(AccountDto037 dto) {
        if (dto == null) return null;
        AccountV037 entity = new AccountV037();

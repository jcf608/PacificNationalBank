...
/**
 * AccountMapper051 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper051 {

    public AccountDto051 toDto(AccountV051 entity) {
        if (entity == null) return null;
        AccountDto051 dto = new AccountDto051();
    ...
    public AccountV051 toEntity(AccountDto051 dto) {
        if (dto == null) return null;
        AccountV051 entity = new AccountV051();

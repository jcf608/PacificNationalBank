...
/**
 * AccountMapper026 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper026 {

    public AccountDto026 toDto(AccountV026 entity) {
        if (entity == null) return null;
        AccountDto026 dto = new AccountDto026();
    ...
    public AccountV026 toEntity(AccountDto026 dto) {
        if (dto == null) return null;
        AccountV026 entity = new AccountV026();

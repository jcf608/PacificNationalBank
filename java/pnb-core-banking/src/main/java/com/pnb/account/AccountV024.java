...
/**
 * AccountV024 — Pacific National Bank entity.
 * Auto-generated domain object.
 */
@Entity
@Table(name = "ACCOUNTV024")
public class AccountV024 {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccountV024)) return false;
        AccountV024 that = (AccountV024) o;

...
/**
 * AccountMapper057 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper057 {

    public AccountDto057 toDto(AccountV057 entity) {
        if (entity == null) return null;
        AccountDto057 dto = new AccountDto057();
    ...
    public AccountV057 toEntity(AccountDto057 dto) {
        if (dto == null) return null;
        AccountV057 entity = new AccountV057();

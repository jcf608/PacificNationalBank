...
/**
 * AccountMapper028 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper028 {

    public AccountDto028 toDto(AccountV028 entity) {
        if (entity == null) return null;
        AccountDto028 dto = new AccountDto028();
    ...
    public AccountV028 toEntity(AccountDto028 dto) {
        if (dto == null) return null;
        AccountV028 entity = new AccountV028();

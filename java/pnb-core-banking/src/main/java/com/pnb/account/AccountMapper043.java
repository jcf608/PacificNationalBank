...
/**
 * AccountMapper043 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper043 {

    public AccountDto043 toDto(AccountV043 entity) {
        if (entity == null) return null;
        AccountDto043 dto = new AccountDto043();
    ...
    public AccountV043 toEntity(AccountDto043 dto) {
        if (dto == null) return null;
        AccountV043 entity = new AccountV043();

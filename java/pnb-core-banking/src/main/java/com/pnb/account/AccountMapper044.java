...
/**
 * AccountMapper044 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper044 {

    public AccountDto044 toDto(AccountV044 entity) {
        if (entity == null) return null;
        AccountDto044 dto = new AccountDto044();
    ...
    public AccountV044 toEntity(AccountDto044 dto) {
        if (dto == null) return null;
        AccountV044 entity = new AccountV044();

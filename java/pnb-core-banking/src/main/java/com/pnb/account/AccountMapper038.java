...
/**
 * AccountMapper038 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper038 {

    public AccountDto038 toDto(AccountV038 entity) {
        if (entity == null) return null;
        AccountDto038 dto = new AccountDto038();
    ...
    public AccountV038 toEntity(AccountDto038 dto) {
        if (dto == null) return null;
        AccountV038 entity = new AccountV038();

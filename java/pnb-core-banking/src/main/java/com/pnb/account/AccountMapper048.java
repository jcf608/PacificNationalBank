...
/**
 * AccountMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper048 {

    public AccountDto048 toDto(AccountV048 entity) {
        if (entity == null) return null;
        AccountDto048 dto = new AccountDto048();
    ...
    public AccountV048 toEntity(AccountDto048 dto) {
        if (dto == null) return null;
        AccountV048 entity = new AccountV048();

...
/**
 * AccountMapper049 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper049 {

    public AccountDto049 toDto(AccountV049 entity) {
        if (entity == null) return null;
        AccountDto049 dto = new AccountDto049();
    ...
    public AccountV049 toEntity(AccountDto049 dto) {
        if (dto == null) return null;
        AccountV049 entity = new AccountV049();

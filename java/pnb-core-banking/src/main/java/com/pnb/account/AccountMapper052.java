...
/**
 * AccountMapper052 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper052 {

    public AccountDto052 toDto(AccountV052 entity) {
        if (entity == null) return null;
        AccountDto052 dto = new AccountDto052();
    ...
    public AccountV052 toEntity(AccountDto052 dto) {
        if (dto == null) return null;
        AccountV052 entity = new AccountV052();

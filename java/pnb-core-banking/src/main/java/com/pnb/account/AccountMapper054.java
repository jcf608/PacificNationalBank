...
/**
 * AccountMapper054 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AccountMapper054 {

    public AccountDto054 toDto(AccountV054 entity) {
        if (entity == null) return null;
        AccountDto054 dto = new AccountDto054();
    ...
    public AccountV054 toEntity(AccountDto054 dto) {
        if (dto == null) return null;
        AccountV054 entity = new AccountV054();

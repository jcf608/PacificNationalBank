...
/**
 * FeeMapper020 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper020 {

    public FeeDto020 toDto(FeeV020 entity) {
        if (entity == null) return null;
        FeeDto020 dto = new FeeDto020();
    ...
    public FeeV020 toEntity(FeeDto020 dto) {
        if (dto == null) return null;
        FeeV020 entity = new FeeV020();

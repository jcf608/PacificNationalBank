...
/**
 * FeeMapper039 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper039 {

    public FeeDto039 toDto(FeeV039 entity) {
        if (entity == null) return null;
        FeeDto039 dto = new FeeDto039();
    ...
    public FeeV039 toEntity(FeeDto039 dto) {
        if (dto == null) return null;
        FeeV039 entity = new FeeV039();

...
/**
 * FeeDto033 — Data Transfer Object for fee operations.
 * Variant 33 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FeeDto033 {
    ...
    public static class Builder {
        private final FeeDto033 instance = new FeeDto033();
        ...
        public Builder feeField016(LocalDate val) { instance.feeField016 = val; return this; }
        public FeeDto033 build() { return instance; }
    }
    ...
    public LocalDate getFeeField016() { return feeField016; }
    public void setFeeField016(LocalDate feeField016) { this.feeField016 = feeField016; }

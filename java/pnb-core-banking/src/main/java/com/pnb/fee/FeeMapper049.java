...
/**
 * FeeMapper049 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper049 {

    public FeeDto049 toDto(FeeV049 entity) {
        if (entity == null) return null;
        FeeDto049 dto = new FeeDto049();
    ...
    public FeeV049 toEntity(FeeDto049 dto) {
        if (dto == null) return null;
        FeeV049 entity = new FeeV049();

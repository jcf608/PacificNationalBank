...
/**
 * FeeMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper024 {

    public FeeDto024 toDto(FeeV024 entity) {
        if (entity == null) return null;
        FeeDto024 dto = new FeeDto024();
    ...
    public FeeV024 toEntity(FeeDto024 dto) {
        if (dto == null) return null;
        FeeV024 entity = new FeeV024();

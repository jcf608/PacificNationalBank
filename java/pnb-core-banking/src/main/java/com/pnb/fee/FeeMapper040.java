...
/**
 * FeeMapper040 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper040 {

    public FeeDto040 toDto(FeeV040 entity) {
        if (entity == null) return null;
        FeeDto040 dto = new FeeDto040();
    ...
    public FeeV040 toEntity(FeeDto040 dto) {
        if (dto == null) return null;
        FeeV040 entity = new FeeV040();

...
/**
 * FeeMapper045 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper045 {

    public FeeDto045 toDto(FeeV045 entity) {
        if (entity == null) return null;
        FeeDto045 dto = new FeeDto045();
    ...
    public FeeV045 toEntity(FeeDto045 dto) {
        if (dto == null) return null;
        FeeV045 entity = new FeeV045();

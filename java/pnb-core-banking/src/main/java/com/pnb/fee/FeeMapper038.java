...
/**
 * FeeMapper038 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper038 {

    public FeeDto038 toDto(FeeV038 entity) {
        if (entity == null) return null;
        FeeDto038 dto = new FeeDto038();
    ...
    public FeeV038 toEntity(FeeDto038 dto) {
        if (dto == null) return null;
        FeeV038 entity = new FeeV038();

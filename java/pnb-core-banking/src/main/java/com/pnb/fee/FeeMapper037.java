...
/**
 * FeeMapper037 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper037 {

    public FeeDto037 toDto(FeeV037 entity) {
        if (entity == null) return null;
        FeeDto037 dto = new FeeDto037();
    ...
    public FeeV037 toEntity(FeeDto037 dto) {
        if (dto == null) return null;
        FeeV037 entity = new FeeV037();

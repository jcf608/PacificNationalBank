...
/**
 * FeeMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper048 {

    public FeeDto048 toDto(FeeV048 entity) {
        if (entity == null) return null;
        FeeDto048 dto = new FeeDto048();
    ...
    public FeeV048 toEntity(FeeDto048 dto) {
        if (dto == null) return null;
        FeeV048 entity = new FeeV048();

...
/**
 * FeeMapper035 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper035 {

    public FeeDto035 toDto(FeeV035 entity) {
        if (entity == null) return null;
        FeeDto035 dto = new FeeDto035();
    ...
    public FeeV035 toEntity(FeeDto035 dto) {
        if (dto == null) return null;
        FeeV035 entity = new FeeV035();

...
/**
 * FeeDto048 — Data Transfer Object for fee operations.
 * Variant 48 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class FeeDto048 {
    ...
    public static class Builder {
        private final FeeDto048 instance = new FeeDto048();
        ...
        public FeeDto048 build() { return instance; }
    }

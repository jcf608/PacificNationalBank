...
/**
 * FeeMapper022 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper022 {

    public FeeDto022 toDto(FeeV022 entity) {
        if (entity == null) return null;
        FeeDto022 dto = new FeeDto022();
    ...
    public FeeV022 toEntity(FeeDto022 dto) {
        if (dto == null) return null;
        FeeV022 entity = new FeeV022();

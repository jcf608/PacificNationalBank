...
/**
 * FeeMapper036 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper036 {

    public FeeDto036 toDto(FeeV036 entity) {
        if (entity == null) return null;
        FeeDto036 dto = new FeeDto036();
    ...
    public FeeV036 toEntity(FeeDto036 dto) {
        if (dto == null) return null;
        FeeV036 entity = new FeeV036();

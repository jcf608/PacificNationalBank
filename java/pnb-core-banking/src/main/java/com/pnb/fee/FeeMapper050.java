...
/**
 * FeeMapper050 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FeeMapper050 {

    public FeeDto050 toDto(FeeV050 entity) {
        if (entity == null) return null;
        FeeDto050 dto = new FeeDto050();
    ...
    public FeeV050 toEntity(FeeDto050 dto) {
        if (dto == null) return null;
        FeeV050 entity = new FeeV050();

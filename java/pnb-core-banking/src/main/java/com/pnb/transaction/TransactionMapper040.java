...
/**
 * TransactionMapper040 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper040 {

    public TransactionDto040 toDto(TransactionV040 entity) {
        if (entity == null) return null;
        TransactionDto040 dto = new TransactionDto040();
    ...
    public TransactionV040 toEntity(TransactionDto040 dto) {
        if (dto == null) return null;
        TransactionV040 entity = new TransactionV040();

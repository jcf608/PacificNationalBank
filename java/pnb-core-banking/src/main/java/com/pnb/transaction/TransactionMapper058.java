...
/**
 * TransactionMapper058 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper058 {

    public TransactionDto058 toDto(TransactionV058 entity) {
        if (entity == null) return null;
        TransactionDto058 dto = new TransactionDto058();
    ...
    public TransactionV058 toEntity(TransactionDto058 dto) {
        if (dto == null) return null;
        TransactionV058 entity = new TransactionV058();

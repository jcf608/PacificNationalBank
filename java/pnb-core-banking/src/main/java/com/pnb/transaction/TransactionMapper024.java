...
/**
 * TransactionMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper024 {

    public TransactionDto024 toDto(TransactionV024 entity) {
        if (entity == null) return null;
        TransactionDto024 dto = new TransactionDto024();
    ...
    public TransactionV024 toEntity(TransactionDto024 dto) {
        if (dto == null) return null;
        TransactionV024 entity = new TransactionV024();

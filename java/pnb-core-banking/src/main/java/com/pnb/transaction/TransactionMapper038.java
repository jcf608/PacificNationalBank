...
/**
 * TransactionMapper038 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper038 {

    public TransactionDto038 toDto(TransactionV038 entity) {
        if (entity == null) return null;
        TransactionDto038 dto = new TransactionDto038();
    ...
    public TransactionV038 toEntity(TransactionDto038 dto) {
        if (dto == null) return null;
        TransactionV038 entity = new TransactionV038();

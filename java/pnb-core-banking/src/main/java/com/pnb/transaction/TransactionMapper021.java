...
/**
 * TransactionMapper021 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper021 {

    public TransactionDto021 toDto(TransactionV021 entity) {
        if (entity == null) return null;
        TransactionDto021 dto = new TransactionDto021();
    ...
    public TransactionV021 toEntity(TransactionDto021 dto) {
        if (dto == null) return null;
        TransactionV021 entity = new TransactionV021();

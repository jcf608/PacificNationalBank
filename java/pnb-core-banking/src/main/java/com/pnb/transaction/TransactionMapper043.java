...
/**
 * TransactionMapper043 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper043 {

    public TransactionDto043 toDto(TransactionV043 entity) {
        if (entity == null) return null;
        TransactionDto043 dto = new TransactionDto043();
    ...
    public TransactionV043 toEntity(TransactionDto043 dto) {
        if (dto == null) return null;
        TransactionV043 entity = new TransactionV043();

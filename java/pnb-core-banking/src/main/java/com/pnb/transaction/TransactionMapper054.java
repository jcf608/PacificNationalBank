...
/**
 * TransactionMapper054 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper054 {

    public TransactionDto054 toDto(TransactionV054 entity) {
        if (entity == null) return null;
        TransactionDto054 dto = new TransactionDto054();
    ...
    public TransactionV054 toEntity(TransactionDto054 dto) {
        if (dto == null) return null;
        TransactionV054 entity = new TransactionV054();

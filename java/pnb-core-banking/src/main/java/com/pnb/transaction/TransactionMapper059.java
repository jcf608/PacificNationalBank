...
/**
 * TransactionMapper059 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper059 {

    public TransactionDto059 toDto(TransactionV059 entity) {
        if (entity == null) return null;
        TransactionDto059 dto = new TransactionDto059();
    ...
    public TransactionV059 toEntity(TransactionDto059 dto) {
        if (dto == null) return null;
        TransactionV059 entity = new TransactionV059();

...
/**
 * TransactionMapper053 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper053 {

    public TransactionDto053 toDto(TransactionV053 entity) {
        if (entity == null) return null;
        TransactionDto053 dto = new TransactionDto053();
    ...
    public TransactionV053 toEntity(TransactionDto053 dto) {
        if (dto == null) return null;
        TransactionV053 entity = new TransactionV053();

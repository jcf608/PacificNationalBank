...
/**
 * TransactionMapper044 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper044 {

    public TransactionDto044 toDto(TransactionV044 entity) {
        if (entity == null) return null;
        TransactionDto044 dto = new TransactionDto044();
    ...
    public TransactionV044 toEntity(TransactionDto044 dto) {
        if (dto == null) return null;
        TransactionV044 entity = new TransactionV044();

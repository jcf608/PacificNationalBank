...
/**
 * TransactionMapper030 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper030 {

    public TransactionDto030 toDto(TransactionV030 entity) {
        if (entity == null) return null;
        TransactionDto030 dto = new TransactionDto030();
    ...
    public TransactionV030 toEntity(TransactionDto030 dto) {
        if (dto == null) return null;
        TransactionV030 entity = new TransactionV030();

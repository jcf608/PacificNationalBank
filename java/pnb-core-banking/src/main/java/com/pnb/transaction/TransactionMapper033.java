...
/**
 * TransactionMapper033 — Maps between entity and DTO.
 */
@ApplicationScoped
public class TransactionMapper033 {

    public TransactionDto033 toDto(TransactionV033 entity) {
        if (entity == null) return null;
        TransactionDto033 dto = new TransactionDto033();
    ...
    public TransactionV033 toEntity(TransactionDto033 dto) {
        if (dto == null) return null;
        TransactionV033 entity = new TransactionV033();

...
/**
 * CardMapper059 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper059 {

    public CardDto059 toDto(CardV059 entity) {
        if (entity == null) return null;
        CardDto059 dto = new CardDto059();
    ...
    public CardV059 toEntity(CardDto059 dto) {
        if (dto == null) return null;
        CardV059 entity = new CardV059();

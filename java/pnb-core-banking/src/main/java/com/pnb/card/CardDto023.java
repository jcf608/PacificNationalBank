...
/**
 * CardDto023 — Data Transfer Object for card operations.
 * Variant 23 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CardDto023 {
    ...
    public static class Builder {
        private final CardDto023 instance = new CardDto023();
        ...
        public Builder cardField018(Integer val) { instance.cardField018 = val; return this; }
        public CardDto023 build() { return instance; }
    }
    ...
    public Integer getCardField018() { return cardField018; }
    public void setCardField018(Integer cardField018) { this.cardField018 = cardField018; }

...
/**
 * CardMapper042 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper042 {

    public CardDto042 toDto(CardV042 entity) {
        if (entity == null) return null;
        CardDto042 dto = new CardDto042();
    ...
    public CardV042 toEntity(CardDto042 dto) {
        if (dto == null) return null;
        CardV042 entity = new CardV042();

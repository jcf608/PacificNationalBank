...
/**
 * CardMapper053 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper053 {

    public CardDto053 toDto(CardV053 entity) {
        if (entity == null) return null;
        CardDto053 dto = new CardDto053();
    ...
    public CardV053 toEntity(CardDto053 dto) {
        if (dto == null) return null;
        CardV053 entity = new CardV053();

...
/**
 * CardMapper054 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper054 {

    public CardDto054 toDto(CardV054 entity) {
        if (entity == null) return null;
        CardDto054 dto = new CardDto054();
    ...
    public CardV054 toEntity(CardDto054 dto) {
        if (dto == null) return null;
        CardV054 entity = new CardV054();

...
/**
 * CardMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper023 {

    public CardDto023 toDto(CardV023 entity) {
        if (entity == null) return null;
        CardDto023 dto = new CardDto023();
    ...
    public CardV023 toEntity(CardDto023 dto) {
        if (dto == null) return null;
        CardV023 entity = new CardV023();

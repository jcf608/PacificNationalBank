...
/**
 * CardMapper026 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper026 {

    public CardDto026 toDto(CardV026 entity) {
        if (entity == null) return null;
        CardDto026 dto = new CardDto026();
    ...
    public CardV026 toEntity(CardDto026 dto) {
        if (dto == null) return null;
        CardV026 entity = new CardV026();

...
/**
 * CardDto028 — Data Transfer Object for card operations.
 * Variant 28 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CardDto028 {
    ...
    public static class Builder {
        private final CardDto028 instance = new CardDto028();
        ...
        public CardDto028 build() { return instance; }
    }

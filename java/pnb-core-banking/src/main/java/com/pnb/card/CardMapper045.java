...
/**
 * CardMapper045 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper045 {

    public CardDto045 toDto(CardV045 entity) {
        if (entity == null) return null;
        CardDto045 dto = new CardDto045();
    ...
    public CardV045 toEntity(CardDto045 dto) {
        if (dto == null) return null;
        CardV045 entity = new CardV045();

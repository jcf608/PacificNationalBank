...
/**
 * CardDto053 — Data Transfer Object for card operations.
 * Variant 53 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CardDto053 {
    ...
    public static class Builder {
        private final CardDto053 instance = new CardDto053();
        ...
        public CardDto053 build() { return instance; }
    }

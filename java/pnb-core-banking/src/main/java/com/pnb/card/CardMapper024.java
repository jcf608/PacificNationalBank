...
/**
 * CardMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper024 {

    public CardDto024 toDto(CardV024 entity) {
        if (entity == null) return null;
        CardDto024 dto = new CardDto024();
    ...
    public CardV024 toEntity(CardDto024 dto) {
        if (dto == null) return null;
        CardV024 entity = new CardV024();

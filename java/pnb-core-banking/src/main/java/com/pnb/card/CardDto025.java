...
/**
 * CardDto025 — Data Transfer Object for card operations.
 * Variant 25 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CardDto025 {
    ...
    public static class Builder {
        private final CardDto025 instance = new CardDto025();
        ...
        public CardDto025 build() { return instance; }
    }

...
/**
 * CardMapper057 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper057 {

    public CardDto057 toDto(CardV057 entity) {
        if (entity == null) return null;
        CardDto057 dto = new CardDto057();
    ...
    public CardV057 toEntity(CardDto057 dto) {
        if (dto == null) return null;
        CardV057 entity = new CardV057();

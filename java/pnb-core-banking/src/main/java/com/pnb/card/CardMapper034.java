...
/**
 * CardMapper034 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper034 {

    public CardDto034 toDto(CardV034 entity) {
        if (entity == null) return null;
        CardDto034 dto = new CardDto034();
    ...
    public CardV034 toEntity(CardDto034 dto) {
        if (dto == null) return null;
        CardV034 entity = new CardV034();

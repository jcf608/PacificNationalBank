...
/**
 * CardDto032 — Data Transfer Object for card operations.
 * Variant 32 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CardDto032 {
    ...
    public static class Builder {
        private final CardDto032 instance = new CardDto032();
        ...
        public CardDto032 build() { return instance; }
    }

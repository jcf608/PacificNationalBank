...
/**
 * CardMapper036 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CardMapper036 {

    public CardDto036 toDto(CardV036 entity) {
        if (entity == null) return null;
        CardDto036 dto = new CardDto036();
    ...
    public CardV036 toEntity(CardDto036 dto) {
        if (dto == null) return null;
        CardV036 entity = new CardV036();

...
/**
 * AuditDto037 — Data Transfer Object for audit operations.
 * Variant 37 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class AuditDto037 {
    ...
    public static class Builder {
        private final AuditDto037 instance = new AuditDto037();
        ...
        public AuditDto037 build() { return instance; }
    }

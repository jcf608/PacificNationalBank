...
/**
 * AuditMapper045 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AuditMapper045 {

    public AuditDto045 toDto(AuditV045 entity) {
        if (entity == null) return null;
        AuditDto045 dto = new AuditDto045();
    ...
    public AuditV045 toEntity(AuditDto045 dto) {
        if (dto == null) return null;
        AuditV045 entity = new AuditV045();

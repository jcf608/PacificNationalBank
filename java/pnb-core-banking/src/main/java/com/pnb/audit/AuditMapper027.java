...
/**
 * AuditMapper027 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AuditMapper027 {

    public AuditDto027 toDto(AuditV027 entity) {
        if (entity == null) return null;
        AuditDto027 dto = new AuditDto027();
    ...
    public AuditV027 toEntity(AuditDto027 dto) {
        if (dto == null) return null;
        AuditV027 entity = new AuditV027();

...
/**
 * AuditMapper043 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AuditMapper043 {

    public AuditDto043 toDto(AuditV043 entity) {
        if (entity == null) return null;
        AuditDto043 dto = new AuditDto043();
    ...
    public AuditV043 toEntity(AuditDto043 dto) {
        if (dto == null) return null;
        AuditV043 entity = new AuditV043();

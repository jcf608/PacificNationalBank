...
/**
 * AuditMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AuditMapper023 {

    public AuditDto023 toDto(AuditV023 entity) {
        if (entity == null) return null;
        AuditDto023 dto = new AuditDto023();
    ...
    public AuditV023 toEntity(AuditDto023 dto) {
        if (dto == null) return null;
        AuditV023 entity = new AuditV023();

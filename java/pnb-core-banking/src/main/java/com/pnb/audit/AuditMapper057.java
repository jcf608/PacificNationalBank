...
/**
 * AuditMapper057 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AuditMapper057 {

    public AuditDto057 toDto(AuditV057 entity) {
        if (entity == null) return null;
        AuditDto057 dto = new AuditDto057();
    ...
    public AuditV057 toEntity(AuditDto057 dto) {
        if (dto == null) return null;
        AuditV057 entity = new AuditV057();

...
/**
 * AuditDto041 — Data Transfer Object for audit operations.
 * Variant 41 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class AuditDto041 {
    ...
    public static class Builder {
        private final AuditDto041 instance = new AuditDto041();
        ...
        public AuditDto041 build() { return instance; }
    }

...
/**
 * AchMapper034 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AchMapper034 {

    public AchDto034 toDto(AchV034 entity) {
        if (entity == null) return null;
        AchDto034 dto = new AchDto034();
    ...
    public AchV034 toEntity(AchDto034 dto) {
        if (dto == null) return null;
        AchV034 entity = new AchV034();

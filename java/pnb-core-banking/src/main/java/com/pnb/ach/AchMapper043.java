...
/**
 * AchMapper043 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AchMapper043 {

    public AchDto043 toDto(AchV043 entity) {
        if (entity == null) return null;
        AchDto043 dto = new AchDto043();
    ...
    public AchV043 toEntity(AchDto043 dto) {
        if (dto == null) return null;
        AchV043 entity = new AchV043();

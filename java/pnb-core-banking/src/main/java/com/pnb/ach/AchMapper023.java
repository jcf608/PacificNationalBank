...
/**
 * AchMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AchMapper023 {

    public AchDto023 toDto(AchV023 entity) {
        if (entity == null) return null;
        AchDto023 dto = new AchDto023();
    ...
    public AchV023 toEntity(AchDto023 dto) {
        if (dto == null) return null;
        AchV023 entity = new AchV023();

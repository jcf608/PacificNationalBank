...
/**
 * AchMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AchMapper048 {

    public AchDto048 toDto(AchV048 entity) {
        if (entity == null) return null;
        AchDto048 dto = new AchDto048();
    ...
    public AchV048 toEntity(AchDto048 dto) {
        if (dto == null) return null;
        AchV048 entity = new AchV048();

...
/**
 * AchMapper036 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AchMapper036 {

    public AchDto036 toDto(AchV036 entity) {
        if (entity == null) return null;
        AchDto036 dto = new AchDto036();
    ...
    public AchV036 toEntity(AchDto036 dto) {
        if (dto == null) return null;
        AchV036 entity = new AchV036();

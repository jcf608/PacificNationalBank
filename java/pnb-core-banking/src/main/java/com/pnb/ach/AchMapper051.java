...
/**
 * AchMapper051 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AchMapper051 {

    public AchDto051 toDto(AchV051 entity) {
        if (entity == null) return null;
        AchDto051 dto = new AchDto051();
    ...
    public AchV051 toEntity(AchDto051 dto) {
        if (dto == null) return null;
        AchV051 entity = new AchV051();

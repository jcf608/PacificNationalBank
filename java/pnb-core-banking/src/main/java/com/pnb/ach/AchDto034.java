...
/**
 * AchDto034 — Data Transfer Object for ach operations.
 * Variant 34 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class AchDto034 {
    ...
    public static class Builder {
        private final AchDto034 instance = new AchDto034();
        ...
        public AchDto034 build() { return instance; }
    }

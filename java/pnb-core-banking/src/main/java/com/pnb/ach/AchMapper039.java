...
/**
 * AchMapper039 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AchMapper039 {

    public AchDto039 toDto(AchV039 entity) {
        if (entity == null) return null;
        AchDto039 dto = new AchDto039();
    ...
    public AchV039 toEntity(AchDto039 dto) {
        if (dto == null) return null;
        AchV039 entity = new AchV039();

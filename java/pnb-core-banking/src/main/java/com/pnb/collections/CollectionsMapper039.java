...
/**
 * CollectionsMapper039 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CollectionsMapper039 {

    public CollectionsDto039 toDto(CollectionsV039 entity) {
        if (entity == null) return null;
        CollectionsDto039 dto = new CollectionsDto039();
    ...
    public CollectionsV039 toEntity(CollectionsDto039 dto) {
        if (dto == null) return null;
        CollectionsV039 entity = new CollectionsV039();

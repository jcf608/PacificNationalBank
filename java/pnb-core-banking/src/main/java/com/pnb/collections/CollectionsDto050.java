...
/**
 * CollectionsDto050 — Data Transfer Object for collections operations.
 * Variant 50 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CollectionsDto050 {
    ...
    public CollectionsDto050() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final CollectionsDto050 instance = new CollectionsDto050();
        ...
        public CollectionsDto050 build() { return instance; }
    }

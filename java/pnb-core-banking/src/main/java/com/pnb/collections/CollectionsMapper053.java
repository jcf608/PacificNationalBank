...
/**
 * CollectionsMapper053 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CollectionsMapper053 {

    public CollectionsDto053 toDto(CollectionsV053 entity) {
        if (entity == null) return null;
        CollectionsDto053 dto = new CollectionsDto053();
    ...
    public CollectionsV053 toEntity(CollectionsDto053 dto) {
        if (dto == null) return null;
        CollectionsV053 entity = new CollectionsV053();

...
/**
 * CollectionsMapper058 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CollectionsMapper058 {

    public CollectionsDto058 toDto(CollectionsV058 entity) {
        if (entity == null) return null;
        CollectionsDto058 dto = new CollectionsDto058();
    ...
    public CollectionsV058 toEntity(CollectionsDto058 dto) {
        if (dto == null) return null;
        CollectionsV058 entity = new CollectionsV058();

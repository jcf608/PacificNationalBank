...
/**
 * CollectionsMapper031 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CollectionsMapper031 {

    public CollectionsDto031 toDto(CollectionsV031 entity) {
        if (entity == null) return null;
        CollectionsDto031 dto = new CollectionsDto031();
    ...
    public CollectionsV031 toEntity(CollectionsDto031 dto) {
        if (dto == null) return null;
        CollectionsV031 entity = new CollectionsV031();

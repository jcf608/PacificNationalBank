...
/**
 * CollectionsMapper057 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CollectionsMapper057 {

    public CollectionsDto057 toDto(CollectionsV057 entity) {
        if (entity == null) return null;
        CollectionsDto057 dto = new CollectionsDto057();
    ...
    public CollectionsV057 toEntity(CollectionsDto057 dto) {
        if (dto == null) return null;
        CollectionsV057 entity = new CollectionsV057();

...
/**
 * CollectionsMapper051 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CollectionsMapper051 {

    public CollectionsDto051 toDto(CollectionsV051 entity) {
        if (entity == null) return null;
        CollectionsDto051 dto = new CollectionsDto051();
    ...
    public CollectionsV051 toEntity(CollectionsDto051 dto) {
        if (dto == null) return null;
        CollectionsV051 entity = new CollectionsV051();

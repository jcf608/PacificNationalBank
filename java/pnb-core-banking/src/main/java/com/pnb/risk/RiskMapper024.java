...
/**
 * RiskMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RiskMapper024 {

    public RiskDto024 toDto(RiskV024 entity) {
        if (entity == null) return null;
        RiskDto024 dto = new RiskDto024();
    ...
    public RiskV024 toEntity(RiskDto024 dto) {
        if (dto == null) return null;
        RiskV024 entity = new RiskV024();

...
/**
 * RiskMapper031 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RiskMapper031 {

    public RiskDto031 toDto(RiskV031 entity) {
        if (entity == null) return null;
        RiskDto031 dto = new RiskDto031();
    ...
    public RiskV031 toEntity(RiskDto031 dto) {
        if (dto == null) return null;
        RiskV031 entity = new RiskV031();

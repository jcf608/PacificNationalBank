...
/**
 * RiskValidator057 — Business rule validation.
 */
@ApplicationScoped
public class RiskValidator057 {

    public List<String> validate(RiskDto057 dto) {
        ...
        if (dto.getRiskField016() != null && dto.getRiskField016() < 0) {

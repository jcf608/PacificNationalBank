...
/**
 * AlertMapper032 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AlertMapper032 {

    public AlertDto032 toDto(AlertV032 entity) {
        if (entity == null) return null;
        AlertDto032 dto = new AlertDto032();
    ...
    public AlertV032 toEntity(AlertDto032 dto) {
        if (dto == null) return null;
        AlertV032 entity = new AlertV032();

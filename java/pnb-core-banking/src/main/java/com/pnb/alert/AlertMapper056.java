...
/**
 * AlertMapper056 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AlertMapper056 {

    public AlertDto056 toDto(AlertV056 entity) {
        if (entity == null) return null;
        AlertDto056 dto = new AlertDto056();
    ...
    public AlertV056 toEntity(AlertDto056 dto) {
        if (dto == null) return null;
        AlertV056 entity = new AlertV056();

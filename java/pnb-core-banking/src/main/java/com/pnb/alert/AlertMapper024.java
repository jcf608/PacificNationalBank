...
/**
 * AlertMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AlertMapper024 {

    public AlertDto024 toDto(AlertV024 entity) {
        if (entity == null) return null;
        AlertDto024 dto = new AlertDto024();
    ...
    public AlertV024 toEntity(AlertDto024 dto) {
        if (dto == null) return null;
        AlertV024 entity = new AlertV024();

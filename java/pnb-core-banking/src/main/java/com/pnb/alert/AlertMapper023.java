...
/**
 * AlertMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class AlertMapper023 {

    public AlertDto023 toDto(AlertV023 entity) {
        if (entity == null) return null;
        AlertDto023 dto = new AlertDto023();
    ...
    public AlertV023 toEntity(AlertDto023 dto) {
        if (dto == null) return null;
        AlertV023 entity = new AlertV023();

...
/**
 * HoldDto054 — Data Transfer Object for hold operations.
 * Variant 54 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class HoldDto054 {
    ...
    public static class Builder {
        private final HoldDto054 instance = new HoldDto054();
        ...
        public HoldDto054 build() { return instance; }
    }

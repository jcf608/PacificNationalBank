...
/**
 * HoldDto034 — Data Transfer Object for hold operations.
 * Variant 34 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class HoldDto034 {
    ...
    private LocalDate holdField014;
    ...
    public static class Builder {
        private final HoldDto034 instance = new HoldDto034();
        ...
        public Builder holdField014(LocalDate val) { instance.holdField014 = val; return this; }
        ...
        public HoldDto034 build() { return instance; }
    }
    ...
    public LocalDate getHoldField014() { return holdField014; }
    public void setHoldField014(LocalDate holdField014) { this.holdField014 = holdField014; }

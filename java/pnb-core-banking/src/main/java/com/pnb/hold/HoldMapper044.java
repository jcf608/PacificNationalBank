...
/**
 * HoldMapper044 — Maps between entity and DTO.
 */
@ApplicationScoped
public class HoldMapper044 {

    public HoldDto044 toDto(HoldV044 entity) {
        if (entity == null) return null;
        HoldDto044 dto = new HoldDto044();
    ...
    public HoldV044 toEntity(HoldDto044 dto) {
        if (dto == null) return null;
        HoldV044 entity = new HoldV044();

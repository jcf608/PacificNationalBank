...
/**
 * HoldMapper040 — Maps between entity and DTO.
 */
@ApplicationScoped
public class HoldMapper040 {

    public HoldDto040 toDto(HoldV040 entity) {
        if (entity == null) return null;
        HoldDto040 dto = new HoldDto040();
    ...
    public HoldV040 toEntity(HoldDto040 dto) {
        if (dto == null) return null;
        HoldV040 entity = new HoldV040();

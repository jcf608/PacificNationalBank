...
/**
 * HoldMapper050 — Maps between entity and DTO.
 */
@ApplicationScoped
public class HoldMapper050 {

    public HoldDto050 toDto(HoldV050 entity) {
        if (entity == null) return null;
        HoldDto050 dto = new HoldDto050();
    ...
    public HoldV050 toEntity(HoldDto050 dto) {
        if (dto == null) return null;
        HoldV050 entity = new HoldV050();

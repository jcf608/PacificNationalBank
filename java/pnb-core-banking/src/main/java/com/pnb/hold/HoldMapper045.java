...
/**
 * HoldMapper045 — Maps between entity and DTO.
 */
@ApplicationScoped
public class HoldMapper045 {

    public HoldDto045 toDto(HoldV045 entity) {
        if (entity == null) return null;
        HoldDto045 dto = new HoldDto045();
    ...
    public HoldV045 toEntity(HoldDto045 dto) {
        if (dto == null) return null;
        HoldV045 entity = new HoldV045();

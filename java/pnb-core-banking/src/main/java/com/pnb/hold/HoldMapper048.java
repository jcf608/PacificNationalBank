...
/**
 * HoldMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class HoldMapper048 {

    public HoldDto048 toDto(HoldV048 entity) {
        if (entity == null) return null;
        HoldDto048 dto = new HoldDto048();
    ...
    public HoldV048 toEntity(HoldDto048 dto) {
        if (dto == null) return null;
        HoldV048 entity = new HoldV048();

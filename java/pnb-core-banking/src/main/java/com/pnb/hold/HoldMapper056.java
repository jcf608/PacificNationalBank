...
/**
 * HoldMapper056 — Maps between entity and DTO.
 */
@ApplicationScoped
public class HoldMapper056 {

    public HoldDto056 toDto(HoldV056 entity) {
        if (entity == null) return null;
        HoldDto056 dto = new HoldDto056();
    ...
    public HoldV056 toEntity(HoldDto056 dto) {
        if (dto == null) return null;
        HoldV056 entity = new HoldV056();

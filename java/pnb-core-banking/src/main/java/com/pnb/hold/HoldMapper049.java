...
/**
 * HoldMapper049 — Maps between entity and DTO.
 */
@ApplicationScoped
public class HoldMapper049 {

    public HoldDto049 toDto(HoldV049 entity) {
        if (entity == null) return null;
        HoldDto049 dto = new HoldDto049();
    ...
    public HoldV049 toEntity(HoldDto049 dto) {
        if (dto == null) return null;
        HoldV049 entity = new HoldV049();

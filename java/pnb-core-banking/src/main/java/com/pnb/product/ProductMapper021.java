...
/**
 * ProductMapper021 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper021 {

    public ProductDto021 toDto(ProductV021 entity) {
        if (entity == null) return null;
        ProductDto021 dto = new ProductDto021();
    ...
    public ProductV021 toEntity(ProductDto021 dto) {
        if (dto == null) return null;
        ProductV021 entity = new ProductV021();

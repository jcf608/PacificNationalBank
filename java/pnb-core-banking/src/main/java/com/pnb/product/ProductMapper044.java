...
/**
 * ProductMapper044 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper044 {

    public ProductDto044 toDto(ProductV044 entity) {
        if (entity == null) return null;
        ProductDto044 dto = new ProductDto044();
    ...
    public ProductV044 toEntity(ProductDto044 dto) {
        if (dto == null) return null;
        ProductV044 entity = new ProductV044();

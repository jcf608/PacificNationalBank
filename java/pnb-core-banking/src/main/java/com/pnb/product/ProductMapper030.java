...
/**
 * ProductMapper030 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper030 {

    public ProductDto030 toDto(ProductV030 entity) {
        if (entity == null) return null;
        ProductDto030 dto = new ProductDto030();
    ...
    public ProductV030 toEntity(ProductDto030 dto) {
        if (dto == null) return null;
        ProductV030 entity = new ProductV030();

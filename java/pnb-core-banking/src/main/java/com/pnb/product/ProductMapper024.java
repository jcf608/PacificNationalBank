...
/**
 * ProductMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper024 {

    public ProductDto024 toDto(ProductV024 entity) {
        if (entity == null) return null;
        ProductDto024 dto = new ProductDto024();
    ...
    public ProductV024 toEntity(ProductDto024 dto) {
        if (dto == null) return null;
        ProductV024 entity = new ProductV024();

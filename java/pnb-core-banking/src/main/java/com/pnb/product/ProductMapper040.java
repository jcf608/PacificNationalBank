...
/**
 * ProductMapper040 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper040 {

    public ProductDto040 toDto(ProductV040 entity) {
        if (entity == null) return null;
        ProductDto040 dto = new ProductDto040();
    ...
    public ProductV040 toEntity(ProductDto040 dto) {
        if (dto == null) return null;
        ProductV040 entity = new ProductV040();

...
/**
 * ProductMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper048 {

    public ProductDto048 toDto(ProductV048 entity) {
        if (entity == null) return null;
        ProductDto048 dto = new ProductDto048();
    ...
    public ProductV048 toEntity(ProductDto048 dto) {
        if (dto == null) return null;
        ProductV048 entity = new ProductV048();

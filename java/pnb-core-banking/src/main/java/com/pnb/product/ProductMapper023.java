...
/**
 * ProductMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper023 {

    public ProductDto023 toDto(ProductV023 entity) {
        if (entity == null) return null;
        ProductDto023 dto = new ProductDto023();
    ...
    public ProductV023 toEntity(ProductDto023 dto) {
        if (dto == null) return null;
        ProductV023 entity = new ProductV023();

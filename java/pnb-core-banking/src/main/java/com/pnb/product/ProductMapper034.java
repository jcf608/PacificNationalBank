...
/**
 * ProductMapper034 — Maps between entity and DTO.
 */
@ApplicationScoped
public class ProductMapper034 {

    public ProductDto034 toDto(ProductV034 entity) {
        if (entity == null) return null;
        ProductDto034 dto = new ProductDto034();
    ...
    public ProductV034 toEntity(ProductDto034 dto) {
        if (dto == null) return null;
        ProductV034 entity = new ProductV034();

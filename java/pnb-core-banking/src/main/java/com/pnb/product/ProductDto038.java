...
/**
 * ProductDto038 — Data Transfer Object for product operations.
 * Variant 38 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ProductDto038 {
    ...
    public ProductDto038() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final ProductDto038 instance = new ProductDto038();
        ...
        public ProductDto038 build() { return instance; }
    }

...
/**
 * WireDto028 — Data Transfer Object for wire operations.
 * Variant 28 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class WireDto028 {
    ...
    public static class Builder {
        private final WireDto028 instance = new WireDto028();
        ...
        public WireDto028 build() { return instance; }
    }

...
/**
 * WireMapper045 — Maps between entity and DTO.
 */
@ApplicationScoped
public class WireMapper045 {

    public WireDto045 toDto(WireV045 entity) {
        if (entity == null) return null;
        WireDto045 dto = new WireDto045();
    ...
    public WireV045 toEntity(WireDto045 dto) {
        if (dto == null) return null;
        WireV045 entity = new WireV045();

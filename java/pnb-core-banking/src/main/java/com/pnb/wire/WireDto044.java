...
/**
 * WireDto044 — Data Transfer Object for wire operations.
 * Variant 44 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class WireDto044 {
    ...
    public static class Builder {
        private final WireDto044 instance = new WireDto044();
        ...
        public WireDto044 build() { return instance; }
    }

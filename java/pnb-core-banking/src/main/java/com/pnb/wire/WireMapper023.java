...
/**
 * WireMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class WireMapper023 {

    public WireDto023 toDto(WireV023 entity) {
        if (entity == null) return null;
        WireDto023 dto = new WireDto023();
    ...
    public WireV023 toEntity(WireDto023 dto) {
        if (dto == null) return null;
        WireV023 entity = new WireV023();

...
/**
 * WireValidator040 — Business rule validation.
 */
@ApplicationScoped
public class WireValidator040 {

    public List<String> validate(WireDto040 dto) {
        ...
        if (dto.getWireField010() != null && dto.getWireField010().compareTo(BigDecimal.ZERO) < 0) {

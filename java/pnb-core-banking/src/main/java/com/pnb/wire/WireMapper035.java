...
/**
 * WireMapper035 — Maps between entity and DTO.
 */
@ApplicationScoped
public class WireMapper035 {

    public WireDto035 toDto(WireV035 entity) {
        if (entity == null) return null;
        WireDto035 dto = new WireDto035();
    ...
    public WireV035 toEntity(WireDto035 dto) {
        if (dto == null) return null;
        WireV035 entity = new WireV035();

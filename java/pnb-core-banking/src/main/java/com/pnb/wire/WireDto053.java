...
/**
 * WireDto053 — Data Transfer Object for wire operations.
 * Variant 53 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class WireDto053 {
    ...
    public static class Builder {
        private final WireDto053 instance = new WireDto053();
        ...
        public WireDto053 build() { return instance; }
    }

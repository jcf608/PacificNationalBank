...
/**
 * WireMapper051 — Maps between entity and DTO.
 */
@ApplicationScoped
public class WireMapper051 {

    public WireDto051 toDto(WireV051 entity) {
        if (entity == null) return null;
        WireDto051 dto = new WireDto051();
    ...
    public WireV051 toEntity(WireDto051 dto) {
        if (dto == null) return null;
        WireV051 entity = new WireV051();

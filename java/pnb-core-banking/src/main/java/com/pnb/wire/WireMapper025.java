...
/**
 * WireMapper025 — Maps between entity and DTO.
 */
@ApplicationScoped
public class WireMapper025 {

    public WireDto025 toDto(WireV025 entity) {
        if (entity == null) return null;
        WireDto025 dto = new WireDto025();
    ...
    public WireV025 toEntity(WireDto025 dto) {
        if (dto == null) return null;
        WireV025 entity = new WireV025();

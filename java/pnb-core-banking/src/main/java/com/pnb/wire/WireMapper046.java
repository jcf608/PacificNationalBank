...
/**
 * WireMapper046 — Maps between entity and DTO.
 */
@ApplicationScoped
public class WireMapper046 {

    public WireDto046 toDto(WireV046 entity) {
        if (entity == null) return null;
        WireDto046 dto = new WireDto046();
    ...
    public WireV046 toEntity(WireDto046 dto) {
        if (dto == null) return null;
        WireV046 entity = new WireV046();

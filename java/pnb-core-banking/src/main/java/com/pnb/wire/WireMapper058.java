...
/**
 * WireMapper058 — Maps between entity and DTO.
 */
@ApplicationScoped
public class WireMapper058 {

    public WireDto058 toDto(WireV058 entity) {
        if (entity == null) return null;
        WireDto058 dto = new WireDto058();
    ...
    public WireV058 toEntity(WireDto058 dto) {
        if (dto == null) return null;
        WireV058 entity = new WireV058();

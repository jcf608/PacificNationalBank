...
/**
 * WireDto021 — Data Transfer Object for wire operations.
 * Variant 21 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class WireDto021 {
    ...
    public static class Builder {
        private final WireDto021 instance = new WireDto021();
        ...
        public WireDto021 build() { return instance; }
    }

...
/**
 * LoanDto055 — Data Transfer Object for loan operations.
 * Variant 55 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LoanDto055 {
    ...
    public static class Builder {
        private final LoanDto055 instance = new LoanDto055();
        ...
        public LoanDto055 build() { return instance; }
    }

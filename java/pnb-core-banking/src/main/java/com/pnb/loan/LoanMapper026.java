...
/**
 * LoanMapper026 — Maps between entity and DTO.
 */
@ApplicationScoped
public class LoanMapper026 {

    public LoanDto026 toDto(LoanV026 entity) {
        if (entity == null) return null;
        LoanDto026 dto = new LoanDto026();
    ...
    public LoanV026 toEntity(LoanDto026 dto) {
        if (dto == null) return null;
        LoanV026 entity = new LoanV026();

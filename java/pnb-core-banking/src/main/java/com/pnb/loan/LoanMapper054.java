...
/**
 * LoanMapper054 — Maps between entity and DTO.
 */
@ApplicationScoped
public class LoanMapper054 {

    public LoanDto054 toDto(LoanV054 entity) {
        if (entity == null) return null;
        LoanDto054 dto = new LoanDto054();
    ...
    public LoanV054 toEntity(LoanDto054 dto) {
        if (dto == null) return null;
        LoanV054 entity = new LoanV054();

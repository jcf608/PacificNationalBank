...
/**
 * LoanMapper056 — Maps between entity and DTO.
 */
@ApplicationScoped
public class LoanMapper056 {

    public LoanDto056 toDto(LoanV056 entity) {
        if (entity == null) return null;
        LoanDto056 dto = new LoanDto056();
    ...
    public LoanV056 toEntity(LoanDto056 dto) {
        if (dto == null) return null;
        LoanV056 entity = new LoanV056();

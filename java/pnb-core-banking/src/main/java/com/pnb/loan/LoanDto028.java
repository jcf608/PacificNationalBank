...
/**
 * LoanDto028 — Data Transfer Object for loan operations.
 * Variant 28 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LoanDto028 {
    ...
    public static class Builder {
        private final LoanDto028 instance = new LoanDto028();
        ...
        public LoanDto028 build() { return instance; }
    }

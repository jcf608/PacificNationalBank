...
/**
 * LoanDto036 — Data Transfer Object for loan operations.
 * Variant 36 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LoanDto036 {
    ...
    public static class Builder {
        private final LoanDto036 instance = new LoanDto036();
        ...
        public LoanDto036 build() { return instance; }
    }

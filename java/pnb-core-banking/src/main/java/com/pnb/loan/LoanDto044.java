...
/**
 * LoanDto044 — Data Transfer Object for loan operations.
 * Variant 44 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LoanDto044 {
    ...
    public static class Builder {
        private final LoanDto044 instance = new LoanDto044();
        ...
        public LoanDto044 build() { return instance; }
    }

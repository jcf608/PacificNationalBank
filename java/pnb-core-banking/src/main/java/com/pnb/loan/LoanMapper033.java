...
/**
 * LoanMapper033 — Maps between entity and DTO.
 */
@ApplicationScoped
public class LoanMapper033 {

    public LoanDto033 toDto(LoanV033 entity) {
        if (entity == null) return null;
        LoanDto033 dto = new LoanDto033();
    ...
    public LoanV033 toEntity(LoanDto033 dto) {
        if (dto == null) return null;
        LoanV033 entity = new LoanV033();

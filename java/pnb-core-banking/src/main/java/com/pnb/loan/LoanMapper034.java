...
/**
 * LoanMapper034 — Maps between entity and DTO.
 */
@ApplicationScoped
public class LoanMapper034 {

    public LoanDto034 toDto(LoanV034 entity) {
        if (entity == null) return null;
        LoanDto034 dto = new LoanDto034();
    ...
    public LoanV034 toEntity(LoanDto034 dto) {
        if (dto == null) return null;
        LoanV034 entity = new LoanV034();

...
/**
 * LoanDto045 — Data Transfer Object for loan operations.
 * Variant 45 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LoanDto045 {
    ...
    public static class Builder {
        private final LoanDto045 instance = new LoanDto045();
        ...
        public LoanDto045 build() { return instance; }
    }

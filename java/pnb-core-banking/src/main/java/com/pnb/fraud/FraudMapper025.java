...
/**
 * FraudMapper025 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FraudMapper025 {

    public FraudDto025 toDto(FraudV025 entity) {
        if (entity == null) return null;
        FraudDto025 dto = new FraudDto025();
    ...
    public FraudV025 toEntity(FraudDto025 dto) {
        if (dto == null) return null;
        FraudV025 entity = new FraudV025();

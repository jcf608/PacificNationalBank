...
/**
 * FraudMapper052 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FraudMapper052 {

    public FraudDto052 toDto(FraudV052 entity) {
        if (entity == null) return null;
        FraudDto052 dto = new FraudDto052();
    ...
    public FraudV052 toEntity(FraudDto052 dto) {
        if (dto == null) return null;
        FraudV052 entity = new FraudV052();

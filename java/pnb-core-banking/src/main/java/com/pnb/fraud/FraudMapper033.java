...
/**
 * FraudMapper033 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FraudMapper033 {

    public FraudDto033 toDto(FraudV033 entity) {
        if (entity == null) return null;
        FraudDto033 dto = new FraudDto033();
    ...
    public FraudV033 toEntity(FraudDto033 dto) {
        if (dto == null) return null;
        FraudV033 entity = new FraudV033();

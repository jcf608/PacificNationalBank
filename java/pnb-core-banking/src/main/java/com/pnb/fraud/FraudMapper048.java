...
/**
 * FraudMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class FraudMapper048 {

    public FraudDto048 toDto(FraudV048 entity) {
        if (entity == null) return null;
        FraudDto048 dto = new FraudDto048();
    ...
    public FraudV048 toEntity(FraudDto048 dto) {
        if (dto == null) return null;
        FraudV048 entity = new FraudV048();

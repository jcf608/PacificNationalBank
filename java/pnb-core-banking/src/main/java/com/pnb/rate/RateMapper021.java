...
/**
 * RateMapper021 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper021 {

    public RateDto021 toDto(RateV021 entity) {
        if (entity == null) return null;
        RateDto021 dto = new RateDto021();
    ...
    public RateV021 toEntity(RateDto021 dto) {
        if (dto == null) return null;
        RateV021 entity = new RateV021();

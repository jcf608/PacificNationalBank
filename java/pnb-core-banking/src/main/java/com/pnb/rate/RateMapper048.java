...
/**
 * RateMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper048 {

    public RateDto048 toDto(RateV048 entity) {
        if (entity == null) return null;
        RateDto048 dto = new RateDto048();
    ...
    public RateV048 toEntity(RateDto048 dto) {
        if (dto == null) return null;
        RateV048 entity = new RateV048();

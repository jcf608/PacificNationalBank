...
/**
 * RateMapper030 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper030 {

    public RateDto030 toDto(RateV030 entity) {
        if (entity == null) return null;
        RateDto030 dto = new RateDto030();
    ...
    public RateV030 toEntity(RateDto030 dto) {
        if (dto == null) return null;
        RateV030 entity = new RateV030();

...
/**
 * RateMapper049 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper049 {

    public RateDto049 toDto(RateV049 entity) {
        if (entity == null) return null;
        RateDto049 dto = new RateDto049();
    ...
    public RateV049 toEntity(RateDto049 dto) {
        if (dto == null) return null;
        RateV049 entity = new RateV049();

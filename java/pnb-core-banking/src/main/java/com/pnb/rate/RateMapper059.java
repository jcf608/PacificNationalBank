...
/**
 * RateMapper059 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper059 {

    public RateDto059 toDto(RateV059 entity) {
        if (entity == null) return null;
        RateDto059 dto = new RateDto059();
    ...
    public RateV059 toEntity(RateDto059 dto) {
        if (dto == null) return null;
        RateV059 entity = new RateV059();

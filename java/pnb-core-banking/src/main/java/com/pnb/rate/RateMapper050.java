...
/**
 * RateMapper050 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper050 {

    public RateDto050 toDto(RateV050 entity) {
        if (entity == null) return null;
        RateDto050 dto = new RateDto050();
    ...
    public RateV050 toEntity(RateDto050 dto) {
        if (dto == null) return null;
        RateV050 entity = new RateV050();

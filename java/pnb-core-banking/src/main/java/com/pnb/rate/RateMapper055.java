...
/**
 * RateMapper055 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper055 {

    public RateDto055 toDto(RateV055 entity) {
        if (entity == null) return null;
        RateDto055 dto = new RateDto055();
    ...
    public RateV055 toEntity(RateDto055 dto) {
        if (dto == null) return null;
        RateV055 entity = new RateV055();

...
/**
 * RateMapper056 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper056 {

    public RateDto056 toDto(RateV056 entity) {
        if (entity == null) return null;
        RateDto056 dto = new RateDto056();
    ...
    public RateV056 toEntity(RateDto056 dto) {
        if (dto == null) return null;
        RateV056 entity = new RateV056();

...
/**
 * RateMapper027 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper027 {

    public RateDto027 toDto(RateV027 entity) {
        if (entity == null) return null;
        RateDto027 dto = new RateDto027();
    ...
    public RateV027 toEntity(RateDto027 dto) {
        if (dto == null) return null;
        RateV027 entity = new RateV027();

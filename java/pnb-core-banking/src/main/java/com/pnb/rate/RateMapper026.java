...
/**
 * RateMapper026 — Maps between entity and DTO.
 */
@ApplicationScoped
public class RateMapper026 {

    public RateDto026 toDto(RateV026 entity) {
        if (entity == null) return null;
        RateDto026 dto = new RateDto026();
    ...
    public RateV026 toEntity(RateDto026 dto) {
        if (dto == null) return null;
        RateV026 entity = new RateV026();

...
/**
 * CustomerMapper021 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CustomerMapper021 {

    public CustomerDto021 toDto(CustomerV021 entity) {
        if (entity == null) return null;
        CustomerDto021 dto = new CustomerDto021();
    ...
    public CustomerV021 toEntity(CustomerDto021 dto) {
        if (dto == null) return null;
        CustomerV021 entity = new CustomerV021();

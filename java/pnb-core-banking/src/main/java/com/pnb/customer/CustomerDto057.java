...
/**
 * CustomerDto057 — Data Transfer Object for customer operations.
 * Variant 57 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CustomerDto057 {
    ...
    public CustomerDto057() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final CustomerDto057 instance = new CustomerDto057();
        ...
        public CustomerDto057 build() { return instance; }
    }

...
/**
 * CustomerMapper041 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CustomerMapper041 {

    public CustomerDto041 toDto(CustomerV041 entity) {
        if (entity == null) return null;
        CustomerDto041 dto = new CustomerDto041();
    ...
    public CustomerV041 toEntity(CustomerDto041 dto) {
        if (dto == null) return null;
        CustomerV041 entity = new CustomerV041();

...
/**
 * CustomerDto040 — Data Transfer Object for customer operations.
 * Variant 40 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CustomerDto040 {
    ...
    public CustomerDto040() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final CustomerDto040 instance = new CustomerDto040();
        ...
        public CustomerDto040 build() { return instance; }
    }

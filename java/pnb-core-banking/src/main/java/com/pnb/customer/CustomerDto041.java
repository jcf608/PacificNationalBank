...
/**
 * CustomerDto041 — Data Transfer Object for customer operations.
 * Variant 41 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CustomerDto041 {
    ...
    public CustomerDto041() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final CustomerDto041 instance = new CustomerDto041();
        ...
        public CustomerDto041 build() { return instance; }
    }

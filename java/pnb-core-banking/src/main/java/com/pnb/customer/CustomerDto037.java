...
/**
 * CustomerDto037 — Data Transfer Object for customer operations.
 * Variant 37 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CustomerDto037 {
    ...
    public CustomerDto037() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final CustomerDto037 instance = new CustomerDto037();
        ...
        public CustomerDto037 build() { return instance; }
    }

...
/**
 * CustomerValidator022 — Business rule validation.
 */
@ApplicationScoped
public class CustomerValidator022 {

    public List<String> validate(CustomerDto022 dto) {
        ...
        if (dto.getCustField014() != null && dto.getCustField014().compareTo(BigDecimal.ZERO) < 0) {

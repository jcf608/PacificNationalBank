...
/**
 * CustomerMapper031 — Maps between entity and DTO.
 */
@ApplicationScoped
public class CustomerMapper031 {

    public CustomerDto031 toDto(CustomerV031 entity) {
        if (entity == null) return null;
        CustomerDto031 dto = new CustomerDto031();
    ...
    public CustomerV031 toEntity(CustomerDto031 dto) {
        if (dto == null) return null;
        CustomerV031 entity = new CustomerV031();

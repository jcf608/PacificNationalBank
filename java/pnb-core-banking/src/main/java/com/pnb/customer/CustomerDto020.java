...
/**
 * CustomerDto020 — Data Transfer Object for customer operations.
 * Variant 20 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CustomerDto020 {
    ...
    public CustomerDto020() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final CustomerDto020 instance = new CustomerDto020();
        ...
        public CustomerDto020 build() { return instance; }
    }

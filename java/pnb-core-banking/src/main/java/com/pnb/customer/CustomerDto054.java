...
/**
 * CustomerDto054 — Data Transfer Object for customer operations.
 * Variant 54 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CustomerDto054 {
    ...
    public CustomerDto054() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final CustomerDto054 instance = new CustomerDto054();
        ...
        public CustomerDto054 build() { return instance; }
    }

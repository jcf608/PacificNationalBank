...
/**
 * DepositMapper050 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper050 {

    public DepositDto050 toDto(DepositV050 entity) {
        if (entity == null) return null;
        DepositDto050 dto = new DepositDto050();
    ...
    public DepositV050 toEntity(DepositDto050 dto) {
        if (dto == null) return null;
        DepositV050 entity = new DepositV050();

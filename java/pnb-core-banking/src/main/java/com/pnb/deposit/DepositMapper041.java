...
/**
 * DepositMapper041 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper041 {

    public DepositDto041 toDto(DepositV041 entity) {
        if (entity == null) return null;
        DepositDto041 dto = new DepositDto041();
    ...
    public DepositV041 toEntity(DepositDto041 dto) {
        if (dto == null) return null;
        DepositV041 entity = new DepositV041();

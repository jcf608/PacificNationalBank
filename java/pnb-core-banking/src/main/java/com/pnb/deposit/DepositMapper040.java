...
/**
 * DepositMapper040 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper040 {

    public DepositDto040 toDto(DepositV040 entity) {
        if (entity == null) return null;
        DepositDto040 dto = new DepositDto040();
    ...
    public DepositV040 toEntity(DepositDto040 dto) {
        if (dto == null) return null;
        DepositV040 entity = new DepositV040();

...
/**
 * DepositMapper047 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper047 {

    public DepositDto047 toDto(DepositV047 entity) {
        if (entity == null) return null;
        DepositDto047 dto = new DepositDto047();
    ...
    public DepositV047 toEntity(DepositDto047 dto) {
        if (dto == null) return null;
        DepositV047 entity = new DepositV047();

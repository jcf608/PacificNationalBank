...
/**
 * DepositMapper023 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper023 {

    public DepositDto023 toDto(DepositV023 entity) {
        if (entity == null) return null;
        DepositDto023 dto = new DepositDto023();
    ...
    public DepositV023 toEntity(DepositDto023 dto) {
        if (dto == null) return null;
        DepositV023 entity = new DepositV023();

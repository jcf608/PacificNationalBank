...
/**
 * DepositMapper037 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper037 {

    public DepositDto037 toDto(DepositV037 entity) {
        if (entity == null) return null;
        DepositDto037 dto = new DepositDto037();
    ...
    public DepositV037 toEntity(DepositDto037 dto) {
        if (dto == null) return null;
        DepositV037 entity = new DepositV037();

...
/**
 * DepositDto034 — Data Transfer Object for deposit operations.
 * Variant 34 with domain-specific validation.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class DepositDto034 {
    ...
    private BigDecimal depoField016;

    @JsonProperty("depoField017")
    private Boolean depoField017;

    public DepositDto034() {}

    public static Builder builder() { return new Builder(); }

    public static class Builder {
        private final DepositDto034 instance = new DepositDto034();
        ...
        public Builder depoField016(BigDecimal val) { instance.depoField016 = val; return this; }
        public Builder depoField017(Boolean val) { instance.depoField017 = val; return this; }
        public DepositDto034 build() { return instance; }
    }
    ...
    public BigDecimal getDepoField016() { return depoField016; }
    public void setDepoField016(BigDecimal depoField016) { this.depoField016 = depoField016; }

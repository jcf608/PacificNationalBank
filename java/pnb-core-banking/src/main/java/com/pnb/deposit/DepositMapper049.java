...
/**
 * DepositMapper049 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper049 {

    public DepositDto049 toDto(DepositV049 entity) {
        if (entity == null) return null;
        DepositDto049 dto = new DepositDto049();
    ...
    public DepositV049 toEntity(DepositDto049 dto) {
        if (dto == null) return null;
        DepositV049 entity = new DepositV049();

...
/**
 * DepositMapper021 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper021 {

    public DepositDto021 toDto(DepositV021 entity) {
        if (entity == null) return null;
        DepositDto021 dto = new DepositDto021();
    ...
    public DepositV021 toEntity(DepositDto021 dto) {
        if (dto == null) return null;
        DepositV021 entity = new DepositV021();

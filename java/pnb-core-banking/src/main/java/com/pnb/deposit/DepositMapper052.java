...
/**
 * DepositMapper052 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper052 {

    public DepositDto052 toDto(DepositV052 entity) {
        if (entity == null) return null;
        DepositDto052 dto = new DepositDto052();
    ...
    public DepositV052 toEntity(DepositDto052 dto) {
        if (dto == null) return null;
        DepositV052 entity = new DepositV052();

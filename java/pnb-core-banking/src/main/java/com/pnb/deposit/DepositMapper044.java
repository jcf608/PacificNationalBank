...
/**
 * DepositMapper044 — Maps between entity and DTO.
 */
@ApplicationScoped
public class DepositMapper044 {

    public DepositDto044 toDto(DepositV044 entity) {
        if (entity == null) return null;
        DepositDto044 dto = new DepositDto044();
    ...
    public DepositV044 toEntity(DepositDto044 dto) {
        if (dto == null) return null;
        DepositV044 entity = new DepositV044();

...
/**
 * EscrowMapper048 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper048 {

    public EscrowDto048 toDto(EscrowV048 entity) {
        if (entity == null) return null;
        EscrowDto048 dto = new EscrowDto048();
    ...
    public EscrowV048 toEntity(EscrowDto048 dto) {
        if (dto == null) return null;
        EscrowV048 entity = new EscrowV048();

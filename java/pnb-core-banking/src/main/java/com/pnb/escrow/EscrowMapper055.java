...
/**
 * EscrowMapper055 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper055 {

    public EscrowDto055 toDto(EscrowV055 entity) {
        if (entity == null) return null;
        EscrowDto055 dto = new EscrowDto055();
    ...
    public EscrowV055 toEntity(EscrowDto055 dto) {
        if (dto == null) return null;
        EscrowV055 entity = new EscrowV055();

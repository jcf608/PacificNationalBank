...
/**
 * EscrowMapper027 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper027 {

    public EscrowDto027 toDto(EscrowV027 entity) {
        if (entity == null) return null;
        EscrowDto027 dto = new EscrowDto027();
    ...
    public EscrowV027 toEntity(EscrowDto027 dto) {
        if (dto == null) return null;
        EscrowV027 entity = new EscrowV027();

...
/**
 * EscrowMapper038 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper038 {

    public EscrowDto038 toDto(EscrowV038 entity) {
        if (entity == null) return null;
        EscrowDto038 dto = new EscrowDto038();
    ...
    public EscrowV038 toEntity(EscrowDto038 dto) {
        if (dto == null) return null;
        EscrowV038 entity = new EscrowV038();

...
/**
 * EscrowMapper025 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper025 {

    public EscrowDto025 toDto(EscrowV025 entity) {
        if (entity == null) return null;
        EscrowDto025 dto = new EscrowDto025();
    ...
    public EscrowV025 toEntity(EscrowDto025 dto) {
        if (dto == null) return null;
        EscrowV025 entity = new EscrowV025();

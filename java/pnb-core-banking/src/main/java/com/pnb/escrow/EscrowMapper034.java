...
/**
 * EscrowMapper034 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper034 {

    public EscrowDto034 toDto(EscrowV034 entity) {
        if (entity == null) return null;
        EscrowDto034 dto = new EscrowDto034();
    ...
    public EscrowV034 toEntity(EscrowDto034 dto) {
        if (dto == null) return null;
        EscrowV034 entity = new EscrowV034();

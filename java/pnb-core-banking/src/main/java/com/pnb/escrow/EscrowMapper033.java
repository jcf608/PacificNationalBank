...
/**
 * EscrowMapper033 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper033 {

    public EscrowDto033 toDto(EscrowV033 entity) {
        if (entity == null) return null;
        EscrowDto033 dto = new EscrowDto033();
    ...
    public EscrowV033 toEntity(EscrowDto033 dto) {
        if (dto == null) return null;
        EscrowV033 entity = new EscrowV033();

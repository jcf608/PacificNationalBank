...
/**
 * EscrowMapper031 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper031 {

    public EscrowDto031 toDto(EscrowV031 entity) {
        if (entity == null) return null;
        EscrowDto031 dto = new EscrowDto031();
    ...
    public EscrowV031 toEntity(EscrowDto031 dto) {
        if (dto == null) return null;
        EscrowV031 entity = new EscrowV031();

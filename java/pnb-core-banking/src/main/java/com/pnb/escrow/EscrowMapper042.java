...
/**
 * EscrowMapper042 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper042 {

    public EscrowDto042 toDto(EscrowV042 entity) {
        if (entity == null) return null;
        EscrowDto042 dto = new EscrowDto042();
    ...
    public EscrowV042 toEntity(EscrowDto042 dto) {
        if (dto == null) return null;
        EscrowV042 entity = new EscrowV042();

...
/**
 * EscrowMapper054 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper054 {

    public EscrowDto054 toDto(EscrowV054 entity) {
        if (entity == null) return null;
        EscrowDto054 dto = new EscrowDto054();
    ...
    public EscrowV054 toEntity(EscrowDto054 dto) {
        if (dto == null) return null;
        EscrowV054 entity = new EscrowV054();

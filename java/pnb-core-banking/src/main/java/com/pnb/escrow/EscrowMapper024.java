...
/**
 * EscrowMapper024 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper024 {

    public EscrowDto024 toDto(EscrowV024 entity) {
        if (entity == null) return null;
        EscrowDto024 dto = new EscrowDto024();
    ...
    public EscrowV024 toEntity(EscrowDto024 dto) {
        if (dto == null) return null;
        EscrowV024 entity = new EscrowV024();

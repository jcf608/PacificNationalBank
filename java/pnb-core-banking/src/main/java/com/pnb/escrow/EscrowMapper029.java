...
/**
 * EscrowMapper029 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper029 {

    public EscrowDto029 toDto(EscrowV029 entity) {
        if (entity == null) return null;
        EscrowDto029 dto = new EscrowDto029();
    ...
    public EscrowV029 toEntity(EscrowDto029 dto) {
        if (dto == null) return null;
        EscrowV029 entity = new EscrowV029();

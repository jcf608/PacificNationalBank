...
/**
 * EscrowMapper037 — Maps between entity and DTO.
 */
@ApplicationScoped
public class EscrowMapper037 {

    public EscrowDto037 toDto(EscrowV037 entity) {
        if (entity == null) return null;
        EscrowDto037 dto = new EscrowDto037();
    ...
    public EscrowV037 toEntity(EscrowDto037 dto) {
        if (dto == null) return null;
        EscrowV037 entity = new EscrowV037();
